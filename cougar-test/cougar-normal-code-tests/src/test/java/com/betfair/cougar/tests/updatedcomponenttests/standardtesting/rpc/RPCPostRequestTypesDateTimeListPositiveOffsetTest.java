...
/**
 * Ensure that Cougar can handle the dateTimeList data type with positive offsets in the post body of an RPC request
 */
public class RPCPostRequestTypesDateTimeListPositiveOffsetTest {
    ...
    public void doTest() throws Exception {
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "dateTimeListOperation"),new RequestLogRequirement("2.8", "dateTimeListOperation"),new RequestLogRequirement("2.8", "dateTimeListOperation"),new RequestLogRequirement("2.8", "dateTimeListOperation") );
