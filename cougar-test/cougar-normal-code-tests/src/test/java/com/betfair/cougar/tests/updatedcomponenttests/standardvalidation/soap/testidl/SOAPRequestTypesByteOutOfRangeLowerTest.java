...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/Test-IDL/SOAP_RequestTypes_Byte_OutOfRange_Lower.xls;
...
/**
 * Ensure that when a SOAP request is received with an out of range (lower) Byte parameter Cougar returns the correct fault
 */
public class SOAPRequestTypesByteOutOfRangeLowerTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            // Create the SOAP request as an XML Document (with a lower out of range byte parameter)
            XMLHelpers xMLHelpers2 = new XMLHelpers();
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<ByteOperationRequest><queryParam>-129</queryParam><message><bodyParameter>127</bodyParameter></message></ByteOperationRequest>");
