...
public class RestHealthCheckDetailedComponentStatusDetailsWithFailTest {
    ...
    public void v3() throws Exception {
        ...
        try {
            ...
            Node baselineSubComponentList = metaDataService.getSpecifiedChildNode(healthDetailResponseNode, "subComponentList");
            // Get the Cache entry from the subComponentList and check the value of the status field is OK
            Node baselineCacheComponent = metaDataService.getNodeContainingSpecifiedChildNodeFromParent(baselineSubComponentList, "name", "Cache1");
            ...
            // Get the Service entry from the subComponentList and check the value of the status field is FAIL
            Node baselineServiceComponent = metaDataService.getNodeContainingSpecifiedChildNodeFromParent(baselineSubComponentList, "name", "Service1");
            ...
            Node baselineDBComponent = metaDataService.getNodeContainingSpecifiedChildNodeFromParent(baselineSubComponentList, "name", "DB1");
