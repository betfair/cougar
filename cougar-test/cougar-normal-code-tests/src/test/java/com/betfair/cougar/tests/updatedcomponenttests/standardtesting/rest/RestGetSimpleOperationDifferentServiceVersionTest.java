...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Get_SimpleOperation_DifferentServiceVersion.xls;
 ...
 */
public class RestGetSimpleOperationDifferentServiceVersionTest {
    @Test
    public void doTest() throws Exception {
        ...
        getNewHttpCallBean1.setVersion("v1.0");
        ...
        Document createAsDocument9 = xMLHelpers4.getXMLObjectFromString("<SimpleResponse><message>foo emitted by version 1.0.0 of Baseline</message></SimpleResponse>");
        ...
        cougarManager1.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp7, new RequestLogRequirement("1.0", "testSimpleGet"),new RequestLogRequirement("1.0", "testSimpleGet"),new RequestLogRequirement("1.0", "testSimpleGet"),new RequestLogRequirement("1.0", "testSimpleGet") );
    }
