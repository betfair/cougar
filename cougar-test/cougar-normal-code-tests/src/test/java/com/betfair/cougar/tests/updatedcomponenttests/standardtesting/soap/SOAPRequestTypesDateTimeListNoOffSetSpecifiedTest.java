...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/SOAP_RequestTypes_DateTimeList_NoOffSetSpecified.xls;
...
/**
 * Ensure that when a SOAP request is received, Cougar can handle the dateTimeList datatype containing a date with no offset
 */
public class SOAPRequestTypesDateTimeListNoOffSetSpecifiedTest {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document (with a dateTimeList parameter containing a date with no offset)
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<DateTimeListOperationRequest><message><dateTimeList><Date>2009-06-01T11:50:00.000Z</Date><Date>2009-06-01T11:50:00.000Z</Date></dateTimeList></message></DateTimeListOperationRequest>");
