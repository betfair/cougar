...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Get_SimpleOperation_BlanklIPAddress.xls;
...
/**
 * Ensure that Cougar correctly processes a simple Rest XML/JSON Get using each of the 4 supported response protocols, with X_IP in the header set to blank
 */
public class RestGetSimpleOperationBlanklIPAddressTest {
    @Test
