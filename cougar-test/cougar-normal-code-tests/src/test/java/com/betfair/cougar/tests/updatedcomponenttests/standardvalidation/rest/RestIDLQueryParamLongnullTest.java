...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_QueryParam_Long_null.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request passes a null Long Query parameter
 */
public class RestIDLQueryParamLongnullTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, setting the Long Query parameter as null
