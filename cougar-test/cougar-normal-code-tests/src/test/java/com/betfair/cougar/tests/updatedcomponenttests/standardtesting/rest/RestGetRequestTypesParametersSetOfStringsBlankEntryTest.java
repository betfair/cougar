...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Get_RequestTypes_Parameters_SetOfStrings_BlankEntry.xls;
...
/**
 * Ensure that when the 4 supported Rest XML/JSON Gets are performed, Cougar can handle a Set of Strings with a blank entry being passed in the Header and Query parameters
 */
public class RestGetRequestTypesParametersSetOfStringsBlankEntryTest {
    @Test
    public void doTest() throws Exception {
        ...
        map2.put("HeaderParam","header1,header2,,header4");
        httpCallBeanBaseline.setHeaderParams(map2);
        
        Map map3 = new HashMap();
        map3.put("queryParam","query1,query2,,query4");
        ...
        Document xmlDocument = xMLHelpers5.getXMLObjectFromString("<NonMandatoryParamsOperationResponseObject><headerParameter>,header1,header2,header4</headerParameter><queryParameter>,query1,query2,query4</queryParameter></NonMandatoryParamsOperationResponseObject>");
