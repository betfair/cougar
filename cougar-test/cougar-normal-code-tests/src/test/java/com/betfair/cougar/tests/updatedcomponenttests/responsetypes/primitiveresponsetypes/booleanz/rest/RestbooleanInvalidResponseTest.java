...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/boolean/REST/Rest_booleanInvalidResponse.xls;
 ...
 */
public class RestbooleanInvalidResponseTest {
    @Test
    public void doTest() throws Exception {
        ...
        CougarManager.verifyAccessLogEntriesAfterDate(timeStamp, new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/boolEcho", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/boolEcho", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/boolEcho", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/boolEcho", "BadRequest") );
    }
