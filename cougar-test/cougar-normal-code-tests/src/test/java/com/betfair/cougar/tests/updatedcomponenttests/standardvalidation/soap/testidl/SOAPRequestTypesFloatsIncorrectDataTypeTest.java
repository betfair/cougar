...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/Test-IDL/SOAP_RequestTypes_Floats_Incorrect_DataType.xls;
...
/**
 * Ensure that when a SOAP request is received with a Float parameter with an incorrect data type, Cougar returns the correct fault
 */
public class SOAPRequestTypesFloatsIncorrectDataTypeTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            // Create the SOAP request as an XML Document (with a header parameter of an incorrect data type)
            XMLHelpers xMLHelpers2 = new XMLHelpers();
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<FloatOperationRequest><headerParam>BLAH</headerParam><queryParam>78.025</queryParam><message><bodyParameter>0.0006</bodyParameter></message></FloatOperationRequest>");
