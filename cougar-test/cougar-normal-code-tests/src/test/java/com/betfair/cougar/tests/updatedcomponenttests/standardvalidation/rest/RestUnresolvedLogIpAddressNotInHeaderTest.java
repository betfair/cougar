...
/**
 * Ensure that when Cougar cannot resolve a request, the entry written to the unresolved log caters for when the passed header doesn't have an X-Forwarded-For header value
 */
public class RestUnresolvedLogIpAddressNotInHeaderTest {
    ...
    public void doTest() throws Exception {
        ...
        HttpCallBean getNewHttpCallBean2 = cougarManager2.getNewHttpCallBean("DO NOT INCLUDE");
