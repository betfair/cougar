...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_Long_IncorrectDataType.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request contains a non Long as a Long body parameter
 */
public class RestIDLPostBodyElementLongIncorrectDataTypeTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the Long body parameter to a non Long
        getNewHttpCallBean2.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><bodyParameter>sadsas</bodyParameter></message>".getBytes())));
