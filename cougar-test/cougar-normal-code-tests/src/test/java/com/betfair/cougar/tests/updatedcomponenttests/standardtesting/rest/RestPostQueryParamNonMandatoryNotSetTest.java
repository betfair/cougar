...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_QueryParam_NonMandatory_NotSet.xls;
...
/**
 * Ensure that when a Rest (XML/JSON) Post operation is performed against Cougar, non-mandatory Query Params do not have to be set in the request or the response.
 */
public class RestPostQueryParamNonMandatoryNotSetTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters for the request, not setting the non mandatory query parameter
        ...
        // Create the expected response as an XML document (not expecting the not set non mandatory query parameter)
        XMLHelpers xMLHelpers4 = new XMLHelpers();
        Document createAsDocument10 = xMLHelpers4.getXMLObjectFromString("<NonMandatoryParamsOperationResponseObject><bodyParameter1>postBodyParamString1</bodyParameter1><bodyParameter2>postBodyParamString2</bodyParameter2><headerParameter>headerParamString</headerParameter></NonMandatoryParamsOperationResponseObject>");
