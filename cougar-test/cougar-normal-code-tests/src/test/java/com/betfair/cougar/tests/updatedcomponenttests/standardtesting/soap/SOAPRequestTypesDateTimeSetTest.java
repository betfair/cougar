...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/SOAP_RequestTypes_DateTimeSet.xls;
...
/**
 * Ensure that when a SOAP request is received, Cougar can handle the dateTimeSet datatype
 */
public class SOAPRequestTypesDateTimeSetTest {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document (with a dateTimeSet parameter)
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<DateTimeSetOperationRequest><message><dateTimeSet><Date>2009-06-01T13:50:00.0Z</Date><Date>2009-06-02T13:50:00.0Z</Date></dateTimeSet></message></DateTimeSetOperationRequest>");
