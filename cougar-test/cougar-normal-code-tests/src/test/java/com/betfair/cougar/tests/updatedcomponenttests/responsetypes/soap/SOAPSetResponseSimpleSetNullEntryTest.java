...
// Originally from UpdatedComponentTests/ResponseTypes/SOAP/SOAP_SetResponse_SimpleSet_NullEntry.xls;
...
/**
 * Ensure that when a SOAP request operation is performed against Cougar, passing in a Set with one null entry , it is correctly  processed and the correct Set response returned.
 */
public class SOAPSetResponseSimpleSetNullEntryTest {
    @Test
    public void doTest() throws Exception {

        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<TestSimpleSetGetRequest><inputSet><String>aaa string</String><String>bbb string</String><String>ccc string</String><String/></inputSet></TestSimpleSetGetRequest>");
