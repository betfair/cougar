...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_Boolean_IncorrectDataType.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a request passes a non Boolean object in a Boolean parameter
 */
public class RestIDLHeaderParamBooleanIncorrectDataTypeTest {
    @Test
