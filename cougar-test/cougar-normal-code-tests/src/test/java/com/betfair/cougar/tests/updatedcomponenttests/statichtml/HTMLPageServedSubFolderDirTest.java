...
// Originally from UpdatedComponentTests/StaticHTML/HTMLPageServed_SubFolderDir.xls;
...
/**
 * Ensure cougar can ship static html files: handle basic html from a specified subfolder directory
 */
public class HTMLPageServedSubFolderDirTest {
    @Test
    public void doTest() throws Exception {
        ...
        InputStream inputStream = InputStreamHelpers.getInputStreamForResource("static-html/subfolder/subfoo.html");
        ...
        cougarManager2.verifyAccessLogEntriesAfterDate(getTimeAsTimeStamp1, new AccessLogRequirement(null, "/static-html/subfolder/subfoo.html", "Ok") );
    }
