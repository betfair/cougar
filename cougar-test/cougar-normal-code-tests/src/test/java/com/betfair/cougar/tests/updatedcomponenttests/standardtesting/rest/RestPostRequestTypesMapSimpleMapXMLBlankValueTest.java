...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_Map_SimpleMap_XML_BlankValue.xls;
...
/**
 * Ensure that when a Rest (XML) Post operation is performed, Cougar can correctly handle a simple Map with a blank value in the post body
 */
public class RestPostRequestTypesMapSimpleMapXMLBlankValueTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the post body to contain a simple map  with a blank value
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><simpleMap><entry key=\"bbb\"><String>Value for bbb</String></entry><entry key=\"aaa\"><String></String></entry><entry key=\"AAA\"><String>Value for AAA</String></entry><entry key=\"ccc\"><String>Value for ccc</String></entry></simpleMap></message>".getBytes())));
        ...
        Document createAsDocument10 = xMLHelpers3.getXMLObjectFromString("<SimpleMapOperationResponse><SimpleMapOperationResponseObject><responseMap><entry key=\"AAA\"><String>Value for AAA</String></entry><entry key=\"aaa\"><String/></entry><entry key=\"bbb\"><String>Value for bbb</String></entry><entry key=\"ccc\"><String>Value for ccc</String></entry></responseMap></SimpleMapOperationResponseObject></SimpleMapOperationResponse>");
        // Create the expected response as a JSON object
        JSONHelpers jSONHelpers4 = new JSONHelpers();
        JSONObject createAsJSONObject11 = jSONHelpers4.createAsJSONObject(new JSONObject("{\"responseMap\": {\"AAA\": \"Value for AAA\",\"aaa\": \"\",\"bbb\": \"Value for bbb\",\"ccc\": \"Value for ccc\"}}"));
