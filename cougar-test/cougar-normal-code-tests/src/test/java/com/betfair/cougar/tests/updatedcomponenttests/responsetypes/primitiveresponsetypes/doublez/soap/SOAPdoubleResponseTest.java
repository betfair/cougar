...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/double/SOAP/SOAP_doubleResponse.xls;
package com.betfair.cougar.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.doublez.soap;
...
/**
 * Test that the Cougar service allows to use double primitive type in the response (SOAP)
 */
public class SOAPdoubleResponseTest {
    @Test
    public void doTest() throws Exception {
        // Create a soap request structure as a Document object
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document requestDocument = xMLHelpers1.getXMLObjectFromString("<DoubleSimpleTypeEchoRequest><msg>0.13</msg></DoubleSimpleTypeEchoRequest>");
        // Get an HTTPCallBean
        ...
        Document responseDocument = xMLHelpers4.getXMLObjectFromString("<response>0.13</response>");
        ...
        CougarManager.verifyRequestLogEntriesAfterDate(timestamp, new RequestLogRequirement("2.8", "doubleSimpleTypeEcho") );
    }
