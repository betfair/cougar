...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_Doubles_Infinity_XML.xls;
...
/**
 * Ensure that Cougar can handle Doubles in the XML post body, header params and query params that are infinity
 */
public class RestPostRequestTypesDoublesInfinityXMLTest {
    @Test
    public void doTest() throws Exception {
        ...
        Document createAsDocument12 = xMLHelpers5.getXMLObjectFromString("<DoubleOperationResponse><DoubleOperationResponseObject><bodyParameter>-INF</bodyParameter><headerParameter>INF</headerParameter><queryParameter>-INF</queryParameter></DoubleOperationResponseObject></DoubleOperationResponse>");
        ...
        cougarManager1.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp9, new RequestLogRequirement("2.8", "doubleOperation"),new RequestLogRequirement("2.8", "doubleOperation") );
    }
