...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/double/REST/Rest_doubleInvalidResponse.xls;
...
/**
 * Test that the Cougar service throws a correct error when invalid value is passed to  double primitive type parameter (REST)
 */
public class RestdoubleInvalidResponseTest {
    @Test
    public void doTest() throws Exception {
        ...
        CougarManager.verifyAccessLogEntriesAfterDate(timeStamp, new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/doubleEcho", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/doubleEcho", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/doubleEcho", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/doubleEcho", "BadRequest") );
    }
