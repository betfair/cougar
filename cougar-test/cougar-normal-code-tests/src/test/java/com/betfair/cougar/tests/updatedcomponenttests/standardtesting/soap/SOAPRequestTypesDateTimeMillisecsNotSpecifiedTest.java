...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/SOAP_RequestTypes_DateTime_MillisecsNotSpecified.xls;
...
/**
 * Ensure that when a SOAP request is received, Cougar can handle the dateTime datatype with no milliseconds specified
 */
public class SOAPRequestTypesDateTimeMillisecsNotSpecifiedTest {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document (with a dateTime parameter with no milliseconds)
