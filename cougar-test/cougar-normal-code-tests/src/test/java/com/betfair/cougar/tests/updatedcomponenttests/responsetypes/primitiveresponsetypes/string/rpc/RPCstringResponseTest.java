...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/string/RPC/RPC_stringResponse.xls;
package com.betfair.cougar.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.string.rpc;
...
/**
 * Test that the Cougar service allows to use string primitive type in the response (Batched JSON)
 */
public class RPCstringResponseTest {
    @Test
    public void doTest() throws Exception {
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "stringSimpleTypeEcho"),new RequestLogRequirement("2.8", "stringSimpleTypeEcho") );
