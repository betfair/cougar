...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTime_Miliiseconds_FillTo3Digits.xls;
...
/**
 * Ensure that Cougar can handle the dateTime data type in the post body with less than 3 digits millisecond accuracy
 */
public class RestPostRequestTypesDateTimeMiliisecondsFillTo3DigitsTest {
    @Test
    public void doTest() throws Exception {
        ...
        String date = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2009, (int) 1, (int) 1, (int) 13, (int) 50, (int) 0, (int) 430);
        // Set the post body to contain a date time object (with < 3 digits millisecond accuracy)
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<bodyParamDateTimeObject><dateTimeParameter>2009-01-01T13:50:00.43Z</dateTimeParameter></bodyParamDateTimeObject>".getBytes())));
