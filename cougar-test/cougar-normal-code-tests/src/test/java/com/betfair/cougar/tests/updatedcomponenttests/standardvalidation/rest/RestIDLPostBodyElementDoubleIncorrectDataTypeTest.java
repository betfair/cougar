...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_Double_IncorrectDataType.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request contains a non Double as a Double body parameter
 */
public class RestIDLPostBodyElementDoubleIncorrectDataTypeTest {
    @Test
    public void doTest() throws Exception {
        ...
        map4.put("queryParam","4.543");
        getNewHttpCallBean2.setQueryParams(map4);
        // Set the Double body parameter as a non Double
        getNewHttpCallBean2.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><bodyParameter>fdsfss</bodyParameter></message>".getBytes())));
