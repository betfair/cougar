...
/**
 * Test that when SOAP request operation is performed against Cougar, passing in a Map of primitive integers , it is correctly  processed and the correct response map is returned.
 */
public class SOAPMapResponseIntTest {
    ...
    public void doTest() throws Exception {
        ...
        cougarManager2.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp7, new RequestLogRequirement("2.8", "i32MapSimpleTypeEcho") );
    }
