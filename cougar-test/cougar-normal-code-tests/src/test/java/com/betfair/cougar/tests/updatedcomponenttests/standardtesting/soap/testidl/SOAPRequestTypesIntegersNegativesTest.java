...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/Test-IDL/SOAP_RequestTypes_Integers_Negatives.xls;
...
/**
 * Ensure that when a SOAP request is received, Cougar can handle the integer datatype with negative integers
 */
public class SOAPRequestTypesIntegersNegativesTest {
    @Test
