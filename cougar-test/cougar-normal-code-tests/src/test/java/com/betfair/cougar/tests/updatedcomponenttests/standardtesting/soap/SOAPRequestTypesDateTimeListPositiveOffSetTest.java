...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/SOAP_RequestTypes_DateTimeList_PositiveOffSet.xls;
...
/**
 * Ensure that when a SOAP request is received, Cougar can handle the dateTimeList datatype containing a date with a positive offset
 */
public class SOAPRequestTypesDateTimeListPositiveOffSetTest {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document (with a dateTimeList parameter containing a date with a positive offset)
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<DateTimeListOperationRequest><message><dateTimeList><Date>2009-06-01T15:50:00+02:00</Date><Date>2009-06-01T15:50:00+02:00</Date></dateTimeList></message></DateTimeListOperationRequest>");
