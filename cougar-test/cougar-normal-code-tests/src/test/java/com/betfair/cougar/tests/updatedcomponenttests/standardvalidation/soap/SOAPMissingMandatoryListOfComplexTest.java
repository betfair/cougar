...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/SOAP_MissingMandatory_ListOfComplex.xls;
...
/**
 * Ensure that the correct fault is returned when, a SOAP Post operation is performed against Cougar, passing a List of complex object in the post body, where the complex object  contained in the list has a mandatory field missing
 */
public class SOAPMissingMandatoryListOfComplexTest {
