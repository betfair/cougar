...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeMap_JSON_NegativeOffset_RollToNextDayxls.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeMap data type in the post body of a JSON request with a date with a negative offset large enough to roll the date to the next day
 */
public class RestPostRequestTypesDateTimeMapJSONNegativeOffsetRollToNextDayxlsTest {
    @Test
    public void doTest() throws Exception {
        ...
        map4.put("RESTJSON","{\"message\":{\"dateTimeMap\":{   \n\"date1\":\"2009-12-31T23:50:00.435-14:00\",                   \"date2\":\"2009-12-31T23:50:00.436-14:00\"} \n}}");
