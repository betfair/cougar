...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/byte/SOAP/SOAP_byteInvalidResponse.xls;
...
/**
 * Test that the Cougar service returns a correct error when an invalid value is passed in byte primitive type (SOAP)
 */
public class SOAPbyteInvalidResponseTest {
    @Test
    public void doTest() throws Exception {
        // Create a soap request structure as a Document object
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document requestDocument = xMLHelpers1.getXMLObjectFromString("<ByteSimpleTypeEchoRequest><msg>stringvalue</msg></ByteSimpleTypeEchoRequest>");
        // Get an HTTPCallBean
