...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_QueryParam_Boolean_null.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request passes a null Boolean Query parameter
 */
public class RestIDLQueryParamBooleannullTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, setting the Boolean Query parameter as null
