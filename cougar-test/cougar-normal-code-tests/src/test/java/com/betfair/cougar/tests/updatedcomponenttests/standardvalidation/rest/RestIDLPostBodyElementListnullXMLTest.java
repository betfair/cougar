...
/**
 * Ensure that Cougar returns the correct fault, when a REST XML request contains a null list body parameter
 */
public class RestIDLPostBodyElementListnullXMLTest {
    ...
    public void doTest() throws Exception {
        ...
        cougarManager10.verifyAccessLogEntriesAfterDate(getTimeAsTimeStamp9, new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/testLargePostQA", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/testLargePostQA", "BadRequest") );
    }
