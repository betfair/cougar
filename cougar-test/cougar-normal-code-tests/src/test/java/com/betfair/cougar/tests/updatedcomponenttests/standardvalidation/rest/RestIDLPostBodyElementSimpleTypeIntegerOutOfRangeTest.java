...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_SimpleType_Integer_OutOfRange.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request contains an out of range SimpleType Integer body parameter
 */
public class RestIDLPostBodyElementSimpleTypeIntegerOutOfRangeTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, setting the SimpleType Integer body parameter to be an out of range value
        Map map3 = new HashMap();
        map3.put("HeaderParam","-34");
        getNewHttpCallBean2.setHeaderParams(map3);

        Map map4 = new HashMap();
        map4.put("queryParam","34243");
        getNewHttpCallBean2.setQueryParams(map4);

        getNewHttpCallBean2.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><bodyParameter>21474836470</bodyParameter></message>".getBytes())));
        ...
        cougarManager15.verifyAccessLogEntriesAfterDate(getTimeAsTimeStamp11, new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/i32SimpleTypeOperation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/i32SimpleTypeOperation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/i32SimpleTypeOperation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/i32SimpleTypeOperation", "BadRequest") );
    }
