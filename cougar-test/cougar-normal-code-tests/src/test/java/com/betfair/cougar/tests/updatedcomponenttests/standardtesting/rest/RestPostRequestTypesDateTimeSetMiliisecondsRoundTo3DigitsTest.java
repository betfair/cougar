...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeSet_Miliiseconds_RoundTo3Digits.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeSet data type in the post body with a date with > 3 digits milliseconds accuracy
 */
public class RestPostRequestTypesDateTimeSetMiliisecondsRoundTo3DigitsTest {
    @Test
    public void doTest() throws Exception {
        ...
        String date1 = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2009, (int) 1, (int) 1, (int) 13, (int) 50, (int) 0, (int) 434);
        // Create a date time object expected to be in the response object

        String date2 = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2009, (int) 1, (int) 2, (int) 13, (int) 50, (int) 0, (int) 434);
        // Set the post body to contain a date time set object containing dates with > 3 digits millisecond accuracy
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeSet><Date>2009-01-01T13:50:00.4343Z</Date><Date>2009-01-02T13:50:00.4343Z</Date></dateTimeSet></message>".getBytes())));
        ...
        Document expectedResponseXML = xMLHelpers5.createAsDocument(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream(("<DateTimeSetOperationResponseObject><responseSet><Date>"+date1+"</Date><Date>"+date2+"</Date></responseSet></DateTimeSetOperationResponseObject>").getBytes())));
        // Convert the expected response to REST types for comparison with actual reponses
        Map<CougarMessageProtocolRequestTypeEnum, Object> expectedResponseREST = hinstance.convertResponseToRestTypes(expectedResponseXML, hbean);
        ...
        AssertionUtils.multiAssertEquals(expectedResponseREST.get(CougarMessageProtocolRequestTypeEnum.RESTXML), response6.getResponseObject());
        ...
        AssertionUtils.multiAssertEquals(expectedResponseREST.get(CougarMessageProtocolRequestTypeEnum.RESTJSON), response8.getResponseObject());
        ...
        AssertionUtils.multiAssertEquals(expectedResponseREST.get(CougarMessageProtocolRequestTypeEnum.RESTXML), response9.getResponseObject());
