...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTime_NegativeOffset_2.xls;
...
/**
 * Ensure that Cougar can handle the dateTime data type in the post body with a negative offset
 */
public class RestPostRequestTypesDateTimeNegativeOffset2Test {
    @Test
    public void doTest() throws Exception {
        ...
        String date = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2009, (int) 3, (int) 1, (int) 13, (int) 50, (int) 0, (int) 435);
        // Set the post body to contain a date time object (with a negative offset)
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<bodyParamDateTimeObject><dateTimeParameter>2009-03-01T11:50:00.435-02:00</dateTimeParameter></bodyParamDateTimeObject>".getBytes())));
