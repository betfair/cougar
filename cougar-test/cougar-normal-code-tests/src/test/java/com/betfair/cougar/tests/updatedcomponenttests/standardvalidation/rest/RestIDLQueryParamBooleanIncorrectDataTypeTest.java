...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_QueryParam_Boolean_IncorrectDataType.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request passes a non Boolean object in a Boolean Query parameter
 */
public class RestIDLQueryParamBooleanIncorrectDataTypeTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, setting the Boolean Query parameter as a non boolean
        Map map3 = new HashMap();
        map3.put("HeaderParam","true");
        getNewHttpCallBean2.setHeaderParams(map3);

        Map map4 = new HashMap();
        map4.put("queryParam","fdsfds");
