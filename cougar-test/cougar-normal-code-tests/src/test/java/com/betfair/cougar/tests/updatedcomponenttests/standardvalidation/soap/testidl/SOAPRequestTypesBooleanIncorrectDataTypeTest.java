...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/Test-IDL/SOAP_RequestTypes_Boolean_Incorrect_DataType.xls;
...
/**
 * Ensure that when a SOAP request is received with a Boolean parameter set to an incorrect data type, Cougar returns the correct fault
 */
public class SOAPRequestTypesBooleanIncorrectDataTypeTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<BoolOperationRequest><headerParam>true</headerParam><queryParam>BLAH</queryParam><message><bodyParameter>true</bodyParameter></message></BoolOperationRequest>");
