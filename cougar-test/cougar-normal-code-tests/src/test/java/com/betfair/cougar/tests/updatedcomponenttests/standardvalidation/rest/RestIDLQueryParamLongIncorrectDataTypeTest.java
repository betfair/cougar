...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_QueryParam_Long_IncorrectDataType.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request passes a non Long object in a Long Query parameter
 */
public class RestIDLQueryParamLongIncorrectDataTypeTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, setting the Long Query parameter as a non Long
        Map map3 = new HashMap();
        map3.put("HeaderParam","234");
        getNewHttpCallBean2.setHeaderParams(map3);

        Map map4 = new HashMap();
        map4.put("queryParam","dssdsdv");
