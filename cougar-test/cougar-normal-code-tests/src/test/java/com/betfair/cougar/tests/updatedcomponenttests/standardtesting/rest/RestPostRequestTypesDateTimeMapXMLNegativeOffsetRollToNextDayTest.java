...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeMap_XML_NegativeOffset_RollToNextDay.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeMap data type in the post body of an XML request with a date with a negative offset large enough to roll the date to the next day
 */
public class RestPostRequestTypesDateTimeMapXMLNegativeOffsetRollToNextDayTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the post body to contain a date time map object containing dates with a large enough offset to roll the date to the next day
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeMap><entry key=\"date1\"><Date>2009-12-31T23:50:00.435-14:00</Date></entry><entry key=\"date2\"><Date>2009-12-31T23:50:00.436-14:00</Date></entry></dateTimeMap></message>".getBytes())));
