...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTime_Miliiseconds_RoundTo3Digits2.xls;
...
/**
 * Ensure that Cougar can handle the dateTime data type in the post body with more than 3 digits millisecond accuracy (round up)
 */
public class RestPostRequestTypesDateTimeMiliisecondsRoundTo3Digits2Test {
    @Test
    public void doTest() throws Exception {
        ...
        String date = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2009, (int) 1, (int) 1, (int) 13, (int) 50, (int) 0, (int) 434);
        // Set the post body to contain a date time object (with > 3 digits millisecond accuracy)
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<bodyParamDateTimeObject><dateTimeParameter>2009-01-01T13:50:00.4346Z</dateTimeParameter></bodyParamDateTimeObject>".getBytes())));
        ...
        Document expectedXML = xMLHelpers4.createAsDocument(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream(("<DateTimeOperationResponseObject><localTime>"+date+"</localTime><localTime2>"+date+"</localTime2></DateTimeOperationResponseObject>").getBytes())));
        // Convert the expected response to REST types for comparison with actual responses
        Map<CougarMessageProtocolRequestTypeEnum, Object> expectedREST = cougarManager1.convertResponseToRestTypes(expectedXML, getNewHttpCallBean1);
        ...
        AssertionUtils.multiAssertEquals(expectedREST.get(CougarMessageProtocolRequestTypeEnum.RESTXML), response5.getResponseObject());
        ...
        AssertionUtils.multiAssertEquals(expectedREST.get(CougarMessageProtocolRequestTypeEnum.RESTJSON), response6.getResponseObject());
        ...
        AssertionUtils.multiAssertEquals(expectedREST.get(CougarMessageProtocolRequestTypeEnum.RESTXML), response8.getResponseObject());
