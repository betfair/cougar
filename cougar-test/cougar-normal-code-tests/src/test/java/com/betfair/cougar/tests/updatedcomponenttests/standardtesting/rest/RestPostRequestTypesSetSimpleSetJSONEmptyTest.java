...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_Set_SimpleSet_JSON_Empty.xls;
...
/**
 * Ensure that when a Rest (JSON) Post operation is performed, Cougar can correctly handle an empty simple Set in the post body
 */
public class RestPostRequestTypesSetSimpleSetJSONEmptyTest {
    @Test
    public void doTest() throws Exception {
        ...
        Document createAsDocument10 = xMLHelpers4.getXMLObjectFromString("<SimpleSetOperationResponse><SimpleSetOperationResponseObject><responseSet/></SimpleSetOperationResponseObject></SimpleSetOperationResponse>");
        // Create the expected response as a JSON object
        JSONHelpers jSONHelpers5 = new JSONHelpers();
        JSONObject createAsJSONObject11 = jSONHelpers5.createAsJSONObject(new JSONObject("{\"responseSet\": []}"));
