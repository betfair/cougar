...
// Originally from UpdatedComponentTests/StandardTesting/RPC/RPC_Get_SimpleOperation.xls;
...
/**
 * Ensure that Cougar correctly processes a Batched JSON simple get
 */
public class RPCGetSimpleOperationTest {
    @Test
