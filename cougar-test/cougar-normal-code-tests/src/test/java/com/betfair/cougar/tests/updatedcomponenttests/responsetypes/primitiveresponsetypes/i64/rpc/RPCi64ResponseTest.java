...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/i64/RPC/RPC_i64Response.xls;
package com.betfair.cougar.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.i64.rpc;
...
/**
 * Test that the Cougar service allows to use i64 primitive type in the response (Batched JSON)
 */
public class RPCi64ResponseTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray2[0].put("method","i64SimpleTypeEcho");
        mapArray2[0].put("params","[-2147483647]");
        mapArray2[0].put("id","1");
        mapArray2[1] = new HashMap();
        mapArray2[1].put("method","i64SimpleTypeEcho");
        mapArray2[1].put("params","[-2147483647]");
        ...
        AssertionUtils.multiAssertEquals("{\"id\":1,\"result\":-2147483647,\"jsonrpc\":\"2.0\"}", map5.get("response1"));
        AssertionUtils.multiAssertEquals("{\"id\":2,\"result\":-2147483647,\"jsonrpc\":\"2.0\"}", map5.get("response2"));
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "i64SimpleTypeEcho"),new RequestLogRequirement("2.8", "i64SimpleTypeEcho") );
