...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_Set_SimpleSet_DuplicateEntry.xls;
...
/**
 * Ensure that when a Rest (XML/JSON) Post operation is performed, Cougar can correctly handle a simple Set with a duplicate entry in the post body
 */
public class RestPostRequestTypesSetSimpleSetDuplicateEntryTest {
    @Test
    public void doTest() throws Exception {
        ...
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><simpleSet><String>bbb string</String><String>aaa string</String><String>ddd string</String><String>bbb string</String><String>ddd string</String><String>ccc string</String><String>ddd string</String></simpleSet></message>".getBytes())));
        ...
        Document createAsDocument9 = xMLHelpers3.getXMLObjectFromString("<SimpleSetOperationResponseObject><responseSet><String>aaa string</String><String>bbb string</String><String>ccc string</String><String>ddd string</String></responseSet></SimpleSetOperationResponseObject>");
        ...
        cougarManager1.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp7, new RequestLogRequirement("2.8", "simpleSetOperation"),new RequestLogRequirement("2.8", "simpleSetOperation"),new RequestLogRequirement("2.8", "simpleSetOperation"),new RequestLogRequirement("2.8", "simpleSetOperation") );
    }
