...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/SOAP_RequestTypes_DateTime_LeapYear.xls;
...
/**
 * Ensure that when a SOAP request is received, Cougar can handle the dateTime datatypewith a date on 29th February (in a  leap year)
 */
public class SOAPRequestTypesDateTimeLeapYearTest {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document (with a dateTime parameter on 29th Feb)
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<DateTimeOperationRequest><bodyParamDateTimeObject><dateTimeParameter>2012-02-29T13:50:00Z</dateTimeParameter></bodyParamDateTimeObject></DateTimeOperationRequest>");
