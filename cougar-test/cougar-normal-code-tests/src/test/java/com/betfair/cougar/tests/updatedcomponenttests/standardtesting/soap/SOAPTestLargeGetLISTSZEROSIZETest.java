...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/SOAP_TestLargeGet_LISTS_ZEROSIZE.xls;
...
/**
 * Test to call the testLargeGetRequest operation to check that cougar can return a list containing the given number of items (zero items)
 */
public class SOAPTestLargeGetLISTSZEROSIZETest {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document (giving the number of items expected in the returned list)
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<TestLargeGetRequest><size>0</size></TestLargeGetRequest>");
        ...
        Document createAsDocument10 = xMLHelpers4.getXMLObjectFromString("<response><size>0</size><objects/><oddOrEven>EVEN</oddOrEven></response>");
