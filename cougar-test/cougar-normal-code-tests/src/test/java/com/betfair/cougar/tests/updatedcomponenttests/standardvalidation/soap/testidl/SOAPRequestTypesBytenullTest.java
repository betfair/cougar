 ...
 */
public class SOAPRequestTypesBytenullTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<ByteOperationRequest><queryParam></queryParam><message><bodyParameter>-50</bodyParameter></message></ByteOperationRequest>");
