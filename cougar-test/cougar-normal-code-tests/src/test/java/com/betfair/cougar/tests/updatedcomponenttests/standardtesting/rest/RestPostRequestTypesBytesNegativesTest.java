...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_Bytes_Negatives.xls;
...
/**
 * Ensure that Cougar can handle negative Bytes passed in the post body, header params and query params
 */
public class RestPostRequestTypesBytesNegativesTest {
    @Test
    public void doTest() throws Exception {
        ...
        hbean.setVersion("v2");
        // Set each of the parameter types to contain a negative byte datatype object
        Map<String, String> headerParams = new HashMap<String, String>();
        headerParams.put("HeaderParam","-1");
        hbean.setHeaderParams(headerParams);
        Map<String, String> queryParams = new HashMap<String, String>();
        queryParams.put("queryParam","-50");
