...
// Originally from UpdatedComponentTests/StandardTesting/RPC/RPC_Post_RequestTypes_DateTimeSet_ZeroOffset.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeSet data type with Zero Offsets in the post body of an RPC request
 */
public class RPCPostRequestTypesDateTimeSetZeroOffsetTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray2[0].put("params","[{\"dateTimeSet\":[\"2009-06-01T11:50:00.435Z\",\"2009-06-02T11:50:00.435Z\"]}]");
        mapArray2[0].put("id","\"DateTimeSetZeroOff\"");
        mapArray2[1] = new HashMap();
        mapArray2[1].put("method","dateTimeSetOperation");
        mapArray2[1].put("params","[{\"dateTimeSet\":[\"2009-02-01T11:50:00.435Z\",\"2009-02-02T11:50:00.435Z\"]}]");
        mapArray2[1].put("id","\"DateTimeSetZeroOff2\"");
        ...
        AssertionUtils.multiAssertEquals("{\"id\":\"DateTimeSetZeroOff\",\"result\":{\"responseSet\":[\"2009-06-01T11:50:00.435Z\",\"2009-06-02T11:50:00.435Z\"]},\"jsonrpc\":\"2.0\"}", map5.get("responseDateTimeSetZeroOff"));
        AssertionUtils.multiAssertEquals("{\"id\":\"DateTimeSetZeroOff2\",\"result\":{\"responseSet\":[\"2009-02-01T11:50:00.435Z\",\"2009-02-02T11:50:00.435Z\"]},\"jsonrpc\":\"2.0\"}", map5.get("responseDateTimeSetZeroOff2"));
