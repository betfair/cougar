...
/**
 * Ensure that Cougar can handle the dateTimeList data type in the post body containing dates with positive offsets large enough to roll the date to the previous day
 */
