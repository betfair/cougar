...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_Double_null.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a request passes null in a Double parameter
 */
public class RestIDLHeaderParamDoublenullTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the Double Header param as null
