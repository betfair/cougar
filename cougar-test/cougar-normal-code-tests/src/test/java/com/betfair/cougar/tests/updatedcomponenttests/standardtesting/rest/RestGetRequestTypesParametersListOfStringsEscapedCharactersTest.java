...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Get_RequestTypes_Parameters_ListOfStrings_EscapedCharacters.xls;
...
/**
 * Ensure that when the 4 supported Rest XML/JSON Gets are performed, Cougar can handle a List of Strings containing escaped characters being passed in the Header and Query parameters
 */
public class RestGetRequestTypesParametersListOfStringsEscapedCharactersTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters to lists of string containing escaped characters
        ...
        Document xmlDocument = xMLHelpers5.getXMLObjectFromString("<NonMandatoryParamsOperationResponseObject><headerParameter>a header1,:header2,this &amp; that is 100%</headerParameter><queryParameter>a query1,:query2,this &amp; that is 100%</queryParameter></NonMandatoryParamsOperationResponseObject>");
