...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_IncorrectTag.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request contains a body parameter containing an incorrect tag (i.e. A tag that is not expected in that object)
 */
public class RestIDLPostBodyElementIncorrectTagTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the post body as an object containing an incorrect tag (unexpectedtag is not a field of ComplexObject)
        getNewHttpCallBean2.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><name>sum</name><unexpectedtag>7</unexpectedtag><value2>75</value2></message>".getBytes())));
