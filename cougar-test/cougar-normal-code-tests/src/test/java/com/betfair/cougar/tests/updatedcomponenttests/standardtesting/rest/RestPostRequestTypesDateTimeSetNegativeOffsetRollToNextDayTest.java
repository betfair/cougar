...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeSet_NegativeOffset_RollToNextDay.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeSet data type in the post body with a date with a negative offset large enough to roll the date to the next day
 */
public class RestPostRequestTypesDateTimeSetNegativeOffsetRollToNextDayTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the post body to contain a date time set object containing dates with a large enough offset to roll the date to the next day
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeSet><Date>2009-12-31T23:50:00.435-14:00</Date><Date>2009-12-31T23:50:00.436-14:00</Date></dateTimeSet></message>".getBytes())));
