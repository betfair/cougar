...
// Originally from UpdatedComponentTests/ErrorCodes/RPC/RPC_Get_SimpleExceptions_GENERIC.xls;
...
/**
 * Ensure that Cougar can correctly throw a simple exception with error code: GENERIC from a batched request
 */
public class RPCGetSimpleExceptionsGENERICTest {
    @Test
    public void doTest() throws Exception {
        ...
        AssertionUtils.multiAssertEquals("{\"id\":1,\"error\":{\"message\":\"SEX-0001\",\"data\":{\"SimpleException\":{\"reason\":\"GENERIC\",\"errorCode\":\"GENERIC\"},\"exceptionname\":\"SimpleException\"},\"code\":-32099},\"jsonrpc\":\"2.0\"}", map5.get("response1"));
        AssertionUtils.multiAssertEquals("{\"id\":2,\"error\":{\"message\":\"SEX-0001\",\"data\":{\"SimpleException\":{\"reason\":\"GENERIC\",\"errorCode\":\"GENERIC\"},\"exceptionname\":\"SimpleException\"},\"code\":-32099},\"jsonrpc\":\"2.0\"}", map5.get("response2"));
