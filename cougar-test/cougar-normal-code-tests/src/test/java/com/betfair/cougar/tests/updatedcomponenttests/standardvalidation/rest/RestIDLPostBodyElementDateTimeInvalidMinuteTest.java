...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_DateTime_InvalidMinute.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request contains a DateTime body parameter with a time containing an invalid minute
 */
public class RestIDLPostBodyElementDateTimeInvalidMinuteTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the DateTime body parameter, including a time with an invalid minute (00:60:00)
        getNewHttpCallBean2.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<BodyParamDateTimeObject><dateTimeParameter>2009-12-01T00:60:00.000Z</dateTimeParameter></BodyParamDateTimeObject>".getBytes())));
