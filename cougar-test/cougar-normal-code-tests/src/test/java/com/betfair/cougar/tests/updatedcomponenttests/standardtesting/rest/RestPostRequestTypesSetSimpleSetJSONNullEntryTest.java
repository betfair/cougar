...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_Set_SimpleSet_JSON_NullEntry.xls;
...
/**
 * Ensure that when a Rest (JSON) Post operation is performed, Cougar can correctly handle a simple Set with a null entry in the post body
 */
public class RestPostRequestTypesSetSimpleSetJSONNullEntryTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the post body to contain a simple set with a null entry
        ...
        JSONObject createAsJSONObject11 = jSONHelpers5.createAsJSONObject(new JSONObject("{\"responseSet\": [null,\"bbb string\",\"ccc string\",\"ddd string\"]}"));
