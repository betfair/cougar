...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeSet_Miliiseconds_FillTo3Digits.xls;
 ...
 */
public class RestPostRequestTypesDateTimeSetMiliisecondsFillTo3DigitsTest {
    @Test
    public void doTest() throws Exception {
        ...
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeSet><Date>2009-01-01T13:50:00.43Z</Date><Date>2009-01-02T13:50:00.43Z</Date></dateTimeSet></message>".getBytes())));
        ...
        Document createAsDocument11 = xMLHelpers5.createAsDocument(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream(("<DateTimeSetOperationResponseObject><responseSet><Date>"+date1+"</Date><Date>"+date2+"</Date></responseSet></DateTimeSetOperationResponseObject>").getBytes())));
