...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeSet_PositiveOffset_HoursAndMinutes.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeSet data type in the post body with a date with a positive offset with hours and minutes (0230 = offset by 2 hours 30 minutes)
 */
public class RestPostRequestTypesDateTimeSetPositiveOffsetHoursAndMinutesTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the post body to contain a date time set object containing dates with a positive offset
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeSet><Date>2009-06-01T15:50:00.435+02:30</Date><Date>2009-06-01T16:50:00.435+02:30</Date></dateTimeSet></message>".getBytes())));
