...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_Boolean_null.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a request passes null in a Boolean parameter
 */
public class RestIDLHeaderParamBooleannullTest {
    @Test
