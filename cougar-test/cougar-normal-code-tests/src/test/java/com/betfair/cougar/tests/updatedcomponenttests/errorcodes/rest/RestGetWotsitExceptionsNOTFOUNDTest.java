...
// Originally from UpdatedComponentTests/ErrorCodes/Rest/Rest_Get_WotsitExceptions_NOT_FOUND.xls;
...
/**
 * Ensure that Cougar can correctly throw a wotsit exception with error code: NOT_FOUND.
 */
public class RestGetWotsitExceptionsNOTFOUNDTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the query parameter to tell the operation which exception to throw (NOT_FOUND)
        Map map2 = new HashMap();
        map2.put("message","NOT_FOUND");
        ...
        Document createAsDocument10 = xMLHelpers4.getXMLObjectFromString("<fault><faultcode>Client</faultcode><faultstring>WEX-0003</faultstring><detail><exceptionname>WotsitException</exceptionname><WotsitException><errorCode>NOT_FOUND</errorCode><type>SPICY</type><clientMessage>NOT_FOUND</clientMessage></WotsitException></detail></fault>");
