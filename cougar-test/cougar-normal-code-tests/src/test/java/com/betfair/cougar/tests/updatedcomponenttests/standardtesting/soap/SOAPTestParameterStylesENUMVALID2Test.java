...
public class SOAPTestParameterStylesENUMVALID2Test {
    ...
    public void doTest() throws Exception {
        ...
        Document createAsDocument10 = xMLHelpers5.createAsDocument(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream(("<response><message>headerParam=Bar,queryParam=qp1,dateQueryParam="+convertedDate1+"</message></response>").getBytes())));
