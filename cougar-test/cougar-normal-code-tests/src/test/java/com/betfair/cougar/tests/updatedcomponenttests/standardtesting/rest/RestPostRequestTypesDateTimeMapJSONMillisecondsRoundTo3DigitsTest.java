...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeMap_JSON_Milliseconds_RoundTo3Digits.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeMap data type in the post body of a JSON request containg a date with milliseconds accuracy > 3 digits
 */
public class RestPostRequestTypesDateTimeMapJSONMillisecondsRoundTo3DigitsTest {
    @Test
    public void doTest() throws Exception {
        ...
        map4.put("RESTJSON","{\"message\":{\"dateTimeMap\":{   \n\"date1\":\"2009-06-01T13:50:00.4343Z\",                   \"date2\":\"2009-06-01T14:50:00.4343Z\"} \n}}");
