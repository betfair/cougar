...
/**
 * Test that when SOAP request operation is performed against Cougar, passing in a Map with a duplicate key, it is correctly  processed and the correct response map is returned.
 */
