...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTime_NoOffsetSpecified.xls;
 ...
 */
public class RestPostRequestTypesDateTimeNoOffsetSpecifiedTest {
    @Test
    public void doTest() throws Exception {
        ...
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<bodyParamDateTimeObject><dateTimeParameter>2009-06-01T11:50:00.435</dateTimeParameter></bodyParamDateTimeObject>".getBytes())));
