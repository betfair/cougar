...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_ListOfStrings_MandatoryNotSet.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a request is missing a mandatory list of string parameter
 */
public class RestIDLHeaderParamListOfStringsMandatoryNotSetTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set parameters but don't set the mandatory List of string header parameter
