...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/float/RPC/RPC_floatInvalidResponse.xls;
...
/**
 * Test that the Cougar service throws a correct error when invalid value is passed to  float primitive type parameter (Batched JSON)
 */
public class RPCfloatInvalidResponseTest {
    @Test
