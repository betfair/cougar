...
/**
 * Test that when SOAP request operation is performed against Cougar, passing in an empty Map , it is correctly  processed and the correct response  is returned.
 */
