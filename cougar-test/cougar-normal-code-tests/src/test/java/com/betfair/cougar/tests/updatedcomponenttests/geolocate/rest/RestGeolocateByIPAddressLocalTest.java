...
// Originally from UpdatedComponentTests/Geolocate/Rest/Rest_Geolocate_ByIPAddress_Local.xls;
...
/**
 * Ensure that when a Rest JSON request is received by Cougar, the ipaddress is used to correctly identify where the request originated, in this case: LocalHost
 */
public class RestGeolocateByIPAddressLocalTest {
    @Test
    public void doTest() throws Exception {
        ...
        getNewHttpCallBean1.setIpAddress("127.0.0.1");
        ...
        // In particular check the IPLocation field of the Access log gives the correct location, in this case -- as it is a local IP address
        cougarManager1.verifyAccessLogEntriesAfterDate(getTimeAsTimeStamp8, new AccessLogRequirement("127.0.0.1", "/cougarBaseline/v2/simple", "Ok"),new AccessLogRequirement("127.0.0.1", "/cougarBaseline/v2/simple", "Ok"),new AccessLogRequirement("127.0.0.1", "/cougarBaseline/v2/simple", "Ok"),new AccessLogRequirement("127.0.0.1", "/cougarBaseline/v2/simple", "Ok") );
    }
