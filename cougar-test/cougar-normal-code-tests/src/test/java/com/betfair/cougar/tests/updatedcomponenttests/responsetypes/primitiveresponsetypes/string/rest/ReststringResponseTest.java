...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/string/REST/Rest_stringResponse.xls;
package com.betfair.cougar.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.string.rest;
...
/**
 * Test that the Cougar service allows to use string primitive type in the response (REST)
 */
public class ReststringResponseTest {
    @Test
    public void doTest() throws Exception {
        ...
        Document responseDocument = xMLHelpers4.getXMLObjectFromString("<String>foo</String>");
        ...
        CougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "stringSimpleTypeEcho"),new RequestLogRequirement("2.8", "stringSimpleTypeEcho"),new RequestLogRequirement("2.8", "stringSimpleTypeEcho"),new RequestLogRequirement("2.8", "stringSimpleTypeEcho") );
    }
