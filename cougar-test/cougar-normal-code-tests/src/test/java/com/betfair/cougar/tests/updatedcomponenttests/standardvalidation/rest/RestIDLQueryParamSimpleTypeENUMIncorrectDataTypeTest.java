...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_QueryParam_SimpleType_ENUM_IncorrectDataType.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request passes a SimpleTypeENUM Query parameter containing an invalid value
 */
public class RestIDLQueryParamSimpleTypeENUMIncorrectDataTypeTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, setting the SimpleTypeENUM Query parameter to be an invalid value
        Map map3 = new HashMap();
        map3.put("HeaderParam","BAR");
        getNewHttpCallBean2.setHeaderParams(map3);

        Map map4 = new HashMap();
        map4.put("queryParam","InvalidValue");
