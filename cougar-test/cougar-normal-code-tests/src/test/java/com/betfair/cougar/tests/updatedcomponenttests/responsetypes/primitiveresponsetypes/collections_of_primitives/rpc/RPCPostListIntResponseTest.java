...
/**
 * Ensure that when a Batched JSON Post request is performed against Cougar, passing a List in the post body, it is correctly de-serialized, processed, returned the correct response.
 */
public class RPCPostListIntResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "i32ListSimpleTypeEcho"),new RequestLogRequirement("2.8", "i32ListSimpleTypeEcho") );
