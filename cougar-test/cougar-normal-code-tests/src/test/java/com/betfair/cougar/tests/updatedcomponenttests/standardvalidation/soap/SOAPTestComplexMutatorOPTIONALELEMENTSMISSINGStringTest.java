...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/SOAP_TestComplexMutator_OPTIONALELEMENTS_MISSING_String.xls;
 ...
 */
public class SOAPTestComplexMutatorOPTIONALELEMENTSMISSINGStringTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            // Create the SOAP request as an XML Document (with a missing non mandatory parameter, name)
            XMLHelpers xMLHelpers2 = new XMLHelpers();
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<TestComplexMutatorRequest><message><value1>7</value1></message></TestComplexMutatorRequest>");
