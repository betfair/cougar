...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/SOAP_TestLargePost_ZEROONEMANY_1.xls;
...
/**
 * Test that when Cougar is passed a Large Request it can correctly deserialise it and count how many items are in the list (incorrect odd number of items given)
 */
public class SOAPTestLargePostZEROONEMANY1Test {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<TestLargePostRequest><largeRequest><size>2</size><objects><ComplexObject><name>ssasdf</name><value1>23</value1><value2>42</value2></ComplexObject></objects><oddOrEven>ODD</oddOrEven></largeRequest></TestLargePostRequest>");
