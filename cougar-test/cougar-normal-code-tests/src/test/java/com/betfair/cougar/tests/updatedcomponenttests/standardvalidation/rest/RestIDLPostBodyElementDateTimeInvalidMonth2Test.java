...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_DateTime_InvalidMonth_2.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request contains a DateTime body parameter with a time containing an invalid month
 */
public class RestIDLPostBodyElementDateTimeInvalidMonth2Test {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the DateTime body parameter, including a time with an invalid month (2009-00-01)
        getNewHttpCallBean2.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<BodyParamDateTimeObject><dateTimeParameter>2009-00-01T13:50:00.435Z</dateTimeParameter></BodyParamDateTimeObject>".getBytes())));
