...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/Test-IDL/SOAP_RequestTypes_Double_Null.xls;
...
/**
 * Ensure that when a SOAP request is received with a null Double parameter, Cougar returns the correct fault
 */
public class SOAPRequestTypesDoubleNullTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<DoubleOperationRequest><headerParam>45.5</headerParam><queryParam></queryParam><message><bodyParameter>43.44</bodyParameter></message></DoubleOperationRequest>");
