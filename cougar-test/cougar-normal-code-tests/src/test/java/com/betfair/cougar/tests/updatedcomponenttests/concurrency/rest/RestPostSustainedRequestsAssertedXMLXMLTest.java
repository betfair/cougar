...
// Originally from UpdatedComponentTests/Concurrency/Rest/Rest_Post_SustainedRequestsAssertedXMLXML.xls;
...
/**
 * Ensure that when sustained Rest XML post requests are performed against Cougar, each request is successfully sent and the XML response to each is correctly handled
 */
public class RestPostSustainedRequestsAssertedXMLXMLTest {
    @Test
    public void doTest() throws Exception {
        ...
        RestSustainedPostRequestsJETTTest.RestSustainedPostRequestsTestResultBean executeTest3 = new RestSustainedPostRequestsJETTTest().executeTest(4000, CougarMessageProtocolRequestTypeEnum.RESTXML, CougarMessageContentTypeEnum.XML);
