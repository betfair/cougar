...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_Floats_Negatives.xls;
...
/**
 * Ensure that Cougar can handle Negative Floats in the post body, header params and query params
 */
public class RestPostRequestTypesFloatsNegativesTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set each of the parameter types to contain a negative float datatype object
        ...
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><bodyParameter>-6.0E-4</bodyParameter></message>".getBytes())));
