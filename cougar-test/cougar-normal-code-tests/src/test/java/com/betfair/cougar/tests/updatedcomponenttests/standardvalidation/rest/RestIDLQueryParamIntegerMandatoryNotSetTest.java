...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_QueryParam_Integer_Mandatory_NotSet.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request i missing a mandatory Integer Query parameter
 */
public class RestIDLQueryParamIntegerMandatoryNotSetTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, don't set the Integer Query parameter
