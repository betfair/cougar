...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_Map_SimpleMap_JSON_DuplicateKey.xls;
...
/**
 * Ensure that when a Rest (JSON) Post operation is performed, Cougar can correctly handle a simple Map with a duplicate key in the post body
 */
public class RestPostRequestTypesMapSimpleMapJSONDuplicateKeyTest {
    @Test
    public void doTest() throws Exception {
        ...
        JSONObject createAsJSONObject11 = jSONHelpers5.createAsJSONObject(new JSONObject("{\"responseMap\": {\"AAA\": \"Value for AAA\",\"aaa\": \"Value for aaa\",\"bbb\": \"Value for bbb\",\"ccc\": \"Value for ccc\"}}"));
