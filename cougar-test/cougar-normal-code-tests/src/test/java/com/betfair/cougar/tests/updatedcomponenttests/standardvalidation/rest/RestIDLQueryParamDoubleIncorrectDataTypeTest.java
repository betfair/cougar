...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_QueryParam_Double_IncorrectDataType.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request passes a non Double object in a Double Query parameter
 */
public class RestIDLQueryParamDoubleIncorrectDataTypeTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, setting the Double Query parameter as a non Double
        Map map3 = new HashMap();
        map3.put("HeaderParam","234.56");
        getNewHttpCallBean2.setHeaderParams(map3);

        Map map4 = new HashMap();
        map4.put("queryParam","fdfdfds");
