...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/boolean/REST/Rest_booleanResponse.xls;
package com.betfair.cougar.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.booleanz.rest;
...
/**
 * Test that the Cougar service allows to use boolean primitive type in the response (REST)
 */
public class RestbooleanResponseTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set operation  name 
        HTTPCallBean.setOperationName("BoolSimpleTypeEcho", "boolEcho");
        ...
        Document responseDocument = xMLHelpers4.getXMLObjectFromString("<Boolean>true</Boolean>");
        ...
        CougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "boolSimpleTypeEcho"),new RequestLogRequirement("2.8", "boolSimpleTypeEcho"),new RequestLogRequirement("2.8", "boolSimpleTypeEcho"),new RequestLogRequirement("2.8", "boolSimpleTypeEcho") );
    }
