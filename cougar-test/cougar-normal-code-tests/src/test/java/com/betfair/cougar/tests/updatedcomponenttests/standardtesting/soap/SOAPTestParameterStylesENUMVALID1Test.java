...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/SOAP_TestParameterStyles_ENUM_VALID_1.xls;
...
/**
 * Test that Cougar can correctly handle a valid ENUM. In this case HeaderParam is Foo
 */
public class SOAPTestParameterStylesENUMVALID1Test {
    @Test
    public void doTest() throws Exception {
        ...
        Document createAsDocument1 = xMLHelpers2.getXMLObjectFromString("<TestParameterStylesQARequest><HeaderParam>Foo</HeaderParam><queryParam>qp1</queryParam><dateQueryParam>2009-06-01T13:50:00.000Z</dateQueryParam></TestParameterStylesQARequest>");
        ...
        Document createAsDocument10 = xMLHelpers5.createAsDocument(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream(("<response><message>headerParam=Foo,queryParam=qp1,dateQueryParam="+cougarHelpers1.dateInUTC(convertedDate1)+"</message></response>").getBytes())));
