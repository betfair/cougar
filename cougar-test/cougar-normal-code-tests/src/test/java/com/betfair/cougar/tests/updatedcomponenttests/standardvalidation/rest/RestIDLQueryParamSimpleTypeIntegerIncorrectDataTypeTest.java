...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_QueryParam_SimpleType_Integer_IncorrectDataType.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request passes a non integer in the SimpleTypeInteger Query parameter
 */
public class RestIDLQueryParamSimpleTypeIntegerIncorrectDataTypeTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, setting the SimpleTypeInteger Query parameter to be a non Integer
        Map map3 = new HashMap();
        map3.put("HeaderParam","354354");
        getNewHttpCallBean2.setHeaderParams(map3);

        Map map4 = new HashMap();
        map4.put("queryParam","notaninteger");
