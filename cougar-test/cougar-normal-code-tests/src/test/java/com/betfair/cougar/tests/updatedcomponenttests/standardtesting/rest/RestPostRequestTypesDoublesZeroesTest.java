...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_Doubles_Zeroes.xls;
...
/**
 * Ensure that Cougar can handle Doubles in the post body, header params and query params that are zeroes
 */
public class RestPostRequestTypesDoublesZeroesTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set each of the parameter types to contain a double datatype object
        Map map2 = new HashMap();
        map2.put("HeaderParam","0.0");
        getNewHttpCallBean1.setHeaderParams(map2);
        
        Map map3 = new HashMap();
        map3.put("queryParam","0.0");
        getNewHttpCallBean1.setQueryParams(map3);
        
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><bodyParameter>0.0</bodyParameter></message>".getBytes())));
        ...
        Document createAsDocument11 = xMLHelpers5.getXMLObjectFromString("<DoubleOperationResponseObject><bodyParameter>0.0</bodyParameter><headerParameter>0.0</headerParameter><queryParameter>0.0</queryParameter></DoubleOperationResponseObject>");
