...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/datetime/REST/Rest_dateTimeResponse.xls;
package com.betfair.cougar.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.datetime.rest;
...
/**
 * Test that the Cougar service allows to use dateTime primitive type in the response (REST)
 */
public class RestdateTimeResponseTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set operation  name 
        HTTPCallBean.setOperationName("dateTimeSimpleTypeEcho", "dateTimeEcho");
        ...
        Document responseDocument = xMLHelpers4.getXMLObjectFromString("<Date>2011-01-10T00:00:00.000Z</Date>");
        ...
        CougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "dateTimeSimpleTypeEcho"),new RequestLogRequirement("2.8", "dateTimeSimpleTypeEcho"),new RequestLogRequirement("2.8", "dateTimeSimpleTypeEcho"),new RequestLogRequirement("2.8", "dateTimeSimpleTypeEcho") );
    }
