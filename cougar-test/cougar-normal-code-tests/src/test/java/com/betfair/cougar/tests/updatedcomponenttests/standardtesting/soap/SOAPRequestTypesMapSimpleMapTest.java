...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/SOAP_RequestTypes_Map_SimpleMap.xls;
...
/**
 * Ensure that when a SOAP request is received, Cougar can handle a SimpleMap datatype parameter
 */
public class SOAPRequestTypesMapSimpleMapTest {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document (with a simple map parameter)
