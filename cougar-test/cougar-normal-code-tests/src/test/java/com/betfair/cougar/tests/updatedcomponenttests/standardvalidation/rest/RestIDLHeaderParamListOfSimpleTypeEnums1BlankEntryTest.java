...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_ListOfSimpleTypeEnums_1BlankEntry.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a request passes a blank list of simple type enum
 */
public class RestIDLHeaderParamListOfSimpleTypeEnums1BlankEntryTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the List of Simple Type Enum header parameter to a blank list
