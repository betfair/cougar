...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/SOAP_RequestTypes_DateTimeList_InvalidFormat_NoTime.xls;
...
/**
 * Ensure that when a SOAP request is received with an invalid dateTimeList format (no time is set), Cougar returns the correct fault
 */
public class SOAPRequestTypesDateTimeListInvalidFormatNoTimeTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            // Create the SOAP request as an XML Document (containing a dateTimeList object in an invalid format)
            XMLHelpers xMLHelpers2 = new XMLHelpers();
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<DateTimeListOperationRequest><message><dateTimeList><Date>A009-06-01T13:50:00.0Z</Date><Date>A009-06-02T13:50:00.0Z</Date></dateTimeList></message></DateTimeListOperationRequest>");
