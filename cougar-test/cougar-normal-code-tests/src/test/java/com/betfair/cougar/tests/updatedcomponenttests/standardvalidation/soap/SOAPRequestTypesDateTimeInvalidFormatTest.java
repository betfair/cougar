...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/SOAP_RequestTypes_DateTime_InvalidFormat.xls;
 ...
 */
public class SOAPRequestTypesDateTimeInvalidFormatTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<DateTimeOperationRequest><bodyParamDateTimeObject><dateTimeParameter>A009-06-01T13:50:00.0Z</dateTimeParameter></bodyParamDateTimeObject></DateTimeOperationRequest>");
