...
// Originally from UpdatedComponentTests/ErrorCodes/RPC/RPC_Get_WotsitExceptions_CLOSED.xls;
...
/**
 * Ensure that Cougar can correctly throw a wotsit exception with error code: CLOSED from a batched request
 */
public class RPCGetWotsitExceptionsCLOSEDTest {
    @Test
    public void doTest() throws Exception {
        ...
        AssertionUtils.multiAssertEquals("{\"id\":1,\"error\":{\"message\":\"WEX-0001\",\"data\":{\"WotsitException\":{\"clientMessage\":\"CLOSED\",\"errorCode\":\"CLOSED\",\"type\":\"SPICY\"},\"exceptionname\":\"WotsitException\"},\"code\":-32099},\"jsonrpc\":\"2.0\"}", map5.get("response1"));
        AssertionUtils.multiAssertEquals("{\"id\":2,\"error\":{\"message\":\"WEX-0001\",\"data\":{\"WotsitException\":{\"clientMessage\":\"CLOSED\",\"errorCode\":\"CLOSED\",\"type\":\"SPICY\"},\"exceptionname\":\"WotsitException\"},\"code\":-32099},\"jsonrpc\":\"2.0\"}", map5.get("response2"));
