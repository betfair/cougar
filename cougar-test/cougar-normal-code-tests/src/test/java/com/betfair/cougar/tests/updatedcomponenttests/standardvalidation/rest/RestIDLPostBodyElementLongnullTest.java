...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_Long_null.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request contains a null Long body parameter
 */
public class RestIDLPostBodyElementLongnullTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the Long body parameter to null
