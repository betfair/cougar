...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_PostBody_String_SpecialCharacters_2.xls;
...
/**
 * Ensure that when a Rest XML/JSON Post is performed, Cougar can handle a String in the PostBody that contains the special character \
 */
public class RestPostPostBodyStringSpecialCharacters2Test {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the post body for the request, setting one of the string parameters to contain the special character being tested \
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><name>this is a \\n slash+n</name><value1>7</value1><value2>75</value2></message>".getBytes())));
        ...
        Document createAsDocument9 = xMLHelpers3.getXMLObjectFromString("<SimpleResponse><message>this is a \\n slash+n = 82</message></SimpleResponse>");
