...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/double/SOAP/SOAP_doubleInvalidResponse.xls;
...
/**
 * Test that the Cougar service returns a correct error when an invalid value is passed in double primitive type (SOAP)
 */
public class SOAPdoubleInvalidResponseTest {
    @Test
    public void doTest() throws Exception {
        // Create a soap request structure as a Document object
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document requestDocument = xMLHelpers1.getXMLObjectFromString("<DoubleSimpleTypeEchoRequest><msg>stringvalue</msg></DoubleSimpleTypeEchoRequest>");
        // Get an HTTPCallBean
