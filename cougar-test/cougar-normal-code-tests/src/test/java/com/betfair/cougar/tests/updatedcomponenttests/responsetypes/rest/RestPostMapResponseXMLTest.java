...
// Originally from UpdatedComponentTests/ResponseTypes/REST/Rest_Post_MapResponse_XML.xls;
...
/**
 * Ensure that when a Rest (XML) Post operation is performed against Cougar, passing in a Map in the post body, it is correctly de-serialized, processed, returned the correct Map response.
 */
public class RestPostMapResponseXMLTest {
    @Test
    public void doTest() throws Exception {
        ...
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<inputMap><entry key=\"bbb\"><String>Value for bbb</String></entry><entry key=\"aaa\"><String>Value for aaa</String></entry><entry key=\"AAA\"><String>Value for AAA</String></entry><entry key=\"ccc\"><String>Value for ccc</String></entry></inputMap>".getBytes())));
