...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Get_RequestTypes_Parameters_ListOfSimpleTypeEnum.xls;
...
/**
 * Ensure that when the 4 supported Rest XML/JSON Gets are performed, Cougar can handle a List of Simple Type Enums being passed in the Header and Query parameters
 */
public class RestGetRequestTypesParametersListOfSimpleTypeEnumTest {
    @Test
    public void doTest() throws Exception {
        ...
        httpCallBeanBaseline.setOperationName("simpleEnumListOperation");
        // Set the parameters to lists of simple type enums
        Map map2 = new HashMap();
        map2.put("HeaderParam","FOO,FOOBAR,BARFOO");
        httpCallBeanBaseline.setHeaderParams(map2);
        
        Map map3 = new HashMap();
        map3.put("queryParam","FOOFOO,BARBAR,FOOFOO");
        ...
        Document xmlDocument = xMLHelpers5.getXMLObjectFromString("<NonMandatoryParamsOperationResponseObject><headerParameter>FOO,FOOBAR,BARFOO</headerParameter><queryParameter>FOOFOO,BARBAR,FOOFOO</queryParameter></NonMandatoryParamsOperationResponseObject>");
        ...
        cougarManagerBaseline.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "simpleEnumListOperation"),new RequestLogRequirement("2.8", "simpleEnumListOperation"),new RequestLogRequirement("2.8", "simpleEnumListOperation"),new RequestLogRequirement("2.8", "simpleEnumListOperation") );
    }
