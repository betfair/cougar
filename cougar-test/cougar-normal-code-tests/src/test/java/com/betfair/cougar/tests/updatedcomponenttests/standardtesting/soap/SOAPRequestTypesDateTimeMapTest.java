...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/SOAP_RequestTypes_DateTimeMap.xls;
...
/**
 * Ensure that when a SOAP request is received, Cougar can handle the dateTimeMap datatype
 */
public class SOAPRequestTypesDateTimeMapTest {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document (with a dateTimeMap parameter)
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<DateTimeMapOperationRequest><message><dateTimeMap><entry key=\"date1\"><Date>2009-06-01T13:50:00.000Z</Date></entry><entry key=\"date2\"><Date>2009-06-01T14:50:00.000Z</Date></entry></dateTimeMap></message></DateTimeMapOperationRequest>");
