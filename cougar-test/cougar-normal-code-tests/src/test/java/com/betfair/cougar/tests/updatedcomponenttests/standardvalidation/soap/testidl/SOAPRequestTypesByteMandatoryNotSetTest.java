...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/Test-IDL/SOAP_RequestTypes_Byte_Mandatory_NotSet.xls;
...
/**
 * Ensure that when a SOAP request is received with a mandatory Byte parameter not set, Cougar returns the correct fault
 */
public class SOAPRequestTypesByteMandatoryNotSetTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            // Create the SOAP request as an XML Document (with a missing mandatory byte parameter)
            XMLHelpers xMLHelpers2 = new XMLHelpers();
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<ByteOperationRequest><queryParam>50</queryParam><message><bodyParameter>V2liYmxlIFdvYmJsZSBXdWJibGUgRmxvYg==</bodyParameter></message></ByteOperationRequest>");
