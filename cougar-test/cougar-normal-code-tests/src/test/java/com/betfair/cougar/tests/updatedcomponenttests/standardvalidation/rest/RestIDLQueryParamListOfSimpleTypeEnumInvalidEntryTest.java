...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_QueryParam_ListOfSimpleTypeEnum_InvalidEntry.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request passes a List of SimpleTypeEnum Query parameter containing an invalid entry
 */
public class RestIDLQueryParamListOfSimpleTypeEnumInvalidEntryTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, setting the List of SimpleTypeEnum Query parameter to contain an invalid entry (WHATEVER is not a valid ENUM)
