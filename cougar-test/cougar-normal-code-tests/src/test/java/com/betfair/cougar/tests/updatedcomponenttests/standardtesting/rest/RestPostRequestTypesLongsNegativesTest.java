...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_Longs_Negatives.xls;
...
/**
 * Ensure that Cougar can handle Negative Longs in the post body, header params and query params
 */
public class RestPostRequestTypesLongsNegativesTest {
    @Test
    public void doTest() throws Exception {
        ...
        getNewHttpCallBean1.setOperationName("i64Operation");
        
        getNewHttpCallBean1.setServiceName("baseline", "cougarBaseline");
        
        getNewHttpCallBean1.setVersion("v2");
        // Set each of the parameter types to contain a negative long datatype object
        Map map2 = new HashMap();
        map2.put("HeaderParam","-21474836473");
        getNewHttpCallBean1.setHeaderParams(map2);
        
        Map map3 = new HashMap();
        map3.put("queryParam","-21474836465");
        getNewHttpCallBean1.setQueryParams(map3);
        
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><bodyParameter>-21474836423</bodyParameter></message>".getBytes())));
        ...
        Document createAsDocument11 = xMLHelpers5.getXMLObjectFromString("<I64OperationResponseObject><bodyParameter>-21474836423</bodyParameter><headerParameter>-21474836473</headerParameter><queryParameter>-21474836465</queryParameter></I64OperationResponseObject>");
        ...
        cougarManager1.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp9, new RequestLogRequirement("2.8", "i64Operation"),new RequestLogRequirement("2.8", "i64Operation"),new RequestLogRequirement("2.8", "i64Operation"),new RequestLogRequirement("2.8", "i64Operation") );
    }
