...
// Originally from UpdatedComponentTests/ErrorCodes/Rest/Rest_Get_SimpleExceptions_TIMEOUT.xls;
...
/**
 * Ensure that Cougar can correctly throw a simple exception with error code: TIMEOUT.
 */
public class RestGetSimpleExceptionsTIMEOUTTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the query parameter to tell the operation which exception to throw (TIMEOUT)
        Map map2 = new HashMap();
        map2.put("message","TIMEOUT");
        ...
        Document createAsDocument10 = xMLHelpers4.getXMLObjectFromString("<fault><faultcode>Client</faultcode><faultstring>SEX-0003</faultstring><detail><exceptionname>SimpleException</exceptionname><SimpleException><errorCode>TIMEOUT</errorCode><reason>TIMEOUT</reason></SimpleException></detail></fault>");
