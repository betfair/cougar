...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/SOAP_RequestTypes_DateTimeMap_ValidFormat_Incorrect.xls;
...
/**
 * Ensure that when a SOAP request is received with an invalid dateTimeMap format, Cougar returns the correct fault
 */
public class SOAPRequestTypesDateTimeMapValidFormatIncorrectTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<DateTimeMapOperationRequest><message><dateTimeMap><entry key=\"date1\"><Date>0000-00-00T00:00:00.000</Date></entry><entry key=\"date2\"><Date>0000-00-00T00:00:00.000</Date></entry></dateTimeMap></message></DateTimeMapOperationRequest>");
