...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeSet_PositiveOffset.xls;
 ...
 */
public class RestPostRequestTypesDateTimeSetPositiveOffsetTest {
    @Test
    public void doTest() throws Exception {
        ...
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeSet><Date>2009-06-01T15:50:00.435+02:00</Date><Date>2009-06-01T16:50:00.435+02:00</Date></dateTimeSet></message>".getBytes())));
