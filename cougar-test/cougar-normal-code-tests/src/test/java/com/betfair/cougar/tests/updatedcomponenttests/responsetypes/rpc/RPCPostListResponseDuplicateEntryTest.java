...
// Originally from UpdatedComponentTests/ResponseTypes/RPC/RPC_Post_ListResponse_DuplicateEntry.xls;
...
/**
 * Ensure that when a Batched JSON request is performed against Cougar, passing a List with a duplicate entry in the post body, it is correctly de-serialized, processed, returned the correct response.
 */
public class RPCPostListResponseDuplicateEntryTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray2[0].put("method","testSimpleListGet");
        mapArray2[0].put("params","[[\"Value a\",\"Value b\",\"Value a\"]]");
        mapArray2[0].put("id","1");
        mapArray2[1] = new HashMap();
        mapArray2[1].put("method","testSimpleListGet");
        mapArray2[1].put("params","[[\"Value c\",\"Value d\",\"Value c\"]]");
        ...
        AssertionUtils.multiAssertEquals("{\"id\":1,\"result\":[\"Value a\",\"Value b\",\"Value a\"],\"jsonrpc\":\"2.0\"}", map5.get("response1"));
        AssertionUtils.multiAssertEquals("{\"id\":2,\"result\":[\"Value c\",\"Value d\",\"Value c\"],\"jsonrpc\":\"2.0\"}", map5.get("response2"));
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "testSimpleListGet"),new RequestLogRequirement("2.8", "testSimpleListGet") );
