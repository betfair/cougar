...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_Map_SimpleMap_JSON_BlankValue.xls;
...
/**
 * Ensure that when a Rest (JSON) Post operation is performed, Cougar can correctly handle a simple Map with a blank value in the post body
 */
public class RestPostRequestTypesMapSimpleMapJSONBlankValueTest {
    @Test
    public void doTest() throws Exception {
        ...
        Document createAsDocument10 = xMLHelpers4.getXMLObjectFromString("<SimpleMapOperationResponse><SimpleMapOperationResponseObject><responseMap><entry key=\"AAA\"><String>Value for AAA</String></entry><entry key=\"aaa\"><String></String></entry><entry key=\"bbb\"><String>Value for bbb</String></entry><entry key=\"ccc\"><String>Value for ccc</String></entry></responseMap></SimpleMapOperationResponseObject></SimpleMapOperationResponse>");
        // Create the expected response as a JSON object
        JSONHelpers jSONHelpers5 = new JSONHelpers();
        JSONObject createAsJSONObject11 = jSONHelpers5.createAsJSONObject(new JSONObject("{\"responseMap\": {\"AAA\": \"Value for AAA\",\"aaa\": \"\",\"bbb\": \"Value for bbb\",\"ccc\": \"Value for ccc\"}}"));
