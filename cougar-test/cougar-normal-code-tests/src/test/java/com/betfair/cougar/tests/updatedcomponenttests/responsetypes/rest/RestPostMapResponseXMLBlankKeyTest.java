...
/**
 * Ensure that when a Rest (XML) Post operation is performed against Cougar, passing in a Map containing blank a key in the post body, it is correctly de-serialized, processed, returned the correct response.
 */
