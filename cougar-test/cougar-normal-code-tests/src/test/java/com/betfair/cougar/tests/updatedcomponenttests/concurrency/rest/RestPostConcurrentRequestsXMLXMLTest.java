...
// Originally from UpdatedComponentTests/Concurrency/Rest/Rest_Post_ConcurrentRequests_XMLXML.xls;
...
/**
 * Ensure that when concurrent Rest XML post requests are performed against Cougar, each request is successfully sent and the XML response to each is correctly handled
 */
public class RestPostConcurrentRequestsXMLXMLTest {
    @Test
    public void doTest() throws Exception {
        ...
        RestConcurrentPostRequestsJETTTest.RestConcurrentPostRequestsTestsResultBean executeTest3 = new RestConcurrentPostRequestsJETTTest().executeTest(10, 400, CougarMessageProtocolRequestTypeEnum.RESTXML, CougarMessageContentTypeEnum.XML);
