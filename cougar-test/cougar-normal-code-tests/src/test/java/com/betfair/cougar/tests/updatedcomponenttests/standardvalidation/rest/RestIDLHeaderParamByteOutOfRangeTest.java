...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_Byte_OutOfRange.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a request passes an out of range number in a Byte parameter
 */
public class RestIDLHeaderParamByteOutOfRangeTest {
    @Test
    public void doTest() throws Exception {
        ...
        hbean.setVersion("v2");
        // Set the Byte Header param to an out of range number
        Map map3 = new HashMap();
        map3.put("headerParam","128");
