...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Get_RequestTypes_String_HeaderParam_EscapedCharacters_Colon.xls;
 ...
 */
public class RestGetRequestTypesStringHeaderParamEscapedCharactersColonTest {
    @Test
    public void doTest() throws Exception {
        ...
        Document createAsDocument10 = xMLHelpers4.getXMLObjectFromString("<NonMandatoryParamsOperationResponseObject><headerParameter>colon:</headerParameter></NonMandatoryParamsOperationResponseObject>");
