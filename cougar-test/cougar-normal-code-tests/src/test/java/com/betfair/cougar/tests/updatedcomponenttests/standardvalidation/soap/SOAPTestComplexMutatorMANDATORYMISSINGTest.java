...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/SOAP_TestComplexMutator_MANDATORY_MISSING.xls;
...
/**
 * Ensure that when a SOAP request is received with a missing mandatory parameter, Cougar returns the correct fault
 */
public class SOAPTestComplexMutatorMANDATORYMISSINGTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            // Create the SOAP request as an XML Document (with a missing mandatory parameter, value1)
            XMLHelpers xMLHelpers2 = new XMLHelpers();
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<TestComplexMutatorRequest><message><name>sum</name><value2>75</value2></message></TestComplexMutatorRequest>");
