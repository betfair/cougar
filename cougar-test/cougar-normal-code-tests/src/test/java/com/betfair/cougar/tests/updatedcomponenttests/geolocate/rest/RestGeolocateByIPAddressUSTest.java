...
// Originally from UpdatedComponentTests/Geolocate/Rest/Rest_Geolocate_ByIPAddress_US.xls;
...
/**
 * Ensure that when a Rest JSON request is received by Cougar, the ipaddress is used to correctly identify where the request originated, in this case: US
 */
public class RestGeolocateByIPAddressUSTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the IP address that the request is originating from (in this case a US IP Address)
        getNewHttpCallBean1.setIpAddress("65.55.209.105");
        ...
        cougarManager1.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp8, new RequestLogRequirement("2.8", "testSimpleGet"),new RequestLogRequirement("2.8", "testSimpleGet"),new RequestLogRequirement("2.8", "testSimpleGet"),new RequestLogRequirement("2.8", "testSimpleGet") );
        // In particular check the IPLocation field of the Access log gives the correct location, in this case US
        cougarManager1.verifyAccessLogEntriesAfterDate(getTimeAsTimeStamp8, new AccessLogRequirement("65.55.209.105", "/cougarBaseline/v2/simple", "Ok"),new AccessLogRequirement("65.55.209.105", "/cougarBaseline/v2/simple", "Ok"),new AccessLogRequirement("65.55.209.105", "/cougarBaseline/v2/simple", "Ok"),new AccessLogRequirement("65.55.209.105", "/cougarBaseline/v2/simple", "Ok") );
    }
