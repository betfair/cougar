...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_Byte_IncorrectDataType.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a request passes a non Byte object in a Byte parameter
 */
public class RestIDLHeaderParamByteIncorrectDataTypeTest {
    @Test
    public void doTest() throws Exception {
        ...
        try {
            ...
            hbean.setVersion("v2");
            // Set the Byte Header param as a non byte
