...
/**
 * Ensure that the correct fault is returned when, a Rest(XML) Post operation is performed against Cougar, passing a List of complex object in the post body, where the complex object  contained in the list has a mandatory field missing
 */
