...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/i64/SOAP/SOAP_i64Response.xls;
...
/**
 * Test that the Cougar service allows to use i64 primitive type in the response (SOAP)
 */
public class SOAPi64ResponseTest {
    @Test
    public void doTest() throws Exception {
        // Create a soap request structure as a Document object
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document requestDocument = xMLHelpers1.getXMLObjectFromString("<I64SimpleTypeEchoRequest><msg>200</msg></I64SimpleTypeEchoRequest>");
        // Get an HTTPCallBean
        ...
        CougarManager.verifyRequestLogEntriesAfterDate(timestamp, new RequestLogRequirement("2.8", "i64SimpleTypeEcho") );
    }
