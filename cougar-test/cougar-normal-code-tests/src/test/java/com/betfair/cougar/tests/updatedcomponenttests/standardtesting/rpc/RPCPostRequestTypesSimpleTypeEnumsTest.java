...
// Originally from UpdatedComponentTests/StandardTesting/RPC/RPC_Post_RequestTypes_SimpleType_Enums.xls;
...
/**
 * Ensure that Cougar can handle SimpleType Enums in the post body, header params and query params of an RPC request
 */
public class RPCPostRequestTypesSimpleTypeEnumsTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray2[0].put("method","enumSimpleOperation");
        mapArray2[0].put("params","[\"FOO\", \"BAR\",{\"bodyParameter\":\"FOOBAR\"}]");
        mapArray2[0].put("id","1");
        mapArray2[1] = new HashMap();
        mapArray2[1].put("method","enumSimpleOperation");
        mapArray2[1].put("params","[\"BAR\", \"FOO\",{\"bodyParameter\":\"BARFOO\"}]");
        ...
        AssertionUtils.multiAssertEquals("{\"id\":1,\"result\":{\"headerParameter\":\"FOO\",\"queryParameter\":\"BAR\",\"bodyParameter\":\"FOOBAR\"},\"jsonrpc\":\"2.0\"}", map5.get("response1"));
        AssertionUtils.multiAssertEquals("{\"id\":2,\"result\":{\"headerParameter\":\"BAR\",\"queryParameter\":\"FOO\",\"bodyParameter\":\"BARFOO\"},\"jsonrpc\":\"2.0\"}", map5.get("response2"));
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "enumSimpleOperation"),new RequestLogRequirement("2.8", "enumSimpleOperation") );
