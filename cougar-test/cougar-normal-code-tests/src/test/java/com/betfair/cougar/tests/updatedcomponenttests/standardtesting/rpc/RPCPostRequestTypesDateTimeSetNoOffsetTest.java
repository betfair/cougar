...
// Originally from UpdatedComponentTests/StandardTesting/RPC/RPC_Post_RequestTypes_DateTimeSet_NoOffset.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeSet data type with no offets specified in the post body of an RPC request
 */
public class RPCPostRequestTypesDateTimeSetNoOffsetTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray2[0].put("params","[{\"dateTimeSet\":[\"2009-06-01T11:50:00.435\",\"2009-06-02T11:50:00.435\"]}]");
        mapArray2[0].put("id","\"DateTimeSetNoOff\"");
        mapArray2[1] = new HashMap();
        mapArray2[1].put("method","dateTimeSetOperation");
        mapArray2[1].put("params","[{\"dateTimeSet\":[\"2009-02-01T11:50:00.435\",\"2009-02-02T11:50:00.435\"]}]");
        mapArray2[1].put("id","\"DateTimeSetNoOff2\"");
        ...
        AssertionUtils.multiAssertEquals("{\"id\":\"DateTimeSetNoOff\",\"result\":{\"responseSet\":[\"2009-06-01T11:50:00.435Z\",\"2009-06-02T11:50:00.435Z\"]},\"jsonrpc\":\"2.0\"}", map5.get("responseDateTimeSetNoOff"));
        AssertionUtils.multiAssertEquals("{\"id\":\"DateTimeSetNoOff2\",\"result\":{\"responseSet\":[\"2009-02-01T11:50:00.435Z\",\"2009-02-02T11:50:00.435Z\"]},\"jsonrpc\":\"2.0\"}", map5.get("responseDateTimeSetNoOff2"));
