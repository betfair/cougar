...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_Longs.xls;
...
/**
 * Ensure that Cougar can handle Longs in the post body, header params and query params
 */
public class RestPostRequestTypesLongsTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set each of the parameter types to contain a long datatype object
