...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/datetime/REST/Rest_dateTimeInvalidResponse.xls;
...
/**
 * Test that the Cougar service throws a correct error when invalid value is passed to  dateTime primitive type parameter (REST)
 */
public class RestdateTimeInvalidResponseTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set Query parameter (?msg=some non date)
        ...
        CougarManager.verifyAccessLogEntriesAfterDate(timeStamp, new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/dateTimeEcho", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/dateTimeEcho", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/dateTimeEcho", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/dateTimeEcho", "BadRequest") );
    }
