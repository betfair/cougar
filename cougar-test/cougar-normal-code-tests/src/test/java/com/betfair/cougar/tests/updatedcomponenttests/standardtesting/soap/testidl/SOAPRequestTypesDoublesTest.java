...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/Test-IDL/SOAP_RequestTypes_Doubles.xls;
...
/**
 * Ensure that when a SOAP request is received, Cougar can handle the double datatype
 */
public class SOAPRequestTypesDoublesTest {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document (with double parameters)
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<DoubleOperationRequest><headerParam>553.36</headerParam><queryParam>1.7976931348623157E308</queryParam><message><bodyParameter>0.0006</bodyParameter></message></DoubleOperationRequest>");
        ...
        Document createAsDocument9 = xMLHelpers4.getXMLObjectFromString("<response><queryParameter>1.7976931348623157E308</queryParameter><headerParameter>553.36</headerParameter><bodyParameter>6.0E-4</bodyParameter></response>");
