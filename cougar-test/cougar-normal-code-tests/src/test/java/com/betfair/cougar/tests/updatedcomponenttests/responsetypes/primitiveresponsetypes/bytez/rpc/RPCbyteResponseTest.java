...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/byte/RPC/RPC_byteResponse.xls;
package com.betfair.cougar.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.bytez.rpc;
...
/**
 * Test that the Cougar service allows to use byte primitive type in the response (Batched JSON)
 */
public class RPCbyteResponseTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray2[0].put("method","byteSimpleTypeEcho");
        mapArray2[0].put("params","[1]");
        mapArray2[0].put("id","1");
        mapArray2[1] = new HashMap();
        mapArray2[1].put("method","byteSimpleTypeEcho");
        mapArray2[1].put("params","[1]");
        ...
        AssertionUtils.multiAssertEquals("{\"id\":1,\"result\":1,\"jsonrpc\":\"2.0\"}", map5.get("response1"));
        AssertionUtils.multiAssertEquals("{\"id\":2,\"result\":1,\"jsonrpc\":\"2.0\"}", map5.get("response2"));
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "byteSimpleTypeEcho"),new RequestLogRequirement("2.8", "byteSimpleTypeEcho") );
