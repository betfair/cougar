...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/datetime/RPC/RPC_dateTimeResponse.xls;
package com.betfair.cougar.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.datetime.rpc;
...
/**
 * Test that the Cougar service allows to use dateTime primitive type in the response (Batched JSON)
 */
public class RPCdateTimeResponseTest {
    @Test
    public void doTest() throws Exception {
        ...
        AssertionUtils.multiAssertEquals("{\"id\":1,\"result\":\"2011-01-10T00:00:00.000Z\",\"jsonrpc\":\"2.0\"}", map5.get("response1"));
        AssertionUtils.multiAssertEquals("{\"id\":2,\"result\":\"2011-01-10T00:00:00.000Z\",\"jsonrpc\":\"2.0\"}", map5.get("response2"));
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "dateTimeSimpleTypeEcho"),new RequestLogRequirement("2.8", "dateTimeSimpleTypeEcho") );
