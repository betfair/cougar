...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_ENUM_Mandatory_NotSet.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a request is missing a mandatory ENUM parameter
 */
public class RestIDLHeaderParamENUMMandatoryNotSetTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set parameters but don't set a mandatory header parameter
