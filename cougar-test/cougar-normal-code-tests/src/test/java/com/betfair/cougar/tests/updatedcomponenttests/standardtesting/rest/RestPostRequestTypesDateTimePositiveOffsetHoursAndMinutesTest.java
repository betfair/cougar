...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTime_PositiveOffset_HoursAndMinutes.xls;
...
/**
 * Ensure that Cougar can handle the dateTime data type in the post body with a positive offset of hours and minutes (0230 = offset by 2 hours 30 minutes)
 */
public class RestPostRequestTypesDateTimePositiveOffsetHoursAndMinutesTest {
    @Test
    public void doTest() throws Exception {
        ...
        String date = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2009, (int) 6, (int) 1, (int) 13, (int) 20, (int) 0, (int) 435);
        // Set the post body to contain a date time object (with a positive offset)
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<bodyParamDateTimeObject><dateTimeParameter>2009-06-01T15:50:00.435+02:30</dateTimeParameter></bodyParamDateTimeObject>".getBytes())));
