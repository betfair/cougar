...
// Originally from UpdatedComponentTests/StandardTesting/RPC/RPC_Get_SimpleOperation_BlankIPAddress.xls;
...
/**
 * Ensure that Cougar correctly processes a Batch of JSON simple gets, with X_IP in the header set to blank
 */
public class RPCGetSimpleOperationBlankIPAddressTest {
    @Test
    public void doTest() throws Exception {
        // Set up the Http Call Bean to make the request
        CougarManager cougarManager1 = CougarManager.getInstance();
        HttpCallBean callBean = cougarManager1.getNewHttpCallBean(null);
        ...
        mapArray2[1].put("params","[\"message\"]");
        ...
        AssertionUtils.multiAssertEquals("{\"id\":2,\"result\":{\"message\":\"message\"},\"jsonrpc\":\"2.0\"}", map5.get("response2"));
        ...
        cougarManager.verifyAccessLogEntriesAfterDate(timeStamp, new AccessLogRequirement("127.0.0.1", "/json-rpc", "Ok") );
    }
