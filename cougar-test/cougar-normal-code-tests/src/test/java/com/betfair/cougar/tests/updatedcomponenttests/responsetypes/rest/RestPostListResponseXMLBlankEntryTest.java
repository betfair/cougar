...
// Originally from UpdatedComponentTests/ResponseTypes/REST/Rest_Post_ListResponse_XML_BlankEntry.xls;
 ...
 */
public class RestPostListResponseXMLBlankEntryTest {
    @Test
    public void doTest() throws Exception {
        ...
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<inputList><String>bbb string</String><String/><String>ddd string</String><String>ccc string</String></inputList>".getBytes())));
        ...
        Document createAsDocument10 = xMLHelpers3.getXMLObjectFromString("<TestSimpleListGetResponse><String>bbb string</String><String/><String>ddd string</String><String>ccc string</String></TestSimpleListGetResponse>");
