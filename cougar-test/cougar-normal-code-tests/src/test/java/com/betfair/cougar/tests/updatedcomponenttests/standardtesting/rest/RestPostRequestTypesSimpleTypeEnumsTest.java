...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_SimpleType_Enums.xls;
...
/**
 * Ensure that Cougar can handle Simple Type Enums in the post body, header params and query params
 */
public class RestPostRequestTypesSimpleTypeEnumsTest {
    @Test
    public void doTest() throws Exception {
        ...
        cougarManager1.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp9, new RequestLogRequirement("2.8", "enumSimpleOperation"),new RequestLogRequirement("2.8", "enumSimpleOperation"),new RequestLogRequirement("2.8", "enumSimpleOperation"),new RequestLogRequirement("2.8", "enumSimpleOperation") );
    }
