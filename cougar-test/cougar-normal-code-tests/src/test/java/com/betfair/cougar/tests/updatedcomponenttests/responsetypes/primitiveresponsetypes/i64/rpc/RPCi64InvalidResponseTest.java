...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/i64/RPC/RPC_i64InvalidResponse.xls;
...
/**
 * Test that the Cougar service throws a correct error when invalid value is passed to  i64 primitive type parameter (Batched JSON)
 */
public class RPCi64InvalidResponseTest {
    @Test
