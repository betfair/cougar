...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_QueryParam_SimpleType_Integer_null.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request passes null in the SimpleTypeInteger Query parameter
 */
public class RestIDLQueryParamSimpleTypeIntegernullTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, setting the SimpleTypeInteger Query parameter to null
