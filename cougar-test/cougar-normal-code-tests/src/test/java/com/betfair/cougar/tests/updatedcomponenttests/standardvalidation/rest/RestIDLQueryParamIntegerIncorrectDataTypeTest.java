...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_QueryParam_Integer_IncorrectDataType.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request passes a non Integer object in an Integer Query parameter
 */
public class RestIDLQueryParamIntegerIncorrectDataTypeTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, setting the Integer Query parameter as a non Integer
