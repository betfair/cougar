...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTime_2.xls;
...
/**
 * Ensure that Cougar can handle the dateTime data type in the post body
 */
public class RestPostRequestTypesDateTime2Test {
    @Test
    public void doTest() throws Exception {
        ...
        String date = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2009, (int) 1, (int) 1, (int) 13, (int) 50, (int) 0, (int) 0);
        // Set the post body to contain a date time object
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<bodyParamDateTimeObject><dateTimeParameter>2009-01-01T13:50:00.0Z</dateTimeParameter></bodyParamDateTimeObject>".getBytes())));
