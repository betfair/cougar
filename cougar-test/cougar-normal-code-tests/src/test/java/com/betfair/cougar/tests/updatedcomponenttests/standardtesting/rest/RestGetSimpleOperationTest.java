...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Get_SimpleOperation.xls;
...
/**
 * Ensure that Cougar correctly processes a simple Rest XML/JSON Get using each of the 4 supported response protocols
 */
public class RestGetSimpleOperationTest {
    @Test
