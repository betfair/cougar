...
/**
 * Ensure that when a SOAP request is received, Cougar can handle the dateTime datatype with a negative offset that causes the date to role to the next day
 */
public class SOAPRequestTypesDateTimeNegativeOffSetRollToNextDayTest {
    ...
    public void doTest() throws Exception {
        ...
        String convertUTCDateTimeToCougarFormat6 = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2010, (int) 1, (int) 1, (int) 13, (int) 50, (int) 0, (int) 0);
