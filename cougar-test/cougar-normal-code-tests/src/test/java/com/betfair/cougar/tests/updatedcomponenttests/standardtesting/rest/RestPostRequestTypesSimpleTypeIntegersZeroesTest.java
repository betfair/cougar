...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_SimpleType_Integers_Zeroes.xls;
...
/**
 * Ensure that Cougar can handle Simple Type Integers in the post body, header params and query params that are Zeroes
 */
public class RestPostRequestTypesSimpleTypeIntegersZeroesTest {
    @Test
    public void doTest() throws Exception {
        ...
        getNewHttpCallBean1.setOperationName("i32SimpleTypeOperation");
        
        getNewHttpCallBean1.setServiceName("baseline", "cougarBaseline");
        
        getNewHttpCallBean1.setVersion("v2");
        // Set each of the parameter types to contain a Zero SimpleType Integer datatype object
        Map map2 = new HashMap();
        map2.put("HeaderParam","0");
        getNewHttpCallBean1.setHeaderParams(map2);
        
        Map map3 = new HashMap();
        map3.put("queryParam","0");
        getNewHttpCallBean1.setQueryParams(map3);
        
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><bodyParameter>0</bodyParameter></message>".getBytes())));
        ...
        Document createAsDocument11 = xMLHelpers5.getXMLObjectFromString("<I32SimpleOperationResponseObject><bodyParameter>0</bodyParameter><headerParameter>0</headerParameter><queryParameter>0</queryParameter></I32SimpleOperationResponseObject>");
        ...
        cougarManager1.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp9, new RequestLogRequirement("2.8", "i32SimpleTypeOperation"),new RequestLogRequirement("2.8", "i32SimpleTypeOperation"),new RequestLogRequirement("2.8", "i32SimpleTypeOperation"),new RequestLogRequirement("2.8", "i32SimpleTypeOperation") );
    }
