...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_PostBody_String_SpecialCharacters_1.xls;
 ...
 */
public class RestPostPostBodyStringSpecialCharacters1Test {
    @Test
    public void doTest() throws Exception {
        ...
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><name>C:\\Testing\\Validation</name><value1>7</value1><value2>75</value2></message>".getBytes())));
        ...
        Document createAsDocument9 = xMLHelpers3.getXMLObjectFromString("<SimpleResponse><message>C:\\Testing\\Validation = 82</message></SimpleResponse>");
