...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/collections_of_primitives/RPC/RPC_Post_SetIntResponse.xls;
...
/**
 * Ensure that when a Batched JSON Post request is performed against Cougar, passing a Set in the post body, it is correctly de-serialized, processed, returned the correct response.
 */
public class RPCPostSetIntResponseTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray2[0].put("method","i32SetSimpleTypeEcho");
        mapArray2[0].put("params","[[1,2]]");
        mapArray2[0].put("id","1");
        mapArray2[1] = new HashMap();
        mapArray2[1].put("method","i32SetSimpleTypeEcho");
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "i32SetSimpleTypeEcho"),new RequestLogRequirement("2.8", "i32SetSimpleTypeEcho") );
