...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/SOAP_RequestTypes_DateTimeSet_ValidFormat_Incorrect.xls;
...
/**
 * Ensure that when a SOAP request is received with an invalid dateTimeSet format, Cougar returns the correct fault
 */
public class SOAPRequestTypesDateTimeSetValidFormatIncorrectTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<DateTimeSetOperationRequest><message><dateTimeSet><Date>0000-00-00T00:00:00.000</Date><Date>0000-00-00T00:00:00.000</Date></dateTimeSet></message></DateTimeSetOperationRequest>");
