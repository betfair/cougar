...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeSet_ZOffset.xls;
 ...
 */
public class RestPostRequestTypesDateTimeSetZOffsetTest {
    @Test
    public void doTest() throws Exception {
        ...
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeSet><Date>2009-06-01T11:50:00.435Z</Date><Date>2009-06-01T12:50:00.435Z</Date></dateTimeSet></message>".getBytes())));
