...
// Originally from UpdatedComponentTests/StandardTesting/RPC/RPC_Post_SimpleOperation.xls;
...
/**
 * Ensure that when a simple RPC Post is performed against Cougar, the request is handled correctly
 */
public class RPCPostSimpleOperationTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray2[0].put("method","testComplexMutator");
        mapArray2[0].put("params","[{\"name\":\"n1\",\"value1\":12,\"value2\":24}]");
        mapArray2[0].put("id","1");
        mapArray2[1] = new HashMap();
        mapArray2[1].put("method","testComplexMutator");
        mapArray2[1].put("params","[{\"name\":\"n2\",\"value1\":16,\"value2\":36}]");
        ...
        AssertionUtils.multiAssertEquals("{\"id\":1,\"result\":{\"message\":\"n1 = 36\"},\"jsonrpc\":\"2.0\"}", map5.get("response1"));
        AssertionUtils.multiAssertEquals("{\"id\":2,\"result\":{\"message\":\"n2 = 52\"},\"jsonrpc\":\"2.0\"}", map5.get("response2"));
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "testComplexMutator"),new RequestLogRequirement("2.8", "testComplexMutator") );
