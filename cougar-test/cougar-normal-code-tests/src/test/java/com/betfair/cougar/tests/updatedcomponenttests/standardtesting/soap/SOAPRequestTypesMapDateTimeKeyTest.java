...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/SOAP_RequestTypes_MapDateTimeKey.xls;
...
/**
 * Ensure that when a SOAP request is received, Cougar can handle a map with a datetime key
 */
public class SOAPRequestTypesMapDateTimeKeyTest {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document (with a dateTimeMap parameter)
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<MapDateTimeKeyOperationRequest><message><mapDateTimeKey><entry key=\"2009-06-01T13:50:00.000Z\"><String>date1</String></entry><entry key=\"2009-06-01T14:50:00.000Z\"><String>date2</String></entry></mapDateTimeKey></message></MapDateTimeKeyOperationRequest>");
        ...
        hbean.setVersion("v2");
        // Create the date object expected to be returned in the response (as a key)
        ...
        AssertionUtils.multiAssertEquals(createAsDocument11, (Document)response7.getResponseObject(),"/*[local-name()='response']/*[local-name()='responseMap']");

        // generalHelpers.pauseTest(3000L);
        // Check the log entries are as expected

        hinstance.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp9, new RequestLogRequirement("2.8", "mapDateTimeKeyOperation") );
    }
