...
// Originally from UpdatedComponentTests/ResponseTypes/RPC/RPC_Post_ListResponse_Empty.xls;
...
/**
 * Ensure that when a Batched JSON request is performed against Cougar, passing an empty List in the post body, it is correctly de-serialized, processed, returned the correct response.
 */
public class RPCPostListResponseEmptyTest {
    @Test
