...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeMap_JSON_PositiveOffset_RollToPreviousDay.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeMap data type in the post body of a JSON request containing dates with positive offsets large enough to roll the date to the previous day
 */
public class RestPostRequestTypesDateTimeMapJSONPositiveOffsetRollToPreviousDayTest {
    @Test
    public void doTest() throws Exception {
        ...
        map4.put("RESTJSON","{\"message\":{\"dateTimeMap\":{   \n\"date1\":\"2009-01-01T00:01:00.435+14:00\",                   \"date2\":\"2009-01-01T00:02:00.435+14:00\"} \n}}");
