...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/SOAP_RequestTypes_DateTime_Futuristic.xls;
...
/**
 * Ensure that when a SOAP request is received, Cougar can handle the dateTime datatypewith a date far in the future
 */
public class SOAPRequestTypesDateTimeFuturisticTest {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document (with a dateTime parameter far in the future)
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<DateTimeOperationRequest><bodyParamDateTimeObject><dateTimeParameter>3009-06-01T13:50:00.0Z</dateTimeParameter></bodyParamDateTimeObject></DateTimeOperationRequest>");
