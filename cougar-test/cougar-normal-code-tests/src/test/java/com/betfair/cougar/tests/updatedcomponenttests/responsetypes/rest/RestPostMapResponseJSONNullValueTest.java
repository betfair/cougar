...
// Originally from UpdatedComponentTests/ResponseTypes/REST/Rest_Post_MapResponse_JSON_NullValue.xls;
...
/**
 * Ensure that when a Rest (JSON) Post operation is performed against Cougar, passing in a Map containing a null value in the post body, it is correctly de-serialized, processed, returned the correct response.
 */
public class RestPostMapResponseJSONNullValueTest {
    @Test
    public void doTest() throws Exception {
        ...
        Document createAsDocument10 = xMLHelpers4.getXMLObjectFromString("<TestSimpleMapGetResponse><entry key=\"aaa\"><String>Value for aaa</String></entry><entry key=\"ccc\"><String>Value for ccc</String></entry><entry key=\"bbb\"><String>Value for bbb</String></entry><entry key=\"ddd\"></entry></TestSimpleMapGetResponse>");

        JSONHelpers jSONHelpers5 = new JSONHelpers();
        JSONObject createAsJSONObject11 = jSONHelpers5.createAsJSONObject(new JSONObject("{\"aaa\": \"Value for aaa\",\"bbb\": \"Value for bbb\",\"ccc\": \"Value for ccc\",\"ddd\": null}"));
        ...
        AssertionUtils.multiAssertEquals(createAsDocument10, (Document)response6.getResponseObject(),"/*[local-name()='TestSimpleMapGetResponse']");
