...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_QueryParam_MissingMandatory.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request is missing a mandatory Query parameter
 */
public class RestIDLQueryParamMissingMandatoryTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, don't set the mandatory Query parameter
        Map map3 = new HashMap();
        map3.put("HeaderParam","Foo");
