...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/SOAP_RequestTypes_DateTime_RoundlTo3Digits.xls;
...
/**
 * Ensure that when a SOAP request is received, Cougar can handle the dateTime datatype with more than 3 digits milliseconds accuracy (time is rounded)
 */
public class SOAPRequestTypesDateTimeRoundlTo3DigitsTest {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document (with a dateTime parameter with more tthan 3 digits milliseconds accuracy)
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<DateTimeOperationRequest><bodyParamDateTimeObject><dateTimeParameter>2009-01-01T13:50:00.4343Z</dateTimeParameter></bodyParamDateTimeObject></DateTimeOperationRequest>");
        ...
        // Create the date object expected to be returned in the response (with the milliseconds rounded to 3 digits)

        String convertUTCDateTimeToCougarFormat6 = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2009, (int) 1, (int) 1, (int) 13, (int) 50, (int) 0, (int) 434);
