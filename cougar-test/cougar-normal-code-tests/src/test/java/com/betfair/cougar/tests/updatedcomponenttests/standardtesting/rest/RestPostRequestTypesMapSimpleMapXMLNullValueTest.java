...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_Map_SimpleMap_XML_NullValue.xls;
...
/**
 * Ensure that when a Rest (XML) Post operation is performed, Cougar can correctly handle a simple Map with a null value in the post body
 */
public class RestPostRequestTypesMapSimpleMapXMLNullValueTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the post body to contain a simple map with an entry with a null value
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><simpleMap><entry key=\"bbb\"><String>Value for bbb</String></entry><entry key=\"aaa\"><String>Value for aaa</String></entry><entry key=\"ddd\"></entry><entry key=\"ccc\"><String>Value for ccc</String></entry></simpleMap></message>".getBytes())));
        ...
        JSONObject createAsJSONObject11 = jSONHelpers4.createAsJSONObject(new JSONObject("{\"responseMap\": {\"aaa\": \"Value for aaa\",\"bbb\": \"Value for bbb\",\"ccc\": \"Value for ccc\",\"ddd\": null}}"));
