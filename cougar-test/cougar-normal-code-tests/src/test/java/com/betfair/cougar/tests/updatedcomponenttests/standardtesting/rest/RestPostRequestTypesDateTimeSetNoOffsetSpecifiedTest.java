...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeSet_NoOffsetSpecified.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeSet data type in the post body with a date with a no offset specified
 */
public class RestPostRequestTypesDateTimeSetNoOffsetSpecifiedTest {
    @Test
    public void doTest() throws Exception {
        ...
        String date1 = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2009, (int) 6, (int) 1, (int) 10, (int) 50, (int) 0, (int) 435);
        // Create a date time object expected to be in the response object

        String date2 = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2009, (int) 6, (int) 1, (int) 11, (int) 50, (int) 0, (int) 435);
        // Set the post body to contain a date time set object containing dates with no offset
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeSet><Date>2009-06-01T10:50:00.435</Date><Date>2009-06-01T11:50:00.435</Date></dateTimeSet></message>".getBytes())));
