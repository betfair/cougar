...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/Test-IDL/SOAP_RequestTypes_Long_OutOfRange_Lowerr.xls;
...
/**
 * Ensure that when a SOAP request is received with an out of range (lower) Long parameter, Cougar returns the correct fault
 */
public class SOAPRequestTypesLongOutOfRangeLowerrTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<I64OperationRequest><headerParam>-9.22337203685477E19</headerParam><queryParam>543553</queryParam><message><bodyParameter>543553</bodyParameter></message></I64OperationRequest>");
