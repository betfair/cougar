...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/Test-IDL/SOAP_RequestTypes_Doubles_Negatives.xls;
...
/**
 * Ensure that when a SOAP request is received, Cougar can handle the double datatype with negative doubles
 */
public class SOAPRequestTypesDoublesNegativesTest {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document (with double parameters)
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<DoubleOperationRequest><headerParam>-54.43223</headerParam><queryParam>-3.343432</queryParam><message><bodyParameter>-4.0</bodyParameter></message></DoubleOperationRequest>");
        ...
        Document createAsDocument9 = xMLHelpers4.getXMLObjectFromString("<response><queryParameter>-3.343432</queryParameter><headerParameter>-54.43223</headerParameter><bodyParameter>-4.0</bodyParameter></response>");
