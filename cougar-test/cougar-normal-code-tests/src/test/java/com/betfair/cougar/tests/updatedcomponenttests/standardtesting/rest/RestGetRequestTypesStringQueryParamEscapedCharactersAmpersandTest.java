...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Get_RequestTypes_String_QueryParam_EscapedCharacters_Ampersand.xls;
 ...
 */
public class RestGetRequestTypesStringQueryParamEscapedCharactersAmpersandTest {
    @Test
