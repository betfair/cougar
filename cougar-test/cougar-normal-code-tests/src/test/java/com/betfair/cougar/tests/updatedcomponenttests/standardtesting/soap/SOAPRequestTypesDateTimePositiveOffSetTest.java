...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/SOAP_RequestTypes_DateTime_PositiveOffSet.xls;
...
/**
 * Ensure that when a SOAP request is received, Cougar can handle the dateTime datatype with a positive offset
 */
public class SOAPRequestTypesDateTimePositiveOffSetTest {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document (with a dateTime parameter with a positive offset)
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<DateTimeOperationRequest><bodyParamDateTimeObject><dateTimeParameter>2009-06-01T15:50:00+02:00</dateTimeParameter></bodyParamDateTimeObject></DateTimeOperationRequest>");
