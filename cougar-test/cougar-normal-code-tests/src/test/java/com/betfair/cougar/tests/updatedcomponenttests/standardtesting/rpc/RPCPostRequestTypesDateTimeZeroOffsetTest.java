...
// Originally from UpdatedComponentTests/StandardTesting/RPC/RPC_Post_RequestTypes_DateTime_ZeroOffset.xls;
...
/**
 * Ensure that Cougar can handle the dateTime data type with Zero Offsets in the post body of an RPC request
 */
public class RPCPostRequestTypesDateTimeZeroOffsetTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray2[0].put("params","[{\"dateTimeParameter\":\"2009-06-01T11:50:00.435Z\"}]");
        mapArray2[0].put("id","\"DateTimeZeroOff\"");
        mapArray2[1] = new HashMap();
        mapArray2[1].put("method","dateTimeOperation");
        mapArray2[1].put("params","[{\"dateTimeParameter\":\"2009-02-01T11:50:00.435Z\"}]");
        mapArray2[1].put("id","\"DateTimeZeroOff2\"");
        ...
        AssertionUtils.multiAssertEquals("{\"id\":\"DateTimeZeroOff\",\"result\":{\"localTime\":\"2009-06-01T11:50:00.435Z\",\"localTime2\":\"2009-06-01T11:50:00.435Z\"},\"jsonrpc\":\"2.0\"}", map5.get("responseDateTimeZeroOff"));
        AssertionUtils.multiAssertEquals("{\"id\":\"DateTimeZeroOff2\",\"result\":{\"localTime\":\"2009-02-01T11:50:00.435Z\",\"localTime2\":\"2009-02-01T11:50:00.435Z\"},\"jsonrpc\":\"2.0\"}", map5.get("responseDateTimeZeroOff2"));
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "dateTimeOperation"),new RequestLogRequirement("2.8", "dateTimeOperation") );
