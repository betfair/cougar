...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_Byte_IncorrectDataType.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request contains a non Byte as a Byte body parameter
 */
public class RestIDLPostBodyElementByteIncorrectDataTypeTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the Byte body parameter as a non Byte
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><bodyParameter>adfsdfdsa</bodyParameter></message>".getBytes())));
