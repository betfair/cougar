...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_UnexpectedDuplicateElements.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request contains a body parameter with extra unexpected (duplicate) entries
 */
public class RestIDLPostBodyElementUnexpectedDuplicateElementsTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, setting the body parameter to contain unexpected duplicate entries (bodyParameter is set twice)
        ...
        getNewHttpCallBean2.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><bodyParameter>32</bodyParameter><bodyParameter>33</bodyParameter></message>".getBytes())));
