...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_Set_null_JSON.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST JSON request has a null Set body parameter
 */
public class RestIDLPostBodyElementSetnullJSONTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the set body parameter to a null map
        ...
        cougarManager11.verifyAccessLogEntriesAfterDate(getTimeAsTimeStamp9, new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/simpleSetOperation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/simpleSetOperation", "BadRequest") );
    }
