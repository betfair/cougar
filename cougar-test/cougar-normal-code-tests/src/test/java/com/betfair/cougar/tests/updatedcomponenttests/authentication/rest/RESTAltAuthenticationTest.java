...
public class RESTAltAuthenticationTest {
    ...
    public void doTest() throws Exception {
        ...
        Map<String, String> headerMap = getResponseObjectsByEnum12.getResponseHeaders();
        ...
        headerMap = getResponseObjectsByEnum14.getResponseHeaders();
        ...
        headerMap = getResponseObjectsByEnum16.getResponseHeaders();
        ...
        headerMap = getResponseObjectsByEnum18.getResponseHeaders();
