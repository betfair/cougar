...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_List_InvalidDataTypeEntry.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request contains a list body parameter with an entry of the wrong type
 */
public class RestIDLPostBodyElementListInvalidDataTypeEntryTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the body parameter to contain a list with a value of the wrong type (objects is a list of Complex Objects but contains a String entry)
        getNewHttpCallBean2.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<LargeRequest><size>1</size><objects><ComplexObject><name>n1</name><value1>11</value1><value2>21</value2></ComplexObject><ComplexObject><name>n2</name><value1>12</value1><value2>22</value2></ComplexObject><String>this should not be here oops</String><ComplexObject><name>n4</name><value1>14</value1><value2>24</value2></ComplexObject><ComplexObject><name>n5</name><value1>15</value1><value2>25</value2></ComplexObject><ComplexObject><name>n6</name><value1>16</value1><value2>26</value2></ComplexObject><ComplexObject><name>n7</name><value1>17</value1><value2>27</value2></ComplexObject></objects><oddOrEven>ODD</oddOrEven><returnList>true</returnList></LargeRequest>".getBytes())));
