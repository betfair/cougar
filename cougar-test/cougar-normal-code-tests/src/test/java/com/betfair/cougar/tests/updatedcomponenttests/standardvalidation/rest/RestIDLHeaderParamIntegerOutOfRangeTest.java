...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_Integer_OutOfRange.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a request passes an out of range Integer parameter
 */
public class RestIDLHeaderParamIntegerOutOfRangeTest {
    @Test
