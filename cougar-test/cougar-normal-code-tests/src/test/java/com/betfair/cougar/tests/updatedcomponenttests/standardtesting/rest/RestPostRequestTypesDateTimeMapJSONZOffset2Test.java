...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeMap_JSON_ZOffset2.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeMap data type in the post body of a JSON request containing dates specifying the UTC timezone
 */
public class RestPostRequestTypesDateTimeMapJSONZOffset2Test {
    @Test
    public void doTest() throws Exception {
        ...
        map4.put("RESTJSON","{\"message\":{\"dateTimeMap\":{   \n\"date1\":\"2009-02-01T11:50:00.435Z\",                   \"date2\":\"2009-02-02T11:50:00.435Z\"} \n}}");
