...
// Originally from UpdatedComponentTests/StandardTesting/RPC/RPC_Post_RequestTypes_DateTime.xls;
...
/**
 * Ensure that Cougar can handle the dateTime data type in the post body of an RPC request
 */
public class RPCPostRequestTypesDateTimeTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray2[0].put("params","[{\"dateTimeParameter\":\"2009-06-01T13:50:00.0Z\"}]");
        mapArray2[0].put("id","\"DateTime\"");
        mapArray2[1] = new HashMap();
        mapArray2[1].put("method","dateTimeOperation");
        mapArray2[1].put("params","[{\"dateTimeParameter\":\"2009-01-01T13:50:00.0Z\"}]");
        mapArray2[1].put("id","\"DateTime2\"");
        mapArray2[2] = new HashMap();
        mapArray2[2].put("method","dateTimeOperation");
        mapArray2[2].put("params","[{\"dateTimeParameter\":\"2012-02-29T13:50:00.0Z\"}]");
        mapArray2[2].put("id","\"DateTimeLeapYear\"");
        ...
        AssertionUtils.multiAssertEquals("{\"id\":\"DateTime\",\"result\":{\"localTime\":\"2009-06-01T13:50:00.000Z\",\"localTime2\":\"2009-06-01T13:50:00.000Z\"},\"jsonrpc\":\"2.0\"}", map5.get("responseDateTime"));
        AssertionUtils.multiAssertEquals("{\"id\":\"DateTime2\",\"result\":{\"localTime\":\"2009-01-01T13:50:00.000Z\",\"localTime2\":\"2009-01-01T13:50:00.000Z\"},\"jsonrpc\":\"2.0\"}", map5.get("responseDateTime2"));
        AssertionUtils.multiAssertEquals("{\"id\":\"DateTimeLeapYear\",\"result\":{\"localTime\":\"2012-02-29T13:50:00.000Z\",\"localTime2\":\"2012-02-29T13:50:00.000Z\"},\"jsonrpc\":\"2.0\"}", map5.get("responseDateTimeLeapYear"));
