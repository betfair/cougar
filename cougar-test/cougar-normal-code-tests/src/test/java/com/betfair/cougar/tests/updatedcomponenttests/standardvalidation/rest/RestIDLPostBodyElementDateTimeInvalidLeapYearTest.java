...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_DateTime_InvalidLeapYear.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request contains a DateTime body parameter set to be February 29th on a no leap year (so that date doesn't exist)
 */
public class RestIDLPostBodyElementDateTimeInvalidLeapYearTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the DateTime body parameter to be February 29th on a non leap year
        getNewHttpCallBean2.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<BodyParamDateTimeObject><dateTimeParameter>2009-02-29T13:50:00.435Z</dateTimeParameter></BodyParamDateTimeObject>".getBytes())));
