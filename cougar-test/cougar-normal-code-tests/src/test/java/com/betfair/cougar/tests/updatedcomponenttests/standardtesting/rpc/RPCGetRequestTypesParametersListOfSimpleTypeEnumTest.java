...
/**
 * Ensure that when a Batched JSON request is performed, Cougar can handle a List of Simple Type Enums being passed in the Header and Query parameters
 */
public class RPCGetRequestTypesParametersListOfSimpleTypeEnumTest {
    ...
    public void doTest() throws Exception {
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "simpleEnumListOperation"),new RequestLogRequirement("2.8", "simpleEnumListOperation") );
