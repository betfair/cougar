...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/SOAP_RequestTypes_DateTime_InvalidFormat_2.xls;
...
/**
 * Ensure that when a SOAP request is received with an invalid dateTime format, Cougar returns the correct fault
 */
public class SOAPRequestTypesDateTimeInvalidFormat2Test {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<DateTimeOperationRequest><bodyParamDateTimeObject><dateTimeParameter>2009-06-011H3:50:00.0Z</dateTimeParameter></bodyParamDateTimeObject></DateTimeOperationRequest>");
