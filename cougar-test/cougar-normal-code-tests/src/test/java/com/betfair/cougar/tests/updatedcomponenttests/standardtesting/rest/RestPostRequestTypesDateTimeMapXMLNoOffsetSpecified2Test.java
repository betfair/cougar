...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeMap_XML_NoOffsetSpecified2.xls;
 ...
 */
public class RestPostRequestTypesDateTimeMapXMLNoOffsetSpecified2Test {
    @Test
    public void doTest() throws Exception {
        ...
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeMap><entry key=\"date1\"><Date>2009-02-01T11:50:00.435</Date></entry><entry key=\"date2\"><Date>2009-02-01T12:50:00.435</Date></entry></dateTimeMap></message>".getBytes())));
