...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_Floats_Zeroes.xls;
...
/**
 * Ensure that Cougar can handle Floats in the post body, header params and query params that are zero
 */
public class RestPostRequestTypesFloatsZeroesTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set each of the parameter types to contain a float datatype object that are zero
        ...
        Document createAsDocument11 = xMLHelpers5.getXMLObjectFromString("<FloatOperationResponseObject><bodyParameter>0.0</bodyParameter><headerParameter>0.0</headerParameter><queryParameter>0.0</queryParameter></FloatOperationResponseObject>");
