...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeMap_XML.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeMap data type in the post body of an XML request
 */
public class RestPostRequestTypesDateTimeMapXMLTest {
    @Test
    public void doTest() throws Exception {
        ...
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeMap><entry key=\"date1\"><Date>2009-06-01T13:50:00.000Z</Date></entry><entry key=\"date2\"><Date>2009-06-01T14:50:00.000Z</Date></entry></dateTimeMap></message>".getBytes())));
