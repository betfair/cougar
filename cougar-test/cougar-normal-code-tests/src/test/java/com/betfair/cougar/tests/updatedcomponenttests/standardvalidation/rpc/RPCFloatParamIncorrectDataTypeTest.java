...
// Originally from UpdatedComponentTests/StandardValidation/RPC/RPC_FloatParam_IncorrectDataType.xls;
...
/**
 * Ensure that Cougar returns the correct fault when a  RPC request with Float param  is made with incorrect data type parameter
 */
public class RPCFloatParamIncorrectDataTypeTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray3[0].put("method","floatOperation");
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "floatOperation") );
