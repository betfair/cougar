...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_Boolean_Mandatory_NotSet.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a request is missing a mandatory Bool header parameter
 */
public class RestIDLHeaderParamBooleanMandatoryNotSetTest {
    @Test
    public void doTest() throws Exception {
        ...
        Map<CougarMessageProtocolRequestTypeEnum, Object> convertResponseToRestTypes13 = hinstance.convertResponseToRestTypes(createAsDocument12, hbean);
        ...
        AssertionUtils.multiAssertEquals(convertResponseToRestTypes13.get(CougarMessageProtocolRequestTypeEnum.RESTXML), response6.getResponseObject());
        ...
        AssertionUtils.multiAssertEquals(convertResponseToRestTypes13.get(CougarMessageProtocolRequestTypeEnum.RESTXML), response9.getResponseObject());
