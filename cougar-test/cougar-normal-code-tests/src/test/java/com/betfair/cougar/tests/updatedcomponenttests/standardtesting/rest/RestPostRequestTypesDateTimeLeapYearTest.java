...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTime_LeapYear.xls;
...
/**
 * Ensure that Cougar can handle the dateTime data type in the post body with the date set to February 29th (in a leap year)
 */
public class RestPostRequestTypesDateTimeLeapYearTest {
    @Test
    public void doTest() throws Exception {
        ...
        String date = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2012, (int) 2, (int) 29, (int) 13, (int) 50, (int) 0, (int) 435);
        // Set the post body to contain a date time object (with the date set to Feb 29th in a leap year)
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<bodyParamDateTimeObject><dateTimeParameter>2012-02-29T13:50:00.435Z</dateTimeParameter></bodyParamDateTimeObject>".getBytes())));
