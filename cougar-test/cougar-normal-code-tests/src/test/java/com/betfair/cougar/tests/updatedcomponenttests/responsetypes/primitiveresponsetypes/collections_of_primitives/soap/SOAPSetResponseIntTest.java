...
/**
 * Ensure that when a SOAP request operation is performed against Cougar, passing in a Set of primitive integers, it is correctly processed and the correct Set response returned.
 */
public class SOAPSetResponseIntTest {
    ...
    public void doTest() throws Exception {
        ...
        cougarManager2.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp7, new RequestLogRequirement("2.8", "i32SetSimpleTypeEcho") );
    }
