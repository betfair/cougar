...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_Set_null_XML.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST XML request contains a null Set body parameter
 */
public class RestIDLPostBodyElementSetnullXMLTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the Set body parameter to null
        getNewHttpCallBean2.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><simpleSet xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:nil=\"true\"/></message>".getBytes())));
        ...
        cougarManager10.verifyAccessLogEntriesAfterDate(getTimeAsTimeStamp9, new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/simpleSetOperation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/simpleSetOperation", "BadRequest") );
    }
