...
// Originally from UpdatedComponentTests/ResponseTypes/REST/Rest_Post_MapResponse_JSON.xls;
...
/**
 * Ensure that when a Rest (JSON) Post operation is performed against Cougar, passing in a Map in the post body, it is correctly de-serialized, processed, returned the correct Map response.
 */
public class RestPostMapResponseJSONTest {
    @Test
