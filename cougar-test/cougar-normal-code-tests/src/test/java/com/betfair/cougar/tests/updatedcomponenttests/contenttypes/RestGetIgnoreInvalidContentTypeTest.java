...
/**
 * Ensure that when a Rest Get is performed against Cougar with an invalid content type supplied, it is correctly processed and the content type is ignored
 */
