...
// Originally from UpdatedComponentTests/ResponseTypes/RPC/RPC_Post_ListResponse_BlankEntry.xls;
...
/**
 * Ensure that when a Batched JSON request is performed against Cougar, passing a List with a blank entry in the post body, it is correctly de-serialized, processed, returned the correct response.
 */
public class RPCPostListResponseBlankEntryTest {
    @Test
