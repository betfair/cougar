...
// Originally from UpdatedComponentTests/StandardTesting/RPC/RPC_Post_RequestTypes_Booleans.xls;
...
/**
 * Ensure that Cougar can handle Booleans in the post body, header params and query params of an RPC request
 */
public class RPCPostRequestTypesBooleansTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray2[0].put("method","boolOperation");
        mapArray2[0].put("params","[\"true\", \"true\",{\"bodyParameter\":false}]");
        mapArray2[0].put("id","1");
        mapArray2[1] = new HashMap();
        mapArray2[1].put("method","boolOperation");
        mapArray2[1].put("params","[\"false\", \"true\",{\"bodyParameter\":false}]");
        ...
        AssertionUtils.multiAssertEquals("{\"id\":1,\"result\":{\"headerParameter\":true,\"queryParameter\":true,\"bodyParameter\":false},\"jsonrpc\":\"2.0\"}", map5.get("response1"));
        AssertionUtils.multiAssertEquals("{\"id\":2,\"result\":{\"headerParameter\":false,\"queryParameter\":true,\"bodyParameter\":false},\"jsonrpc\":\"2.0\"}", map5.get("response2"));
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "boolOperation"),new RequestLogRequirement("2.8", "boolOperation") );
