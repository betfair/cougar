...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeMap_XML_NegativeOffset_HoursAndMinutes.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeMap data type in the post body of an XML request containing a date with a negative offset of hours and minutes (0230 = offset by 2 hours 30 minutes)
 */
public class RestPostRequestTypesDateTimeMapXMLNegativeOffsetHoursAndMinutesTest {
    @Test
    public void doTest() throws Exception {
        ...
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeMap><entry key=\"date1\"><Date>2009-06-01T11:50:00.435-02:30</Date></entry><entry key=\"date2\"><Date>2009-06-01T12:50:00.435-02:30</Date></entry></dateTimeMap></message>".getBytes())));
