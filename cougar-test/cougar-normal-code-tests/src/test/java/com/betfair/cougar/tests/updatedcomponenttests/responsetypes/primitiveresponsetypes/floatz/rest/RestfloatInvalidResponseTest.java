...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/float/REST/Rest_floatInvalidResponse.xls;
...
/**
 * Test that the Cougar service throws a correct error when invalid value is passed to  float primitive type parameter (REST)
 */
public class RestfloatInvalidResponseTest {
    @Test
