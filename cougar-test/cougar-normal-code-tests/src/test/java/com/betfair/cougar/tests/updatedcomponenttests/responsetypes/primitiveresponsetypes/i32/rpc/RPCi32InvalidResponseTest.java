...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/i32/RPC/RPC_i32InvalidResponse.xls;
...
/**
 * Test that the Cougar service throws a correct error when invalid value is passed to  i32 primitive type parameter (Batched JSON)
 */
public class RPCi32InvalidResponseTest {
    @Test
