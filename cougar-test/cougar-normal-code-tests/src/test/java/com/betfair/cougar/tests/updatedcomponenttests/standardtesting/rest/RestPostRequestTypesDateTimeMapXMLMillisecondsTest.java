...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeMap_XML_Milliseconds.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeMap data type in the post body of an XML request containg a date with milliseconds accuracy
 */
public class RestPostRequestTypesDateTimeMapXMLMillisecondsTest {
    @Test
    public void doTest() throws Exception {
        ...
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeMap><entry key=\"date1\"><Date>2009-06-01T13:50:00.435Z</Date></entry><entry key=\"date2\"><Date>2009-06-01T14:50:00.435Z</Date></entry></dateTimeMap></message>".getBytes())));
