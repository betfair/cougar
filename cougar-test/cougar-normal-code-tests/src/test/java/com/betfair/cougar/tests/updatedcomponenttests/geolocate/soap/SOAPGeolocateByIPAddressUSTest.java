...
// Originally from UpdatedComponentTests/Geolocate/SOAP/SOAP_Geolocate_ByIPAddress_US.xls;
...
/**
 * Ensure that when a SOAP request is received by Cougar, the ipaddress is used to correctly identify where the request originated, in this case: US
 */
public class SOAPGeolocateByIPAddressUSTest {
    @Test
    public void doTest() throws Exception {
        ...
        getNewHttpCallBean2.setIpAddress("65.55.209.105");
        ...
        cougarManager2.verifyAccessLogEntriesAfterDate(getTimeAsTimeStamp8, new AccessLogRequirement("65.55.209.105", "/BaselineService/v2", "Ok") );
    }
