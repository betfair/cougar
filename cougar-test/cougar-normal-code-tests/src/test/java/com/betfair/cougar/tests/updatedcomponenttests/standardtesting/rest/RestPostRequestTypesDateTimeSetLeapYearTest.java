...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeSet_LeapYear.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeSet data type in the post body with a date set to February 29th in a leap year
 */
public class RestPostRequestTypesDateTimeSetLeapYearTest {
    @Test
    public void doTest() throws Exception {
        ...
        String date1 = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2012, (int) 2, (int) 29, (int) 13, (int) 50, (int) 0, (int) 435);
        // Create a date time object expected to be in the response object

        String date2 = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2012, (int) 2, (int) 29, (int) 13, (int) 51, (int) 0, (int) 435);
        // Set the post body to contain a date time set object containing a date set to Feb 29th in a leap year
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeSet><Date>2012-02-29T13:50:00.435Z</Date><Date>2012-02-29T13:51:00.435Z</Date></dateTimeSet></message>".getBytes())));
