...
// Originally from UpdatedComponentTests/StandardValidation/RPC/RPC_SimpleEnumSetIncorrectDataType.xls;
...
/**
 * Ensure that Cougar returns the correct fault when a  RPC request when a request passes a set of simple type enum with an invalid entry
 */
public class RPCSimpleEnumSetIncorrectDataTypeTest {
    @Test
