...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_Float_null.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when null is passed in a Float parameter
 */
public class RestIDLHeaderParamFloatnullTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the Float Header param as null
