...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_Double_null.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request contains null as a Double body parameter
 */
public class RestIDLPostBodyElementDoublenullTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the Double body parameter as null
