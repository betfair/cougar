...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/Test-IDL/SOAP_RequestTypes_Integers_null.xls;
...
/**
 * Ensure that when a SOAP request is received with a null Integer parameter, Cougar returns the correct fault
 */
public class SOAPRequestTypesIntegersnullTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            // Create the SOAP request as an XML Document (with a null body parameter)
            XMLHelpers xMLHelpers2 = new XMLHelpers();
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<I32OperationRequest><headerParam>1</headerParam><queryParam>43523434</queryParam><message><bodyParameter></bodyParameter></message></I32OperationRequest>");
