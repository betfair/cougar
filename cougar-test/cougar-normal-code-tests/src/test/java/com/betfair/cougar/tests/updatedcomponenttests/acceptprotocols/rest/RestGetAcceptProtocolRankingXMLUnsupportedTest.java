...
/**
 * Ensure that when a Rest XML Get is performed on Cougar, with no supported ranked response protocols included, the correct error response is generated
 */
public class RestGetAcceptProtocolRankingXMLUnsupportedTest {
    ...
    public void doTest() throws Exception {
        ...
        HttpResponseBean getResponseObjectsByEnum13 = getNewHttpCallBean2.getResponseObjectsByEnum(com.betfair.testing.utils.cougar.enums.CougarMessageProtocolResponseTypeEnum.REST);
