...
/**
 * Ensure that when sustained Rest JSON post requests are performed against Cougar, each request is successfully sent and the JSON response to each is correctly handled
 */
public class RestPostSustainedRequestsAssertedJSONJSONTest {
    ...
    public void doTest() throws Exception {
        ...
        RestSustainedPostRequestsJETTTest.RestSustainedPostRequestsTestResultBean executeTest3 = new RestSustainedPostRequestsJETTTest().executeTest(4000, CougarMessageProtocolRequestTypeEnum.RESTJSON, CougarMessageContentTypeEnum.JSON);
