...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeList_LeapYear.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeList data type in the post body containing dates set to February 29th in a leap year
 */
public class RestPostRequestTypesDateTimeListLeapYearTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the post body to contain a date time list object containing date set to Feb 29th in a leap year
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeList><Date>2012-02-29T13:50:00.435Z</Date><Date>2012-02-29T13:51:00.435Z</Date></dateTimeList></message>".getBytes())));
