...
/**
 * Ensure that when a Rest (XML/JSON) Post operation is performed against Cougar, passing a List in the post body, it is correctly de-serialized, processed, returned the correct response.
 */
public class RestPostListIntResponseXMLTest {
    ...
    public void doTest() throws Exception {
        ...
        cougarManager1.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp7, new RequestLogRequirement("2.8", "i32ListSimpleTypeEcho"),new RequestLogRequirement("2.8", "i32ListSimpleTypeEcho"),new RequestLogRequirement("2.8", "i32ListSimpleTypeEcho"),new RequestLogRequirement("2.8", "i32ListSimpleTypeEcho") );
    }
