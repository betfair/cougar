...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeMap_XML_NegativeOffset.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeMap data type in the post body of an XML request containing a date with a negative offset
 */
public class RestPostRequestTypesDateTimeMapXMLNegativeOffsetTest {
    @Test
    public void doTest() throws Exception {
        ...
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeMap><entry key=\"date1\"><Date>2009-06-01T11:50:00.435-02:00</Date></entry><entry key=\"date2\"><Date>2009-06-01T12:50:00.435-02:00</Date></entry></dateTimeMap></message>".getBytes())));
