...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_Map_XML_null.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST XML request contains a null map body parameter
 */
public class RestIDLPostBodyElementMapXMLnullTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the map body parameter to null
        getNewHttpCallBean2.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><simpleMap xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:nil=\"true\"/></message>".getBytes())));
