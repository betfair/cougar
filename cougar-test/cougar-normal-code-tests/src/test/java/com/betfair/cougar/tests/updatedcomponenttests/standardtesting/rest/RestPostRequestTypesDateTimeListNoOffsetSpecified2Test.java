...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeList_NoOffsetSpecified_2.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeList data type in the post body containing dates with no offset specifed
 */
public class RestPostRequestTypesDateTimeListNoOffsetSpecified2Test {
    @Test
    public void doTest() throws Exception {
        ...
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeList><Date>2009-02-01T11:50:00.435</Date><Date>2009-02-01T11:50:00.435</Date></dateTimeList></message>".getBytes())));
