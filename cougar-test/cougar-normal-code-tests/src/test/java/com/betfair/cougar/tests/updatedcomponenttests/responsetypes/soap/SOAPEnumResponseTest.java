...
// Originally from UpdatedComponentTests/ResponseTypes/SOAP/SOAP_EnumResponse.xls;
...
/**
 * Test that the Cougar service allows to use enumerations in the response (SOAP)
 */
public class SOAPEnumResponseTest {
    @Test
    public void doTest() throws Exception {
        // Create a soap request structure as a Document object
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document requestDocument = xMLHelpers1.getXMLObjectFromString("<CallWithEnumResponseRequest></CallWithEnumResponseRequest>");
        // Get an HTTPCallBean
        ...
        Document responseDocument = xMLHelpers4.getXMLObjectFromString("<response>WEASEL</response>");
        ...
        CougarManager.verifyRequestLogEntriesAfterDate(timestamp, new RequestLogRequirement("2.8", "callWithEnumResponse") );
    }
