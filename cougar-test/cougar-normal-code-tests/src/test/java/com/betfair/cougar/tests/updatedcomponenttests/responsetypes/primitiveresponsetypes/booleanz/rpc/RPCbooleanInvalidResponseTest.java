...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/boolean/RPC/RPC_booleanInvalidResponse.xls;
...
/**
 * Test that the Cougar service throws a correct error when invalid value is passed to boolean primitive type parameter (Batched JSON)
 */
public class RPCbooleanInvalidResponseTest {
    @Test
