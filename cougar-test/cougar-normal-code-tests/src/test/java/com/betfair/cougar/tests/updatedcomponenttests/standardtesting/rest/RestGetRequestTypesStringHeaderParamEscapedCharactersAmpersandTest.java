...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Get_RequestTypes_String_HeaderParam_EscapedCharacters_Ampersand.xls;
 ...
 */
public class RestGetRequestTypesStringHeaderParamEscapedCharactersAmpersandTest {
    @Test
    public void doTest() throws Exception {
        ...
        map3.put("HeaderParam","this&that");
        ...
        Document createAsDocument11 = xMLHelpers5.getXMLObjectFromString("<NonMandatoryParamsOperationResponseObject><headerParameter>this&amp;that</headerParameter><queryParameter>queryParamString</queryParameter></NonMandatoryParamsOperationResponseObject>");
