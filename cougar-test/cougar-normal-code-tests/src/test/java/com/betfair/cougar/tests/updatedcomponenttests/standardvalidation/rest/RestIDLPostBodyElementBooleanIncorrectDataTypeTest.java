...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_Boolean_IncorrectDataType.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request contains a non Boolean as a Boolean body parameter
 */
public class RestIDLPostBodyElementBooleanIncorrectDataTypeTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the Boolean body parameter as a non Boolean
        getNewHttpCallBean2.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><bodyParameter>dsda</bodyParameter></message>".getBytes())));
