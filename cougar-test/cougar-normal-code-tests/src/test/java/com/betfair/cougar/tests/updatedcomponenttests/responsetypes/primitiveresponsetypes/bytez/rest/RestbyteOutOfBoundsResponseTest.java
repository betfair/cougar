...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/byte/REST/Rest_byteOutOfBoundsResponse.xls;
...
/**
 * Test that the Cougar service returns a correct error when value passed  for byte is out of type bounds (REST)
 */
public class RestbyteOutOfBoundsResponseTest {
    @Test
