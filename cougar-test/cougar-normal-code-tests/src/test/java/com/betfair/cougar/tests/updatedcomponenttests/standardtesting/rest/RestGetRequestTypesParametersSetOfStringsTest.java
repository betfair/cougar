...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Get_RequestTypes_Parameters_SetOfStrings.xls;
...
/**
 * Ensure that when the 4 supported Rest XML/JSON Gets are performed, Cougar can handle a Set of Strings being passed in the Header and Query parameters
 */
public class RestGetRequestTypesParametersSetOfStringsTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters to sets of string
        Map map2 = new HashMap();
        map2.put("HeaderParam","header1,header2,header3,header4");
        httpCallBeanBaseline.setHeaderParams(map2);
        
        Map map3 = new HashMap();
        map3.put("queryParam","query1,query2,query3,query4");
        ...
        Document xmlDocument = xMLHelpers5.getXMLObjectFromString("<NonMandatoryParamsOperationResponseObject><headerParameter>header1,header2,header3,header4</headerParameter><queryParameter>query1,query2,query3,query4</queryParameter></NonMandatoryParamsOperationResponseObject>");
