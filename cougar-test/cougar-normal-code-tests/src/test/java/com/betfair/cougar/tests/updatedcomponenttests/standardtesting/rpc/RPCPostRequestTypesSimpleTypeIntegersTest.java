...
/**
 * Ensure that Cougar can handle SimpleType Integers in the post body, header params and query params of an RPC request
 */
public class RPCPostRequestTypesSimpleTypeIntegersTest {
    ...
    public void doTest() throws Exception {
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "i32SimpleTypeOperation"),new RequestLogRequirement("2.8", "i32SimpleTypeOperation"),new RequestLogRequirement("2.8", "i32SimpleTypeOperation") );
