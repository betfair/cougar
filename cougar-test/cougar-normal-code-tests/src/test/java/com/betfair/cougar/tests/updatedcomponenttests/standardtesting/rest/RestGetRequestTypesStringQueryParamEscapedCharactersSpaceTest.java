...
public class RestGetRequestTypesStringQueryParamEscapedCharactersSpaceTest {
    ...
    public void doTest() throws Exception {
        ...
        Document createAsDocument10 = xMLHelpers6.createAsDocument(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream(("<SimpleResponse><message>headerParam=Foo,queryParam=a space,dateQueryParam="+convertedDate1+"</message></SimpleResponse>").getBytes())));
