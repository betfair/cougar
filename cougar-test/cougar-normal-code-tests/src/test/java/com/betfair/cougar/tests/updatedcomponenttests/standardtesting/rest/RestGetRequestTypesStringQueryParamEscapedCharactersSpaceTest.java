...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Get_RequestTypes_String_QueryParam_EscapedCharacters_Space.xls;
...
/**
 * Ensure that Cougar can correctly handle a string Query Param containing a space
 */
public class RestGetRequestTypesStringQueryParamEscapedCharactersSpaceTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the query parameter to a string containing a space
        Map map3 = new HashMap();
        map3.put("queryParam","a%20space");
        ...
        Document createAsDocument10 = xMLHelpers6.createAsDocument(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream(("<SimpleResponse><message>headerParam=Foo,queryParam=a space,dateQueryParam="+cougarHelpers4.dateInUTC(convertedDate1)+"</message></SimpleResponse>").getBytes())));
