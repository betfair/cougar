...
/**
 * Ensure that when a Batched JSON request is performed against Cougar, passing a Set with a blank entry in the post body, it is correctly de-serialized, processed, returned the correct response.
 */
