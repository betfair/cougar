...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeSet_MiliisecondsNotSpecified.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeSet data type in the post body containing dates with milliseconds not specified
 */
public class RestPostRequestTypesDateTimeSetMiliisecondsNotSpecifiedTest {
    @Test
    public void doTest() throws Exception {
        ...
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeSet><Date>2009-06-01T13:50:00Z</Date><Date>2009-06-02T13:50:00Z</Date></dateTimeSet></message>".getBytes())));
