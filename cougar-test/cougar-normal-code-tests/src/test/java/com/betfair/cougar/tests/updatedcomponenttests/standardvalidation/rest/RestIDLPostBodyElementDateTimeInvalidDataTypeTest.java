...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_DateTime_InvalidDataType.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request contains a non dateTime as a dateTime body parameter
 */
public class RestIDLPostBodyElementDateTimeInvalidDataTypeTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the DateTime body parameter as a non DateTime object
        getNewHttpCallBean2.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<BodyParamDateTimeObject><dateTimeParameter>ffwefewfewfewfw</dateTimeParameter></BodyParamDateTimeObject>".getBytes())));
