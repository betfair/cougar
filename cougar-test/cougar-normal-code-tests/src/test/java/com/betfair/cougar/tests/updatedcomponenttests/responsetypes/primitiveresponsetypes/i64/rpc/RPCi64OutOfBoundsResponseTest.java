...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/i64/RPC/RPC_i64OutOfBoundsResponse.xls;
...
/**
 * Test that the Cougar service returns a correct error when value passed  for i64 is out of type bounds (Batched JSON)
 */
public class RPCi64OutOfBoundsResponseTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray2[0].put("params","[-9223372036854775809]");
        mapArray2[0].put("id","1");
        mapArray2[1] = new HashMap();
        mapArray2[1].put("method","i64SimpleTypeEcho");
        mapArray2[1].put("params","[-9223372036854775809]");
