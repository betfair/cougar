...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_SimpleType_Integer_IncorrectDataType.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a request contains a non Simple Type Integer object as a simple type Integer parameter
 */
public class RestIDLHeaderParamSimpleTypeIntegerIncorrectDataTypeTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the Simple Type Integer Header to a non Integer
