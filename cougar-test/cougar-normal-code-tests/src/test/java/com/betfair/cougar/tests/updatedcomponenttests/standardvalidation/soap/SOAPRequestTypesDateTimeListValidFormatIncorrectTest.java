...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/SOAP_RequestTypes_DateTimeList_ValidFormat_Incorrect.xls;
...
/**
 * Ensure that when a SOAP request is received with an invalid dateTimeList format, Cougar returns the correct fault
 */
public class SOAPRequestTypesDateTimeListValidFormatIncorrectTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            // Create the SOAP request as an XML Document (containing a dateTime object in an invalid format)
            XMLHelpers xMLHelpers2 = new XMLHelpers();
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<DateTimeListOperationRequest><message><dateTimeList><Date>0000-00-00T00:00:00.000</Date><Date>0000-00-00T00:00:00.000</Date></dateTimeList></message></DateTimeListOperationRequest>");
