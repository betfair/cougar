...
/**
 * Ensure that Cougar returns the correct fault, when a REST XML requestis missing a null map body parameter (the whole body parameter is null, not just the map it contains)
 */
