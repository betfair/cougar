...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_Long_OutOfRange.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request contains an out of range Long body parameter
 */
public class RestIDLPostBodyElementLongOutOfRangeTest {
    @Test
    public void doTest() throws Exception {
        ...
        getNewHttpCallBean2.setOperationName("i64Operation");
        ...
        map3.put("HeaderParam","234");
        getNewHttpCallBean2.setHeaderParams(map3);

        Map map4 = new HashMap();
        map4.put("queryParam","-50");
        getNewHttpCallBean2.setQueryParams(map4);
        // Set the Long body parameter to an out of range value
        getNewHttpCallBean2.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><bodyParameter>92233720368547758089</bodyParameter></message>".getBytes())));
        ...
        cougarManager15.verifyAccessLogEntriesAfterDate(getTimeAsTimeStamp11, new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/i64Operation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/i64Operation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/i64Operation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/i64Operation", "BadRequest") );
    }
