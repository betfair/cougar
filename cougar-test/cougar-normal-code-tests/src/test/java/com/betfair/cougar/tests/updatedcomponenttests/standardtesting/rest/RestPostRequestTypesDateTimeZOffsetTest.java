...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTime_ZOffset.xls;
 ...
 */
public class RestPostRequestTypesDateTimeZOffsetTest {
    @Test
    public void doTest() throws Exception {
        ...
        String date = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2009, (int) 6, (int) 1, (int) 11, (int) 50, (int) 0, (int) 435);
        // Set the post body to contain a date time object specifying the UTC timezone
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<bodyParamDateTimeObject><dateTimeParameter>2009-06-01T11:50:00.435Z</dateTimeParameter></bodyParamDateTimeObject>".getBytes())));
