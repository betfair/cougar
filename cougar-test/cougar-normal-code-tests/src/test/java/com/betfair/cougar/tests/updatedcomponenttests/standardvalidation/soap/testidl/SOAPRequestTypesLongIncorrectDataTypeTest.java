...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/Test-IDL/SOAP_RequestTypes_Long_Incorrect_DataType.xls;
...
/**
 * Ensure that when a SOAP request is received with an Long parameter of an incorrect data type, Cougar returns the correct fault
 */
public class SOAPRequestTypesLongIncorrectDataTypeTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            // Create the SOAP request as an XML Document (with a header parameter of the wrong type)
            XMLHelpers xMLHelpers2 = new XMLHelpers();
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<I64OperationRequest><headerParam>BLAH</headerParam><queryParam>543553</queryParam><message><bodyParameter>543553</bodyParameter></message></I64OperationRequest>");
