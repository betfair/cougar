...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_Map_SimpleMap_JSON_NullValue.xls;
...
/**
 * Ensure that when a Rest (JSON) Post operation is performed, Cougar can correctly handle a simple Map with a null value in the post body
 */
public class RestPostRequestTypesMapSimpleMapJSONNullValueTest {
    @Test
