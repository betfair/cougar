...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/byte/REST/Rest_byteInvalidResponse.xls;
...
/**
 * Test that the Cougar service throws a correct error when invalid value is passed to  byte primitive type parameter (REST)
 */
public class RestbyteInvalidResponseTest {
    @Test
    public void doTest() throws Exception {
        ...
        CougarManager.verifyAccessLogEntriesAfterDate(timeStamp, new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/byteEcho", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/byteEcho", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/byteEcho", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/byteEcho", "BadRequest") );
    }
