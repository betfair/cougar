...
/**
 * Ensure that when the 4 supported Rest XML/JSON Gets are performed, Cougar can handle a Set of Strings with a null entry being passed in the Header and Query parameters
 */
