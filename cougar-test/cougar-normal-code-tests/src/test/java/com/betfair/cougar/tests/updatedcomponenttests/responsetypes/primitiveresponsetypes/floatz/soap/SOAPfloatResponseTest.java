...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/float/SOAP/SOAP_floatResponse.xls;
package com.betfair.cougar.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.floatz.soap;
...
/**
 * Test that the Cougar service allows to use float primitive type in the response (SOAP)
 */
public class SOAPfloatResponseTest {
    @Test
    public void doTest() throws Exception {
        // Create a soap request structure as a Document object
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document requestDocument = xMLHelpers1.getXMLObjectFromString("<FloatSimpleTypeEchoRequest><msg>0.13</msg></FloatSimpleTypeEchoRequest>");
        // Get an HTTPCallBean
        ...
        CougarManager.verifyRequestLogEntriesAfterDate(timestamp, new RequestLogRequirement("2.8", "floatSimpleTypeEcho") );
    }
