...
/**
 * Ensure that when concurrent Batched JSON requests are performed against Cougar, each batch of requests is successfully sent and the JSON response to each is correctly handled
 */
