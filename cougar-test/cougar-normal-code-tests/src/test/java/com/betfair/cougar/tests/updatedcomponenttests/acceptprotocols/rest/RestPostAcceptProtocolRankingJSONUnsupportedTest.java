...
/**
 * Ensure that when a Rest JSON Post operation is performed on Cougar, with all ranked response protocols being unsupported, the correct error response is generated.
 */
