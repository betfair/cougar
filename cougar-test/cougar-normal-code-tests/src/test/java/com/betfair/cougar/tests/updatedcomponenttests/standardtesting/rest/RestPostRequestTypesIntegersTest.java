...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_Integers.xls;
...
/**
 * Ensure that Cougar can handle Integers in the post body, header params and query params
 */
public class RestPostRequestTypesIntegersTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set each of the parameter types to contain a integer datatype object
