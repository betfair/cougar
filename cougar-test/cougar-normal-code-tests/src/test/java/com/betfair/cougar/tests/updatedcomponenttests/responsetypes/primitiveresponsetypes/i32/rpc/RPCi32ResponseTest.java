...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/i32/RPC/RPC_i32Response.xls;
...
/**
 * Test that the Cougar service allows to use i32 primitive type in the response (Batched JSON)
 */
public class RPCi32ResponseTest {
    @Test
    public void doTest() throws Exception {
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "i32SimpleTypeEcho"),new RequestLogRequirement("2.8", "i32SimpleTypeEcho") );
