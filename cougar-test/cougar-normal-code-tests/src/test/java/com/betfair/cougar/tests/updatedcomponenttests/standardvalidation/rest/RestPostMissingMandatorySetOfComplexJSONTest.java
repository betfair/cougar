...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_Post_MissingMandatory_SetOfComplex_JSON.xls;
...
/**
 * Ensure that the correct fault is returned when, a Rest(JSON) Post operation is performed against Cougar, passing a Set of complex object in the post body, where the complex object  contained in the set has a mandatory field missing
 */
public class RestPostMissingMandatorySetOfComplexJSONTest {
    @Test
    public void doTest() throws Exception {
        ...
        map2.put("RESTJSON","{\"inputSet\": [{\"ComplexObject\":{}}]}");
