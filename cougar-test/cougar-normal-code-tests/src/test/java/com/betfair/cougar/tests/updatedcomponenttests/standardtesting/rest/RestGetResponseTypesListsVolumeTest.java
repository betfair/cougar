...
public class RestGetResponseTypesListsVolumeTest {
    ...
    public void doTest() throws Exception {
        ...
        Document createAsDocument10 = xMLHelpers6.createAsDocument(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream(("<SimpleResponse><message>headerParam=Foo,queryParam=this &amp; that is 100%,dateQueryParam="+convertedDate1+"</message></SimpleResponse>").getBytes())));
