...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Get_ResponseTypes_Lists_Volume.xls;
...
/**
 * Ensure that Cougar can correctly handle a string Query Param containing  a number of encoded characters
 */
public class RestGetResponseTypesListsVolumeTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the query parameter to a string containing multiple encoded characters
        Map map3 = new HashMap();
        map3.put("queryParam","this%20%26%20that%20is%20100%25");
        ...
        Document createAsDocument10 = xMLHelpers6.createAsDocument(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream(("<SimpleResponse><message>headerParam=Foo,queryParam=this &amp; that is 100%,dateQueryParam="+cougarHelpers4.dateInUTC(convertedDate1)+"</message></SimpleResponse>").getBytes())));
