...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_SimpleType_ENUM_InvalidValue.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request contains a SimpleType ENUM body parameter with an invalid value
 */
public class RestIDLPostBodyElementSimpleTypeENUMInvalidValueTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, setting the SimpleType ENUM body parameter to be an invalid value
        Map map3 = new HashMap();
        map3.put("HeaderParam","FOOBAR");
        ...
        getNewHttpCallBean2.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><bodyParameter>INVALID</bodyParameter></message>".getBytes())));
