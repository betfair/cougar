...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_List_XML_NullEntry.xls;
...
/**
 * Ensure that Cougar can handle a list with a null entry in the post body from an XML request
 */
public class RestPostRequestTypesListXMLNullEntryTest {
    @Test
    public void doTest() throws Exception {
        ...
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<LargeRequest><size>1</size><objects><ComplexObject><name>n1</name><value1>11</value1><value2>21</value2></ComplexObject><ComplexObject xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:nil=\"true\"/><ComplexObject><name>n3</name><value1>13</value1><value2>23</value2></ComplexObject></objects><oddOrEven>ODD</oddOrEven><returnList>true</returnList></LargeRequest>".getBytes())));
        ...
        // Check the 2 responses to the XML requests are as expected
