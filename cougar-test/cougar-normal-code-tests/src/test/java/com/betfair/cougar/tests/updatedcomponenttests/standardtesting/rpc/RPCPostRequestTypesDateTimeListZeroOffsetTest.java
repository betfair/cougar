...
// Originally from UpdatedComponentTests/StandardTesting/RPC/RPC_Post_RequestTypes_DateTimeList_ZeroOffset.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeList data type with Zero Offsets in the post body of an RPC request
 */
public class RPCPostRequestTypesDateTimeListZeroOffsetTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray2[0].put("params","[{\"dateTimeList\":[\"2009-06-01T11:50:00.435Z\",\"2009-06-02T11:50:00.435Z\"]}]");
        mapArray2[0].put("id","\"DateTimeListZeroOff\"");
        mapArray2[1] = new HashMap();
        mapArray2[1].put("method","dateTimeListOperation");
        mapArray2[1].put("params","[{\"dateTimeList\":[\"2009-02-01T11:50:00.435Z\",\"2009-02-02T11:50:00.435Z\"]}]");
        mapArray2[1].put("id","\"DateTimeListZeroOff2\"");
        ...
        AssertionUtils.multiAssertEquals("{\"id\":\"DateTimeListZeroOff\",\"result\":{\"responseList\":[\"2009-06-01T11:50:00.435Z\",\"2009-06-02T11:50:00.435Z\"]},\"jsonrpc\":\"2.0\"}", map5.get("responseDateTimeListZeroOff"));
        AssertionUtils.multiAssertEquals("{\"id\":\"DateTimeListZeroOff2\",\"result\":{\"responseList\":[\"2009-02-01T11:50:00.435Z\",\"2009-02-02T11:50:00.435Z\"]},\"jsonrpc\":\"2.0\"}", map5.get("responseDateTimeListZeroOff2"));
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "dateTimeListOperation"),new RequestLogRequirement("2.8", "dateTimeListOperation") );
