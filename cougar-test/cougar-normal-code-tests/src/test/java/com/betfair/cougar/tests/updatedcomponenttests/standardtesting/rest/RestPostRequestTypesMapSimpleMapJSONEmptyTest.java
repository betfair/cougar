...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_Map_SimpleMap_JSON_Empty.xls;
...
/**
 * Ensure that when a Rest (JSON) Post operation is performed, Cougar can correctly handle an empty simple Map in the post body
 */
public class RestPostRequestTypesMapSimpleMapJSONEmptyTest {
    @Test
    public void doTest() throws Exception {
        ...
        map2.put("RESTJSON","{\"message\":{\"simpleMap\":{}}\n}");
        ...
        Document createAsDocument10 = xMLHelpers4.getXMLObjectFromString("<SimpleMapOperationResponse><SimpleMapOperationResponseObject><responseMap/></SimpleMapOperationResponseObject></SimpleMapOperationResponse>");
        // Create the expected response as a JSON object
        JSONHelpers jSONHelpers5 = new JSONHelpers();
        JSONObject createAsJSONObject11 = jSONHelpers5.createAsJSONObject(new JSONObject("{\"responseMap\": {}}"));
