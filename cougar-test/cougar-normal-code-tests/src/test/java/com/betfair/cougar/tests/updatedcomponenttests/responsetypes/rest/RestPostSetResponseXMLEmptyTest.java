...
// Originally from UpdatedComponentTests/ResponseTypes/REST/Rest_Post_SetResponse_XML_Empty.xls;
 ...
 */
public class RestPostSetResponseXMLEmptyTest {
    @Test
    public void doTest() throws Exception {
        ...
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<inputSet/>".getBytes())));
        ...
        Document createAsDocument10 = xMLHelpers3.getXMLObjectFromString("<TestSimpleSetGetResponse></TestSimpleSetGetResponse>");
