...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/SOAP_RequestTypes_Set_SimpleSet_MissingMandatory.xls;
...
/**
 * Ensure that when a SOAP request is received with an missing mandatory parameter from a set, Cougar returns the correct fault
 */
public class SOAPRequestTypesSetSimpleSetMissingMandatoryTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<SimpleSetOperationRequest><message></message></SimpleSetOperationRequest>");
