...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_Set_SimpleSet.xls;
...
/**
 * Ensure that when a Rest (XML/JSON) Post operation is performed, Cougar can correctly handle a simple Set in the post body
 */
public class RestPostRequestTypesSetSimpleSetTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the post body to contain a simple set
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><simpleSet><String>aaa string</String><String>ddd string</String><String>bbb string</String><String>ccc string</String></simpleSet></message>".getBytes())));
