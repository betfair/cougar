...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_HeaderParam_ExtraUnexpectedHeaderParams.xls;
...
/**
 * Ensure that when a request for an operation has a extra header in the request, it is ignored and the correct response is still returned
 */
public class RestPostHeaderParamExtraUnexpectedHeaderParamsTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set header parameters (including an extra unexpected one which will be ignored)
        Map map2 = new HashMap();
        map2.put("HeaderParam","gijogifjdogfd");
        map2.put("anExtraHeaderParam","ignored");
