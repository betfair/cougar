...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeList_PositiveOffset_2.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeList data type in the post body containing dates with a positive offset
 */
public class RestPostRequestTypesDateTimeListPositiveOffset2Test {
    @Test
    public void doTest() throws Exception {
        ...
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeList><Date>2009-02-01T15:50:00.435+02:00</Date><Date>2009-02-01T16:50:00.435+02:00</Date></dateTimeList></message>".getBytes())));
