...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_SimpleType_ENUM_blank.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request contains a blank SimpleType ENUM body parameter
 */
public class RestIDLPostBodyElementSimpleTypeENUMblankTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, setting the SimpleType ENUM body parameter to be blank
