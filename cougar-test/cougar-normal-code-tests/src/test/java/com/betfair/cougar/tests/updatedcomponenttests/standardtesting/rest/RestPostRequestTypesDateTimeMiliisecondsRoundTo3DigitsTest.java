...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTime_Miliiseconds_RoundTo3Digits.xls;
...
/**
 * Ensure that Cougar can handle the dateTime data type in the post body with more than 3 digits millisecond accuracy (round down)
 */
public class RestPostRequestTypesDateTimeMiliisecondsRoundTo3DigitsTest {
    @Test
    public void doTest() throws Exception {
        ...
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<bodyParamDateTimeObject><dateTimeParameter>2009-01-01T13:50:00.4343Z</dateTimeParameter></bodyParamDateTimeObject>".getBytes())));
