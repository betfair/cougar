...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_QueryParam_Integer_OutOfRange.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request passes an out of range value in an Integer Query parameter
 */
public class RestIDLQueryParamIntegerOutOfRangeTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, setting the Integer Query parameter to an out of range value
