...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_QueryParam_SimpleType_ENUM_Mandatory_NotSet.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request is missing a mandatory SimpleTypeENUM Query parameter
 */
public class RestIDLQueryParamSimpleTypeENUMMandatoryNotSetTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, don't set the mandatory SimpleTypeENUM query parameter
