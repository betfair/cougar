...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeList_ZOffset.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeList data type in the post body containing dates specifying the UTC timezone
 */
public class RestPostRequestTypesDateTimeListZOffsetTest {
    @Test
    public void doTest() throws Exception {
        ...
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeList><Date>2009-06-01T11:50:00.435Z</Date><Date>2009-06-01T11:50:00.435Z</Date></dateTimeList></message>".getBytes())));
