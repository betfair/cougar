...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_DateTime_null.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request contains a null DateTime body parameter
 */
public class RestIDLPostBodyElementDateTimenullTest {
    @Test
    public void doTest() throws Exception {
        ...
        getNewHttpCallBean2.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<BodyParamDateTimeObject><dateTimeParameter></dateTimeParameter></BodyParamDateTimeObject>".getBytes())));
