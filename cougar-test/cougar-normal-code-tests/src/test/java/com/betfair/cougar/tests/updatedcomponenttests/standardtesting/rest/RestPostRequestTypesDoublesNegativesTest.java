...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_Doubles_Negatives.xls;
...
/**
 * Ensure that Cougar can handle Negative Doubles in the post body, header params and query params that are infinity
 */
public class RestPostRequestTypesDoublesNegativesTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set each of the parameter types to contain a negative double datatype object
        Map map2 = new HashMap();
        map2.put("queryParam","-3.343432");
        getNewHttpCallBean1.setQueryParams(map2);
        
        Map map3 = new HashMap();
        map3.put("HeaderParam","-54.43223");
        getNewHttpCallBean1.setHeaderParams(map3);
        
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><bodyParameter>-4.0</bodyParameter></message>".getBytes())));
        ...
        Document createAsDocument11 = xMLHelpers5.getXMLObjectFromString("<DoubleOperationResponseObject><bodyParameter>-4.0</bodyParameter><headerParameter>-54.43223</headerParameter><queryParameter>-3.343432</queryParameter></DoubleOperationResponseObject>");
        ...
        cougarManager1.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp9, new RequestLogRequirement("2.8", "doubleOperation"),new RequestLogRequirement("2.8", "doubleOperation"),new RequestLogRequirement("2.8", "doubleOperation"),new RequestLogRequirement("2.8", "doubleOperation") );
    }
