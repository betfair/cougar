...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeList_NegativeOffset.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeList data type in the post body containing dates with a negative offset
 */
public class RestPostRequestTypesDateTimeListNegativeOffsetTest {
    @Test
    public void doTest() throws Exception {
        ...
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeList><Date>2009-06-01T11:50:00.435-02:00</Date><Date>2009-06-01T12:50:00.435-02:00</Date></dateTimeList></message>".getBytes())));
