...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_QueryParam_ListOfSimpleTypeEnums_1BlankEntry.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request passes a blank List of SimpleTypeEnum as a Query parameter
 */
public class RestIDLQueryParamListOfSimpleTypeEnums1BlankEntryTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, setting the List of SimpleTypeEnum Query parameter to be a blank list
        Map map2 = new HashMap();
        map2.put("HeaderParam","FOOBAR,BARFOO");
        httpCallBeanBaseline.setHeaderParams(map2);

        Map map3 = new HashMap();
        map3.put("queryParam",null);
