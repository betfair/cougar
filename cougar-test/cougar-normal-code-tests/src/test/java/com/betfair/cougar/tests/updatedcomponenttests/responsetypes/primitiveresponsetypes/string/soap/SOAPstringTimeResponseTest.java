...
package com.betfair.cougar.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.string.soap;
...
/**
 * Test that the Cougar service allows to use String primitive type in the response (SOAP)
 */
public class SOAPstringTimeResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        CougarManager.verifyRequestLogEntriesAfterDate(timestamp, new RequestLogRequirement("2.8", "stringSimpleTypeEcho") );
    }
