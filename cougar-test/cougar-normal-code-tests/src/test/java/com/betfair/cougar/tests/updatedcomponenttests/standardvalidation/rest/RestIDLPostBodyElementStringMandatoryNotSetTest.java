...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_String_Mandatory_NotSet.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request contains a body parameter that is a missing a mandatory String field
 */
public class RestIDLPostBodyElementStringMandatoryNotSetTest {
    @Test
    public void doTest() throws Exception {
        ...
        getNewHttpCallBean2.setOperationName("mandatoryParamsOperation");
        
        getNewHttpCallBean2.setServiceName("baseline", "cougarBaseline");
        
        getNewHttpCallBean2.setVersion("v2");
        // Set the parameters, setting the body parameter to be missing a mandatory String field (bodyParameter1)
        Map map3 = new HashMap();
        map3.put("HeaderParam","HeaderParamString");
        getNewHttpCallBean2.setHeaderParams(map3);
        
        Map map4 = new HashMap();
        map4.put("queryParam","QueryParamString");
        getNewHttpCallBean2.setQueryParams(map4);
        
        getNewHttpCallBean2.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><bodyParameter2>BodyParam2String</bodyParameter2></message>".getBytes())));
        ...
        Document createAsDocument13 = xMLHelpers6.getXMLObjectFromString("<fault><faultcode>Client</faultcode><faultstring>DSC-0018</faultstring><detail/></fault>");
        ...
        cougarManager13.verifyAccessLogEntriesAfterDate(getTimeAsTimeStamp11, new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/mandatoryParamsOperation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/mandatoryParamsOperation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/mandatoryParamsOperation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/mandatoryParamsOperation", "BadRequest") );
    }
