...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeSet_NegativeOffset.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeSet data type in the post body with a date with a negative offset
 */
public class RestPostRequestTypesDateTimeSetNegativeOffsetTest {
    @Test
    public void doTest() throws Exception {
        ...
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeSet><Date>2009-06-01T11:50:00.435-02:00</Date><Date>2009-06-01T12:50:00.435-02:00</Date></dateTimeSet></message>".getBytes())));
