...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTime_NoOffsetSpecified_2.xls;
...
/**
 * Ensure that Cougar can handle the dateTime data type in the post body with no offset
 */
public class RestPostRequestTypesDateTimeNoOffsetSpecified2Test {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the post body to contain a date time object (with no offset)
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<bodyParamDateTimeObject><dateTimeParameter>2009-02-01T11:50:00.435</dateTimeParameter></bodyParamDateTimeObject>".getBytes())));
