...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_UnresolvedLog_IpAddress_blank.xls;
...
/**
 * Ensure that when Cougar cannot resolve a request, the entry written to the unresolved log caters for when the passed X-Forwarded-For header value is blank
 */
public class RestUnresolvedLogIpAddressblankTest {
    @Test
