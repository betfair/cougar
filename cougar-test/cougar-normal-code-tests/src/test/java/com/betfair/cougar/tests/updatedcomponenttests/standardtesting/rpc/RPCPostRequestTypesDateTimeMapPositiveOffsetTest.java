...
/**
 * Ensure that Cougar can handle the dateTimeMap data type with positive offsets in the post body of an RPC request
 */
public class RPCPostRequestTypesDateTimeMapPositiveOffsetTest {
    ...
    public void doTest() throws Exception {
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "dateTimeMapOperation"),new RequestLogRequirement("2.8", "dateTimeMapOperation"),new RequestLogRequirement("2.8", "dateTimeMapOperation"),new RequestLogRequirement("2.8", "dateTimeMapOperation") );
