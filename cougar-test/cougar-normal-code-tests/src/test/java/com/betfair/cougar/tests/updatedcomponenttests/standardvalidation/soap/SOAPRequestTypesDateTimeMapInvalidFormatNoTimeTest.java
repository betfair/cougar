...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/SOAP_RequestTypes_DateTimeMap_InvalidFormat_NoTime.xls;
 ...
 */
public class SOAPRequestTypesDateTimeMapInvalidFormatNoTimeTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<DateTimeMapOperationRequest><message><dateTimeMap><entry key=\"date1\"><Date>A009-06-01T</Date></entry><entry key=\"date2\"><Date>A009-06-01T</Date></entry></dateTimeMap></message></DateTimeMapOperationRequest>");
