...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/double/RPC/RPC_doubleResponse.xls;
package com.betfair.cougar.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.doublez.rpc;
...
/**
 * Test that the Cougar service allows to use double primitive type in the response (Batched JSON)
 */
public class RPCdoubleResponseTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray2[0].put("method","doubleSimpleTypeEcho");
        mapArray2[0].put("params","[0.6]");
        mapArray2[0].put("id","1");
        mapArray2[1] = new HashMap();
        mapArray2[1].put("method","doubleSimpleTypeEcho");
        mapArray2[1].put("params","[0.6]");
        ...
        AssertionUtils.multiAssertEquals("{\"id\":1,\"result\":0.6,\"jsonrpc\":\"2.0\"}", map5.get("response1"));
        AssertionUtils.multiAssertEquals("{\"id\":2,\"result\":0.6,\"jsonrpc\":\"2.0\"}", map5.get("response2"));
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "doubleSimpleTypeEcho"),new RequestLogRequirement("2.8", "doubleSimpleTypeEcho") );
