...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_SimpleType_ENUM_blank.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a request contains a blank simple type ENUM parameter
 */
public class RestIDLHeaderParamSimpleTypeENUMblankTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the Simple Type ENUM Header param as blank
