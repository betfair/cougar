...
/**
 * Ensure that when a simple Batched JSON Get request is performed against Cougar, with X_IP in the header set to blank, the operation completes successfully and the headers are set to default values
 */
