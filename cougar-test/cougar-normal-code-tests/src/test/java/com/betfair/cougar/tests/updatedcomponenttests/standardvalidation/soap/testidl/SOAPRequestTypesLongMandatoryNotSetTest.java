...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/Test-IDL/SOAP_RequestTypes_Long_MandatoryNotSet.xls;
...
/**
 * Ensure that when a SOAP request is received with a missing mandatory Long parameter, Cougar returns the correct fault
 */
public class SOAPRequestTypesLongMandatoryNotSetTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<I64OperationRequest><headerParam>543553</headerParam><message><bodyParameter>543553</bodyParameter></message></I64OperationRequest>");
