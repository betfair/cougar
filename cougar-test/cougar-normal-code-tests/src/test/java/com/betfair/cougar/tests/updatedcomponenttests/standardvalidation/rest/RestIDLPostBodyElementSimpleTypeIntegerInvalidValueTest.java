...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_SimpleType_Integer_InvalidValue.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request contains a SimpleType Integer body parameter with an invalid value
 */
public class RestIDLPostBodyElementSimpleTypeIntegerInvalidValueTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, setting the SimpleType Integer body parameter to be an invalid value
        ...
        getNewHttpCallBean2.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><bodyParameter>text</bodyParameter></message>".getBytes())));
