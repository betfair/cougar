...
public class RestGetRequestTypesStringQueryParamEscapedCharactersHashTest {
    ...
    public void doTest() throws Exception {
        ...
        Document createAsDocument10 = xMLHelpers6.createAsDocument(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream(("<SimpleResponse><message>headerParam=Foo,queryParam=hash#,dateQueryParam="+convertedDate1+"</message></SimpleResponse>").getBytes())));
