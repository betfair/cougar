...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Get_RequestTypes_String_QueryParam_EscapedCharacters_Hash.xls;
...
/**
 * Ensure that Cougar can correctly handle a string Query Param containing encoded #
 */
public class RestGetRequestTypesStringQueryParamEscapedCharactersHashTest {
    @Test
    public void doTest() throws Exception {
        ...
        Document createAsDocument10 = xMLHelpers6.createAsDocument(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream(("<SimpleResponse><message>headerParam=Foo,queryParam=hash#,dateQueryParam="+cougarHelpers4.dateInUTC(convertedDate1)+"</message></SimpleResponse>").getBytes())));
