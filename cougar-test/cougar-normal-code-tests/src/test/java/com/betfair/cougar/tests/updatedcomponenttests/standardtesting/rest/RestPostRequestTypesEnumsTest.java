...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_Enums.xls;
...
/**
 * Ensure that Cougar can handle ENUMS in the post body, header params and query params
 */
public class RestPostRequestTypesEnumsTest {
    @Test
    public void doTest() throws Exception {
        ...
        getNewHttpCallBean1.setOperationName("enumOperation");
        
        getNewHttpCallBean1.setServiceName("baseline", "cougarBaseline");
        
        getNewHttpCallBean1.setVersion("v2");
        // Set each of the parameter types to contain a valid enum
        Map map2 = new HashMap();
        map2.put("HeaderParam","FooHeader");
        getNewHttpCallBean1.setHeaderParams(map2);
        
        Map map3 = new HashMap();
        map3.put("queryParam","FooQuery");
        getNewHttpCallBean1.setQueryParams(map3);
        
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><bodyParameter>FooBody</bodyParameter></message>".getBytes())));
        ...
        Document createAsDocument11 = xMLHelpers5.getXMLObjectFromString("<EnumOperationResponseObject><bodyParameter>FooBody</bodyParameter><headerParameter>FooHeader</headerParameter><queryParameter>FooQuery</queryParameter></EnumOperationResponseObject>");
        ...
        cougarManager1.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp9, new RequestLogRequirement("2.8", "enumOperation"),new RequestLogRequirement("2.8", "enumOperation"),new RequestLogRequirement("2.8", "enumOperation"),new RequestLogRequirement("2.8", "enumOperation") );
    }
