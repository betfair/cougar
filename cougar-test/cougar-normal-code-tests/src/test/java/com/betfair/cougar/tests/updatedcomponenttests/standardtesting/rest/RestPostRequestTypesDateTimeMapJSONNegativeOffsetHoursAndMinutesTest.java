...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeMap_JSON_NegativeOffset_HoursAndMinutes.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeMap data type in the post body of a JSON request containing a date with a negative offset of hours and minutes (0230 = offset by 2 hours 30 minutes)
 */
public class RestPostRequestTypesDateTimeMapJSONNegativeOffsetHoursAndMinutesTest {
    @Test
    public void doTest() throws Exception {
        ...
        map4.put("RESTJSON","{\"message\":{\"dateTimeMap\":{   \n\"date1\":\"2009-06-01T11:50:00.435-02:30\",                   \"date2\":\"2009-06-01T12:50:00.435-02:30\"} \n}}");
