...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_ENUM_blank.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a request passes a blank value in an ENUM parameter
 */
public class RestIDLHeaderParamENUMblankTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the Enum Header param as blank
