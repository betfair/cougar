...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeList_MiliisecondsNotSpecified.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeList data type in the post body containing dates with no milliseconds specified
 */
public class RestPostRequestTypesDateTimeListMiliisecondsNotSpecifiedTest {
    @Test
    public void doTest() throws Exception {
        ...
        String date2 = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2009, (int) 6, (int) 2, (int) 13, (int) 50, (int) 0, (int) 0);
        // Set the post body to contain a date time list object containing dates with no milliseconds specified
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeList><Date>2009-06-01T13:50:00Z</Date><Date>2009-06-02T13:50:00Z</Date></dateTimeList></message>".getBytes())));
