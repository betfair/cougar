...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/byte/RPC/RPC_byteInvalidResponse.xls;
...
/**
 * Test that the Cougar service throws a correct error when invalid value is passed to  byte primitive type parameter (Batched JSON)
 */
public class RPCbyteInvalidResponseTest {
    @Test
