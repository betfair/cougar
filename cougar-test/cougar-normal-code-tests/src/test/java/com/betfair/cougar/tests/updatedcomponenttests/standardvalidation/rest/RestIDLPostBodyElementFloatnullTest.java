...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_Float_null.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request contains a null Float body parameter
 */
public class RestIDLPostBodyElementFloatnullTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the Float body parameter as null
