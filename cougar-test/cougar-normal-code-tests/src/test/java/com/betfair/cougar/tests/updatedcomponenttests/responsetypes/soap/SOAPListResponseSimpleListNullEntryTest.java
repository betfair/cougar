...
/**
 * Ensure that when a SOAP request operation is performed against Cougar, passing in a List with one null entry , it is correctly  processed and the correct List response returned.
 */
