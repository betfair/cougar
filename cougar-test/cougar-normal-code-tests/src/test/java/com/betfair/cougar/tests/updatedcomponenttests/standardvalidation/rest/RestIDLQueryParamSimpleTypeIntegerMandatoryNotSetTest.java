...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_QueryParam_SimpleType_Integer_Mandatory_NotSet.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request is missing a mandatory SimpleTypeInteger Query parameter 
 */
public class RestIDLQueryParamSimpleTypeIntegerMandatoryNotSetTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, don't set the mandatory SimpleTypeInteger Query parameter
