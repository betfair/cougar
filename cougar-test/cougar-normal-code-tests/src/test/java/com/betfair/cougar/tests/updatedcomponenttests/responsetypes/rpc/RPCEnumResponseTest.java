...
// Originally from UpdatedComponentTests/ResponseTypes/RPC/RPC_EnumResponse.xls;
...
/**
 * Test that the Cougar service allows to use enumerations in the response (Batched JSON)
 */
public class RPCEnumResponseTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray2[0].put("method","callWithEnumResponse");
        mapArray2[0].put("params","[]");
        mapArray2[0].put("id","1");
        mapArray2[1] = new HashMap();
        mapArray2[1].put("method","callWithEnumResponse");
        ...
        AssertionUtils.multiAssertEquals("{\"id\":1,\"result\":\"WEASEL\",\"jsonrpc\":\"2.0\"}", map5.get("response1"));
        AssertionUtils.multiAssertEquals("{\"id\":2,\"result\":\"WEASEL\",\"jsonrpc\":\"2.0\"}", map5.get("response2"));
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "callWithEnumResponse"),new RequestLogRequirement("2.8", "callWithEnumResponse") );
