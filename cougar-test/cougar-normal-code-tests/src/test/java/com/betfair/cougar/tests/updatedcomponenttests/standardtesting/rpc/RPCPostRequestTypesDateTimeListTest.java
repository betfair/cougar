...
// Originally from UpdatedComponentTests/StandardTesting/RPC/RPC_Post_RequestTypes_DateTimeList.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeList data type in the post body of an RPC request
 */
public class RPCPostRequestTypesDateTimeListTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray2[0].put("params","[{\"dateTimeList\":[\"2009-06-01T13:50:00.0Z\",\"2009-06-01T14:50:00.0Z\"]}]");
        mapArray2[0].put("id","\"DateTimeList\"");
        mapArray2[1] = new HashMap();
        mapArray2[1].put("method","dateTimeListOperation");
        mapArray2[1].put("params","[{\"dateTimeList\":[\"2012-02-29T13:50:00.0Z\",\"2012-02-29T14:50:00.0Z\"]}]");
        mapArray2[1].put("id","\"DateTimeListLeapYear\"");
        ...
        AssertionUtils.multiAssertEquals("{\"id\":\"DateTimeList\",\"result\":{\"responseList\":[\"2009-06-01T13:50:00.000Z\",\"2009-06-01T14:50:00.000Z\"]},\"jsonrpc\":\"2.0\"}", map5.get("responseDateTimeList"));
        AssertionUtils.multiAssertEquals("{\"id\":\"DateTimeListLeapYear\",\"result\":{\"responseList\":[\"2012-02-29T13:50:00.000Z\",\"2012-02-29T14:50:00.000Z\"]},\"jsonrpc\":\"2.0\"}", map5.get("responseDateTimeListLeapYear"));
