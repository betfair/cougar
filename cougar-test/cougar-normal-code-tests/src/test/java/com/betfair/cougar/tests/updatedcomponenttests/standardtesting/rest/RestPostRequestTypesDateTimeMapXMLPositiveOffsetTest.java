...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeMap_XML_PositiveOffset.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeMap data type in the post body of an XML request containing dates with a positive offset
 */
public class RestPostRequestTypesDateTimeMapXMLPositiveOffsetTest {
    @Test
    public void doTest() throws Exception {
        ...
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeMap><entry key=\"date1\"><Date>2009-06-01T15:50:00.435+02:00</Date></entry><entry key=\"date2\"><Date>2009-06-01T16:50:00.435+02:00</Date></entry></dateTimeMap></message>".getBytes())));
