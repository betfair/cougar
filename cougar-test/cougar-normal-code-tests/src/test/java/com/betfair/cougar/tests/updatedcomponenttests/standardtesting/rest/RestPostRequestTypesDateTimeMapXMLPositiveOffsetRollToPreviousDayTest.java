...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeMap_XML_PositiveOffset_RollToPreviousDay.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeMap data type in the post body of an XML request containing dates with positive offsets large enough to roll the date to the previous day
 */
public class RestPostRequestTypesDateTimeMapXMLPositiveOffsetRollToPreviousDayTest {
    @Test
    public void doTest() throws Exception {
        ...
        String date1 = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2008, (int) 12, (int) 31, (int) 10, (int) 1, (int) 0, (int) 435);
        // Create a date time object expected to be in the response object

        String date2 = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2008, (int) 12, (int) 31, (int) 10, (int) 2, (int) 0, (int) 435);
        // Set the post body to contain a date time map object (containing dates with positive offsets that roll the date back to the previous day)
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeMap><entry key=\"date1\"><Date>2009-01-01T00:01:00.435+14:00</Date></entry><entry key=\"date2\"><Date>2009-01-01T00:02:00.435+14:00</Date></entry></dateTimeMap></message>".getBytes())));
