...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_PostBody_String_SpecialCharacters_5.xls;
...
/**
 * Ensure that when a Rest XML/JSON Post is performed, Cougar can handle a String in the PostBody that contains the special characters \r
 */
public class RestPostPostBodyStringSpecialCharacters5Test {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the post body for the request, setting one of the string parameters to contain the special characters being tested \r
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><name>this is a \\r slash+r</name><value1>7</value1><value2>75</value2></message>".getBytes())));
        ...
        Document createAsDocument9 = xMLHelpers3.getXMLObjectFromString("<SimpleResponse><message>this is a \\r slash+r = 82</message></SimpleResponse>");
