...
// Originally from UpdatedComponentTests/StandardTesting/RPC/RPC_Post_PostBody_OutOfOrder.xls;
...
/**
 * Ensure that when a Batched JSON request is made to an operation of Cougar, passing a list with a size different to the size stated in the post body, that the correct response message is returned
 */
public class RPCPostPostBodyOutOfOrderTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray2[0].put("params","[{\"size\":1,\"oddOrEven\":\"ODD\",\"objects\":[{\"name\":\"n1\",\"value1\":23,\"value2\":42},{\"name\":\"n2\",\"value1\":23,\"value2\":42}]}]");
        mapArray2[0].put("id","1");
        mapArray2[1] = new HashMap();
        mapArray2[1].put("method","testLargePostQA");
        mapArray2[1].put("params","[{\"size\":1,\"oddOrEven\":\"ODD\",\"objects\":[{\"name\":\"n1\",\"value1\":23,\"value2\":42},{\"name\":\"n2\",\"value1\":23,\"value2\":42}]}]");
        ...
        AssertionUtils.multiAssertEquals("{\"id\":1,\"result\":{\"message\":\"There were 1 items specified in the list, 2 actually\"},\"jsonrpc\":\"2.0\"}", map5.get("response1"));
        AssertionUtils.multiAssertEquals("{\"id\":2,\"result\":{\"message\":\"There were 1 items specified in the list, 2 actually\"},\"jsonrpc\":\"2.0\"}", map5.get("response2"));
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "testLargePostQA"),new RequestLogRequirement("2.8", "testLargePostQA") );
