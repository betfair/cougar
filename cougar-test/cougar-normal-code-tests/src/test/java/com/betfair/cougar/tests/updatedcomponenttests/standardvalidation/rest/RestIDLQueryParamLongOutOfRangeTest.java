...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_QueryParam_Long_OutOfRange.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request passes an out of range Long Query parameter
 */
public class RestIDLQueryParamLongOutOfRangeTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, setting the Long Query parameter as an out of range value
        Map map3 = new HashMap();
        map3.put("HeaderParam","234");
        getNewHttpCallBean2.setHeaderParams(map3);

        Map map4 = new HashMap();
        map4.put("queryParam","9223372036854775808");
