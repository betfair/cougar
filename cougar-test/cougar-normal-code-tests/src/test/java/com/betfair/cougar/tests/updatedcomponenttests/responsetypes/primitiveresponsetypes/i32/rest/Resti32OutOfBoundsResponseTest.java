...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/i32/REST/Rest_i32OutOfBoundsResponse.xls;
...
/**
 * Test that the Cougar service returns a correct error when value passed  for i32 is out of type bounds (REST)
 */
public class Resti32OutOfBoundsResponseTest {
    @Test
