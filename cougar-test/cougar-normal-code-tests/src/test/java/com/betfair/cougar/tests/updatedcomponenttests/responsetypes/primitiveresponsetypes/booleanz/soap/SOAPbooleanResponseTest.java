...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/boolean/SOAP/SOAP_booleanResponse.xls;
 ...
 */
public class SOAPbooleanResponseTest {
    @Test
    public void doTest() throws Exception {
        // Create a soap request structure as a Document object
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document requestDocument = xMLHelpers1.getXMLObjectFromString("<BoolSimpleTypeEchoRequest><msg>true</msg></BoolSimpleTypeEchoRequest>");
        // Get an HTTPCallBean
        ...
        Document responseDocument = xMLHelpers4.getXMLObjectFromString("<response>true</response>");
        ...
        CougarManager.verifyRequestLogEntriesAfterDate(timestamp, new RequestLogRequirement("2.8", "boolSimpleTypeEcho") );
    }
