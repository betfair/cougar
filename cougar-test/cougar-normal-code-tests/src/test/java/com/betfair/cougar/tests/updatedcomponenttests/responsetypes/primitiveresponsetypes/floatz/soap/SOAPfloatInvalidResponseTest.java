...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/float/SOAP/SOAP_floatInvalidResponse.xls;
...
/**
 * Test that the Cougar service returns a correct error when an invalid value is passed in float primitive type (SOAP)
 */
public class SOAPfloatInvalidResponseTest {
    @Test
    public void doTest() throws Exception {
        // Create a soap request structure as a Document object
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document requestDocument = xMLHelpers1.getXMLObjectFromString("<FloatSimpleTypeEchoRequest><msg>stringvalue</msg></FloatSimpleTypeEchoRequest>");
        // Get an HTTPCallBean
