...
// Originally from UpdatedComponentTests/StandardTesting/RPC/RPC_Post_RequestTypes_DateTimeMap_ZeroOffset.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeMap data type with Zero Offsets in the post body of an RPC request
 */
public class RPCPostRequestTypesDateTimeMapZeroOffsetTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray2[0].put("params","[{\"dateTimeMap\":{\"date1\":\"2009-06-01T11:50:00.435Z\",\"date2\":\"2009-06-02T11:50:00.435Z\"}}]");
        mapArray2[0].put("id","\"DateTimeMapZeroOff\"");
        mapArray2[1] = new HashMap();
        mapArray2[1].put("method","dateTimeMapOperation");
        mapArray2[1].put("params","[{\"dateTimeMap\":{\"date1\":\"2009-02-01T11:50:00.435Z\",\"date2\":\"2009-02-02T11:50:00.435Z\"}}]");
        mapArray2[1].put("id","\"DateTimeMapZeroOff2\"");
        ...
        AssertionUtils.multiAssertEquals("{\"id\":\"DateTimeMapZeroOff\",\"result\":{\"responseMap\":{\"date2\":\"2009-06-02T11:50:00.435Z\",\"date1\":\"2009-06-01T11:50:00.435Z\"}},\"jsonrpc\":\"2.0\"}", map5.get("responseDateTimeMapZeroOff"));
        AssertionUtils.multiAssertEquals("{\"id\":\"DateTimeMapZeroOff2\",\"result\":{\"responseMap\":{\"date2\":\"2009-02-02T11:50:00.435Z\",\"date1\":\"2009-02-01T11:50:00.435Z\"}},\"jsonrpc\":\"2.0\"}", map5.get("responseDateTimeMapZeroOff2"));
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "dateTimeMapOperation"),new RequestLogRequirement("2.8", "dateTimeMapOperation") );
