...
/**
 * Ensure that when concurrent SOAP requests are performed against Cougar with a rapid load of a large number of threads, each request is successfully sent and the response to each is correctly  handled
 */
