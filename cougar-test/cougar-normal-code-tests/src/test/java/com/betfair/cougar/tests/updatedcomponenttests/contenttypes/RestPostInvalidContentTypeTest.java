...
// Originally from UpdatedComponentTests/ContentTypes/Rest_Post_InvalidContentType.xls;
...
/**
 * Ensure that when a Rest Post is performed against Cougar, supplying an unsupported content type, the correct error is returned
 */
public class RestPostInvalidContentTypeTest {
    @Test
    public void doTest() throws Exception {
        ...
        map4.put("REST","{  \n    \"name\":\"sum\",\n    \"value1\":\"7\",\n    \"value2\":\"75\"\n}");
        httpCallBeanBaseline.setPostQueryObjects(map4);
