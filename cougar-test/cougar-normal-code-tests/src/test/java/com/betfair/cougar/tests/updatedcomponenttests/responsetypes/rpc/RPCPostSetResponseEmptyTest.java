...
// Originally from UpdatedComponentTests/ResponseTypes/RPC/RPC_Post_SetResponse_Empty.xls;
...
/**
 * Ensure that when a Batched JSON request is performed against Cougar, passing an empty Set in the post body, it is correctly de-serialized, processed, returned the correct response.
 */
public class RPCPostSetResponseEmptyTest {
    @Test
