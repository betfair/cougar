...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_QueryParam_SimpleType_ENUM_null.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request passes a null SimpleTypeENUM Query parameter
 */
public class RestIDLQueryParamSimpleTypeENUMnullTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, setting the SimpleTypeENUM Query parameter to be null
