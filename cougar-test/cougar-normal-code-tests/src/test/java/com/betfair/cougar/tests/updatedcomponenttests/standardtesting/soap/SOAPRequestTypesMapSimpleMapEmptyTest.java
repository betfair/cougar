...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/SOAP_RequestTypes_Map_SimpleMap_Empty.xls;
...
/**
 * Ensure that when a SOAP request is received, Cougar can handle an empty SimpleMap datatype parameter
 */
public class SOAPRequestTypesMapSimpleMapEmptyTest {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document (with an empty simple map parameter)
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<SimpleMapOperationRequest><message><simpleMap/></message></SimpleMapOperationRequest>");
        ...
        Document createAsDocument9 = xMLHelpers4.getXMLObjectFromString("<response><responseMap/></response>");
