...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeList_NegativeOffset_RollToNextDay.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeList data type in the post body with a date with a negative offset large enough to roll the date to the next day
 */
public class RestPostRequestTypesDateTimeListNegativeOffsetRollToNextDayTest {
    @Test
    public void doTest() throws Exception {
        ...
        String date1 = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2010, (int) 1, (int) 1, (int) 13, (int) 50, (int) 0, (int) 435);
        // Create a date time object expected to be in the response object

        String date2 = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2010, (int) 1, (int) 1, (int) 13, (int) 50, (int) 0, (int) 436);
        // Set the post body to contain a date time list object containing dates with a large enough offset to roll the date to the next day
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeList><Date>2009-12-31T23:50:00.435-14:00</Date><Date>2009-12-31T23:50:00.436-14:00</Date></dateTimeList></message>".getBytes())));
        ...
        Document expectedXML = xMLHelpers5.createAsDocument(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream(("<DateTimeListOperationResponseObject><responseList><Date>"+date1+"</Date><Date>"+date2+"</Date></responseList></DateTimeListOperationResponseObject>").getBytes())));
