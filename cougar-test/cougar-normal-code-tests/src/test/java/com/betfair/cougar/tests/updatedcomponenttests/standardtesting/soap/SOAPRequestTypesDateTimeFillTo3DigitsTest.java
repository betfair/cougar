...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/SOAP_RequestTypes_DateTime_FillTo3Digits.xls;
...
/**
 * Ensure that when a SOAP request is received, Cougar can handle the dateTime datatype with less than 3 digits milliseconds accuracy
 */
public class SOAPRequestTypesDateTimeFillTo3DigitsTest {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document (with a dateTime parameter with less than 3 digits millisecond accuracy)
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<DateTimeOperationRequest><bodyParamDateTimeObject><dateTimeParameter>2009-06-01T13:50:00Z</dateTimeParameter></bodyParamDateTimeObject></DateTimeOperationRequest>");
