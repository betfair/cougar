...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_QueryParam_Byte_IncorrectDataType.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request passes a non Byte object in a Byte Query parameter
 */
public class RestIDLQueryParamByteIncorrectDataTypeTest {
    @Test
    public void doTest() throws Exception {
        ...
        hbean.setVersion("v2");
        // Set the parameters, setting the Byte Query parameter as a non byte
