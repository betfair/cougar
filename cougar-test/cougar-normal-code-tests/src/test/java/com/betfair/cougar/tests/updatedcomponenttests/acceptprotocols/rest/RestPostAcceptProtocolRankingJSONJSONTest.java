...
// Originally from UpdatedComponentTests/AcceptProtocols/Rest/Rest_Post_AcceptProtocolRankingJSONJSON.xls;
...
/**
 * Ensure that when a Rest JSON Post operation is performed on Cougar, with JSON the highest ranked response protocol, the response is JSON
 */
public class RestPostAcceptProtocolRankingJSONJSONTest {
    @Test
