...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_Post_RequestTypes_DateTimeList_60Seconds.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request has a body parameter that contains a date list with dates with the seconds set to 60 (should be rolled to the next minute)
 */
public class RestPostRequestTypesDateTimeList60SecondsTest {
    @Test
    public void doTest() throws Exception {
        ...
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeList><Date>2009-12-01T00:00:60.000Z</Date><Date>2009-12-02T00:00:60.000Z</Date></dateTimeList></message>".getBytes())));
        ...
        cougarManager9.verifyAccessLogEntriesAfterDate(getTimeAsTimeStamp11, new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/dateTimeListOperation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/dateTimeListOperation", "BadRequest") );
    }
