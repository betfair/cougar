...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_Long_null.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a request passes null in a Long parameter
 */
public class RestIDLHeaderParamLongnullTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the Long Header param as null
