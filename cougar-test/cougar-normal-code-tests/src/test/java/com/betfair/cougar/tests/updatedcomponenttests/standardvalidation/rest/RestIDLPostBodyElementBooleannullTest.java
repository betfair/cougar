...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_Boolean_null.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST XML request contains a Boolean body parameter set to null
 */
public class RestIDLPostBodyElementBooleannullTest {
    @Test
