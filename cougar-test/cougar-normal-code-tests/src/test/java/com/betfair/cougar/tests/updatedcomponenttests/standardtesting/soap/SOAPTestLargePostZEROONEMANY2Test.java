...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/SOAP_TestLargePost_ZEROONEMANY_2.xls;
...
/**
 * Test that when Cougar is passed a Large Request it can correctly deserialise it and count how many items are in the list (incorrect even number  of items given)
 */
public class SOAPTestLargePostZEROONEMANY2Test {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<TestLargePostRequest><largeRequest><size>1</size><objects><ComplexObject><name>ssasdf</name><value1>23</value1><value2>42</value2></ComplexObject><ComplexObject><name>ssasdf</name><value1>23</value1><value2>42</value2></ComplexObject></objects><oddOrEven>ODD</oddOrEven></largeRequest></TestLargePostRequest>");
        ...
        Document createAsDocument10 = xMLHelpers4.getXMLObjectFromString("<response><message>There were 1 items specified in the list, 2 actually</message></response>");
