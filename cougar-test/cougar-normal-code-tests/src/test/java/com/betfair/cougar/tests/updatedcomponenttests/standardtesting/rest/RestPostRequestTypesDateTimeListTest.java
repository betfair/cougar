...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeList.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeList data type in the post body
 */
public class RestPostRequestTypesDateTimeListTest {
    @Test
    public void doTest() throws Exception {
        ...
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeList><Date>2009-06-01T13:50:00.0Z</Date><Date>2009-06-01T14:50:00.0Z</Date></dateTimeList></message>".getBytes())));
