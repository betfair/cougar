...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/double/RPC/RPC_doubleInvalidResponse.xls;
...
/**
 * Test that the Cougar service throws a correct error when invalid value is passed to  double primitive type parameter (Batched JSON)
 */
public class RPCdoubleInvalidResponseTest {
    @Test
