...
/**
 * Ensure that when a Cougar container is running multiple services, the heathcheck detailed operation returns correct Status Details for each component that has a status set. (OK, WARN)
 */
