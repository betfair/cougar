...
/**
 * Ensure that Cougar can handle the dateTime data type in the post body with a negative offset with hours and minutes 0230 = offset by 2 hours 30 minutes)
 */
public class RestPostRequestTypesDateTimeNegativeOffsetHoursAndMinutesTest {
    ...
    public void doTest() throws Exception {
        ...
        String date = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2009, (int) 6, (int) 1, (int) 14, (int) 20, (int) 0, (int) 435);
