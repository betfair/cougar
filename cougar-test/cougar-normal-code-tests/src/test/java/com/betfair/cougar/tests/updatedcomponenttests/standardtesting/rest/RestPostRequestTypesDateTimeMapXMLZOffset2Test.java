...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeMap_XML_ZOffset2.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeMap data type in the post body of an XML request containing dates specifying the UTC timezone
 */
public class RestPostRequestTypesDateTimeMapXMLZOffset2Test {
    @Test
    public void doTest() throws Exception {
        ...
        String date2 = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2009, (int) 2, (int) 2, (int) 11, (int) 50, (int) 0, (int) 435);
        // Set the post body to contain a date time map object containing dates that specify the UTC timezone
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeMap><entry key=\"date1\"><Date>2009-02-01T11:50:00.435Z</Date></entry><entry key=\"date2\"><Date>2009-02-02T11:50:00.435Z</Date></entry></dateTimeMap></message>".getBytes())));
