...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_Integer_IncorrectDataType.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a non Integer object is passed in an Integer parameter
 */
public class RestIDLHeaderParamIntegerIncorrectDataTypeTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the Integer Header param as an object of a different type
