...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Get_RequestTypes_Parameters_ListOfStrings_BlankEntry.xls;
...
/**
 * Ensure that when the 4 supported Rest XML/JSON Gets are performed, Cougar can handle a List of Strings with an empty entry being passed in the Header and Query parameters
 */
public class RestGetRequestTypesParametersListOfStringsBlankEntryTest {
    @Test
    public void doTest() throws Exception {
        ...
        map2.put("HeaderParam","header1,headerTwo,,header4");
        httpCallBeanBaseline.setHeaderParams(map2);
        
        Map map3 = new HashMap();
        map3.put("queryParam","query1,queryTwo,,query4");
        ...
        Document xmlDocument = xMLHelpers5.getXMLObjectFromString("<NonMandatoryParamsOperationResponseObject><headerParameter>header1,headerTwo,,header4</headerParameter><queryParameter>query1,queryTwo,,query4</queryParameter></NonMandatoryParamsOperationResponseObject>");
