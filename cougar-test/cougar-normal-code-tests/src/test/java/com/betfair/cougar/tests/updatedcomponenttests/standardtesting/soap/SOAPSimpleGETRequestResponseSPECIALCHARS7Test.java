...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/SOAP_SimpleGET_RequestResponse_SPECIALCHARS_7.xls;
 ...
 */
public class SOAPSimpleGETRequestResponseSPECIALCHARS7Test {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document (with message containing the special character being tested)
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<TestSimpleGetRequest><message>&amp;</message></TestSimpleGetRequest>");
        ...
        Document createAsDocument10 = xMLHelpers4.getXMLObjectFromString("<response><message>&amp;</message></response>");
