...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/boolean/RPC/RPC_booleanResponse.xls;
package com.betfair.cougar.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.booleanz.rpc;
...
/**
 * Test that the Cougar service allows to use boolean primitive type in the response (Batched JSON)
 */
public class RPCbooleanResponseTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray2[0].put("method","boolSimpleTypeEcho");
        mapArray2[0].put("params","[true]");
        mapArray2[0].put("id","1");
        mapArray2[1] = new HashMap();
        mapArray2[1].put("method","boolSimpleTypeEcho");
        mapArray2[1].put("params","[true]");
        ...
        AssertionUtils.multiAssertEquals("{\"id\":1,\"result\":true,\"jsonrpc\":\"2.0\"}", map5.get("response1"));
        AssertionUtils.multiAssertEquals("{\"id\":2,\"result\":true,\"jsonrpc\":\"2.0\"}", map5.get("response2"));
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "boolSimpleTypeEcho"),new RequestLogRequirement("2.8", "boolSimpleTypeEcho") );
