...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/SOAP_RequestTypes_DateTime_Historic.xls;
...
/**
 * Ensure that when a SOAP request is received, Cougar can handle the dateTime datatype with a date far in the past
 */
public class SOAPRequestTypesDateTimeHistoricTest {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document (with a dateTime parameter far in the past)
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<DateTimeOperationRequest><bodyParamDateTimeObject><dateTimeParameter>1899-06-01T13:50:00.0Z</dateTimeParameter></bodyParamDateTimeObject></DateTimeOperationRequest>");
        ...
        String convertUTCDateTimeToCougarFormat6 = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 1899, (int) 6, (int) 1, (int) 13, (int) 50, (int) 0, (int) 0);
