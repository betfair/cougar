...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/Test-IDL/SOAP_RequestTypes_Integers_OutOfRange_Upper.xls;
...
/**
 * Ensure that when a SOAP request is received with an out of range (upper) Integer parameter, Cougar returns the correct fault
 */
public class SOAPRequestTypesIntegersOutOfRangeUpperTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            // Create the SOAP request as an XML Document (with an out of range (uppser) parameter)
            XMLHelpers xMLHelpers2 = new XMLHelpers();
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<I32OperationRequest><headerParam>1</headerParam><queryParam>43523434</queryParam><message><bodyParameter>214748364700</bodyParameter></message></I32OperationRequest>");
