...
// Originally from UpdatedComponentTests/AcceptProtocols/Rest/Rest_Get_AcceptProtocolRankingXMLJSON.xls;
...
/**
 * Ensure that when a Rest XML Get is performed on Cougar, with JSON the highest ranked response protocol, the response is JSON
 */
public class RestGetAcceptProtocolRankingXMLJSONTest {
    @Test
