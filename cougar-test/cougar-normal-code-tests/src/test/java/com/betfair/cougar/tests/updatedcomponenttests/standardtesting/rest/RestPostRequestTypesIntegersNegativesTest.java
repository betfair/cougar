...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_Integers_Negatives.xls;
...
/**
 * Ensure that Cougar can handle Negative Integers in the post body, header params and query params
 */
public class RestPostRequestTypesIntegersNegativesTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set each of the parameter types to contain a negative integer datatype object
        ...
        Document createAsDocument11 = xMLHelpers5.getXMLObjectFromString("<I32OperationResponseObject><bodyParameter>-50</bodyParameter><headerParameter>-1</headerParameter><queryParameter>-43523434</queryParameter></I32OperationResponseObject>");
