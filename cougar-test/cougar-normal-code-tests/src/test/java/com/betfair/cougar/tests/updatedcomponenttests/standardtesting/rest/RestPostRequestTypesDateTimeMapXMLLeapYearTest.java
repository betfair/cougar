...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeMap_XML_LeapYear.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeMap data type in the post body of an XML request containing a date set to 29th Feb on a leap year
 */
public class RestPostRequestTypesDateTimeMapXMLLeapYearTest {
    @Test
    public void doTest() throws Exception {
        ...
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeMap><entry key=\"date1\"><Date>2012-02-29T13:50:00.0Z</Date></entry><entry key=\"date2\"><Date>2012-02-29T14:50:00.0Z</Date></entry></dateTimeMap></message>".getBytes())));
