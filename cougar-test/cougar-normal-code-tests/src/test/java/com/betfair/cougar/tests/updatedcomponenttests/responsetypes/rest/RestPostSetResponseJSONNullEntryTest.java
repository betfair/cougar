...
// Originally from UpdatedComponentTests/ResponseTypes/REST/Rest_Post_SetResponse_JSON_NullEntry.xls;
 ...
 */
public class RestPostSetResponseJSONNullEntryTest {
    @Test
    public void doTest() throws Exception {
        ...
        Document createAsDocument10 = xMLHelpers4.getXMLObjectFromString("<TestSimpleSetGetResponse><String/><String>ccc string</String><String>bbb string</String><String>ddd string</String></TestSimpleSetGetResponse>");
        
        JSONHelpers jSONHelpers5 = new JSONHelpers();
        JSONObject createAsJSONObject11 = jSONHelpers5.createAsJSONObject(new JSONObject("{\"response\": [null,\"ccc string\",\"bbb string\",\"ddd string\"]}"));
