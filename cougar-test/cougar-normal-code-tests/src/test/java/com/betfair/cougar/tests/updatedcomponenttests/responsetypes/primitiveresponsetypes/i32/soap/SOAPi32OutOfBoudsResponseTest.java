...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/i32/SOAP/SOAP_i32OutOfBoudsResponse.xls;
...
/**
 * Test that the Cougar service returns a correct error when an out of type bounds value is passed in i32 primitive type (SOAP)
 */
public class SOAPi32OutOfBoudsResponseTest {
    @Test
    public void doTest() throws Exception {
        // Create a soap request structure as a Document object
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document requestDocument = xMLHelpers1.getXMLObjectFromString("<I32SimpleTypeEchoRequest><msg>-2.147483649E9</msg></I32SimpleTypeEchoRequest>");
        // Get an HTTPCallBean
