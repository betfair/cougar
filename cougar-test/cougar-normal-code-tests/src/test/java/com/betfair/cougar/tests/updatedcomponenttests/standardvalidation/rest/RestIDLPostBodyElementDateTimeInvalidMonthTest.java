...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_DateTime_InvalidMonth.xls;
 ...
 */
public class RestIDLPostBodyElementDateTimeInvalidMonthTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the DateTime body parameter, including a time with an invalid month (2009-13-01)
        getNewHttpCallBean2.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<BodyParamDateTimeObject><dateTimeParameter>2009-13-01T13:50:00.435Z</dateTimeParameter></BodyParamDateTimeObject>".getBytes())));
