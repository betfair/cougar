...
// Originally from UpdatedComponentTests/ResponseTypes/REST/Rest_Post_SetResponse_JSON_Empty.xls;
 ...
 */
public class RestPostSetResponseJSONEmptyTest {
    @Test
    public void doTest() throws Exception {
        ...
        Document createAsDocument10 = xMLHelpers4.getXMLObjectFromString("<TestSimpleSetGetResponse></TestSimpleSetGetResponse>");
        
        JSONHelpers jSONHelpers5 = new JSONHelpers();
        JSONObject createAsJSONObject11 = jSONHelpers5.createAsJSONObject(new JSONObject("{\"response\": []}"));
