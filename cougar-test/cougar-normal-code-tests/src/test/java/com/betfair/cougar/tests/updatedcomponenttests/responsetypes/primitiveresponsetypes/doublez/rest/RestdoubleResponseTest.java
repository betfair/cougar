...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/double/REST/Rest_doubleResponse.xls;
package com.betfair.cougar.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.doublez.rest;
...
/**
 * Test that the Cougar service allows to use double primitive type in the response (REST)
 */
public class RestdoubleResponseTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set operation  name 
        HTTPCallBean.setOperationName("doubleSimpleTypeEcho", "doubleEcho");
        ...
        Document responseDocument = xMLHelpers4.getXMLObjectFromString("<Double>0.6</Double>");
        ...
        CougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "doubleSimpleTypeEcho"),new RequestLogRequirement("2.8", "doubleSimpleTypeEcho"),new RequestLogRequirement("2.8", "doubleSimpleTypeEcho"),new RequestLogRequirement("2.8", "doubleSimpleTypeEcho") );
    }
