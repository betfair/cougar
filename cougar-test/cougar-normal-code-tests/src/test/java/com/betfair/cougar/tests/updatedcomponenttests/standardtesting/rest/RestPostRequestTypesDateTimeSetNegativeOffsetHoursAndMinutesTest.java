...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeSet_NegativeOffset_HoursAndMinutes.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeSet data type in the post body with a date with a negative offset with hours and minutes (0230 = offset by 2 hours 30 minutes)
 */
public class RestPostRequestTypesDateTimeSetNegativeOffsetHoursAndMinutesTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the post body to contain a date time set object containing dates with a negative offset
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeSet><Date>2009-06-01T10:50:00.435-02:30</Date><Date>2009-06-01T11:50:00.435-02:30</Date></dateTimeSet></message>".getBytes())));
