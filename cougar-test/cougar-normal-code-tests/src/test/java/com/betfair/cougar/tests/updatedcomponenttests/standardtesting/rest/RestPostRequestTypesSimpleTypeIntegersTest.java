...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_SimpleType_Integers.xls;
...
/**
 * Ensure that Cougar can handle Simple Type Integers in the post body, header params and query params
 */
public class RestPostRequestTypesSimpleTypeIntegersTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set each of the parameter types to contain a SimpleType Integer datatype object
