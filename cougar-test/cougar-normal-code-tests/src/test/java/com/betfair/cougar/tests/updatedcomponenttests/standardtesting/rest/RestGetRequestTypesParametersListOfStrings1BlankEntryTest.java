...
public class RestGetRequestTypesParametersListOfStrings1BlankEntryTest {
    ...
    public void doTest() throws Exception {
        ...
        Document expectedResponseXML = xMLHelpers5.getXMLObjectFromString("<StringListOperationResponse><NonMandatoryParamsOperationResponseObject><headerParameter/><queryParameter/></NonMandatoryParamsOperationResponseObject></StringListOperationResponse>");
