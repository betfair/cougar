...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeMap_XML_Milliseconds_FillTo3Digits.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeMap data type in the post body of an XML request containg a date with milliseconds accuracy with < 3 digits
 */
public class RestPostRequestTypesDateTimeMapXMLMillisecondsFillTo3DigitsTest {
    @Test
    public void doTest() throws Exception {
        ...
        String date1 = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2009, (int) 6, (int) 1, (int) 13, (int) 50, (int) 0, (int) 430);
        // Create a date time object expected to be in the response object

        String date2 = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2009, (int) 6, (int) 1, (int) 14, (int) 50, (int) 0, (int) 430);
        // Set the post body to contain a date time map object
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeMap><entry key=\"date1\"><Date>2009-06-01T13:50:00.43Z</Date></entry><entry key=\"date2\"><Date>2009-06-01T14:50:00.43Z</Date></entry></dateTimeMap></message>".getBytes())));
