...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/SOAP_TestParameterStyles_MALFORMEDREQ_RequiredElementMissing.xls;
...
/**
 * Ensure that when a SOAP request is received with a required field missing (query) Cougar returns the correct fault
 * "
 */
public class SOAPTestParameterStylesMALFORMEDREQRequiredElementMissingTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<TestParameterStylesRequest><HeaderParam>Foo</HeaderParam></TestParameterStylesRequest>");
