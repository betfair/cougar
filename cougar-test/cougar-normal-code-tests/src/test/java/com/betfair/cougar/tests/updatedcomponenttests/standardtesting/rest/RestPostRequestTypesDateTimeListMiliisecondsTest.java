...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeList_Miliiseconds.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeList data type in the post body containing dates with millisecond accuracy
 */
public class RestPostRequestTypesDateTimeListMiliisecondsTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the post body to contain a date time list object containing dates with millisecond accuracy
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeList><Date>2009-06-01T13:50:00.435Z</Date><Date>2009-06-02T13:50:00.435Z</Date></dateTimeList></message>".getBytes())));
