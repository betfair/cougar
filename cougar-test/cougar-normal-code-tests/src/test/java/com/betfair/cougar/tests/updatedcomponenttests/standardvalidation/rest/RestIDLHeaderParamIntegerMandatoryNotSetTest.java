...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_Integer_Mandatory_NotSet.xls;
 ...
 */
public class RestIDLHeaderParamIntegerMandatoryNotSetTest {
    @Test
