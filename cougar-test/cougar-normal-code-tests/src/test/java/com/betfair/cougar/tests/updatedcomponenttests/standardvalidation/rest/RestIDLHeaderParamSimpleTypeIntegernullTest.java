...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_SimpleType_Integer_null.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a request contains a null simple type Integer parameter
 */
public class RestIDLHeaderParamSimpleTypeIntegernullTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the Simple Type Integer Header param as null
