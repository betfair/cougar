...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_ListOfSimpleTypeEnum_InvalidEntry.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a request passes a list of simple type enum with an invalid entry
 */
public class RestIDLHeaderParamListOfSimpleTypeEnumInvalidEntryTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the List of Simple Type Enum header parameter to an list with an invalid entry
