...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_QueryParam_Integer_null.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request passes null in an Integer Query parameter
 */
public class RestIDLQueryParamIntegernullTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, setting the Integer Query parameter as null
