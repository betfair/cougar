...
// Originally from UpdatedComponentTests/ResponseTypes/RPC/RPC_Post_SetResponse_DuplicateEntry.xls;
...
/**
 * Ensure that when a Batched JSON request is performed against Cougar, passing a Set with a duplicate entry in the post body, it is correctly de-serialized, processed, returned the correct response.
 */
public class RPCPostSetResponseDuplicateEntryTest {
    @Test
