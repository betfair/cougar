...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/SOAP_RequestTypes_DateTime_InvalidFormat_1.xls;
 ...
 */
public class SOAPRequestTypesDateTimeInvalidFormat1Test {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<DateTimeOperationRequest><bodyParamDateTimeObject><dateTimeParameter>2009-06-0113:50:00.0Z</dateTimeParameter></bodyParamDateTimeObject></DateTimeOperationRequest>");
