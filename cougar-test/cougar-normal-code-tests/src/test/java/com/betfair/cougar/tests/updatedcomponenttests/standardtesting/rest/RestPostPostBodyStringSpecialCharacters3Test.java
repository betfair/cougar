...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_PostBody_String_SpecialCharacters_3.xls;
 ...
 */
public class RestPostPostBodyStringSpecialCharacters3Test {
    @Test
    public void doTest() throws Exception {
        ...
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><name>this is a \\\" slash+dblquote</name><value1>7</value1><value2>75</value2></message>".getBytes())));
        ...
        Document createAsDocument9 = xMLHelpers3.getXMLObjectFromString("<SimpleResponse><message>this is a \\\" slash+dblquote = 82</message></SimpleResponse>");
