...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/Test-IDL/SOAP_RequestTypes_Double_Incorrect_DataType.xls;
...
/**
 * Ensure that when a SOAP request is received with a Double parameter set to an incorrect data type, Cougar returns the correct fault
 */
public class SOAPRequestTypesDoubleIncorrectDataTypeTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            // Create the SOAP request as an XML Document (with a query parameter set to an object of an incorrect type)
            XMLHelpers xMLHelpers2 = new XMLHelpers();
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<DoubleOperationRequest><headerParam>45.5</headerParam><queryParam>BLAH</queryParam><message><bodyParameter>43.44</bodyParameter></message></DoubleOperationRequest>");
