...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/SOAP_RequestTypes_DateTimeMap_Futuristic.xls;
...
/**
 * Ensure that when a SOAP request is received, Cougar can handle the dateTimeMap datatype containing a date set far in the future
 */
public class SOAPRequestTypesDateTimeMapFuturisticTest {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document (with a dateTimeMap parameter containing a date set far in the future)
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<DateTimeMapOperationRequest><message><dateTimeMap><entry key=\"date1\"><Date>3009-06-01T13:50:00.0Z</Date></entry><entry key=\"date2\"><Date>3009-06-02T13:50:00.0Z</Date></entry></dateTimeMap></message></DateTimeMapOperationRequest>");
        ...
        String date1 = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 3009, (int) 6, (int) 1, (int) 13, (int) 50, (int) 0, (int) 0);
        // Create the date objects expected to be returned in the response

        String date2 = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 3009, (int) 6, (int) 2, (int) 13, (int) 50, (int) 0, (int) 0);
