...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/Test-IDL/SOAP_RequestTypes_Boolean_Null.xls;
...
/**
 * Ensure that when a SOAP request is received with a null Boolean parameter, Cougar returns the correct fault
 */
public class SOAPRequestTypesBooleanNullTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<BoolOperationRequest><headerParam>true</headerParam><queryParam></queryParam><message><bodyParameter>true</bodyParameter></message></BoolOperationRequest>");
