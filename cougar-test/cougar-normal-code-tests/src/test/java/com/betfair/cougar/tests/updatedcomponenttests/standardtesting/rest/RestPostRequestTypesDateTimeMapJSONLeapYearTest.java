...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeMap_JSON_LeapYear.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeMap data type in the post body of a JSON request containing a date set to 29th Feb on a leap year
 */
public class RestPostRequestTypesDateTimeMapJSONLeapYearTest {
    @Test
    public void doTest() throws Exception {
        ...
        map4.put("RESTJSON","{\"message\":{\"dateTimeMap\":{   \n\"date1\":\"2012-02-29T13:50:00.0Z\",                   \"date2\":\"2012-02-29T14:50:00.0Z\"} \n}}");
