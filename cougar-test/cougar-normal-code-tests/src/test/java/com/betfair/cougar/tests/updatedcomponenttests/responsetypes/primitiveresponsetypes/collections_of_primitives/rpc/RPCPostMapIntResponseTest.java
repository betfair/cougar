...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/collections_of_primitives/RPC/RPC_Post_MapIntResponse.xls;
package com.betfair.cougar.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.collections_of_primitives.rpc;
...
/**
 * Ensure that when a Batched JSON Post request is performed against Cougar, passing a Map in the post body, it is correctly de-serialized, processed, returned the correct response.
 */
public class RPCPostMapIntResponseTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray2[0].put("method","i32MapSimpleTypeEcho");
        mapArray2[0].put("params","[{\"1\":11,\"2\":22}]");
        mapArray2[0].put("id","1");
        mapArray2[1] = new HashMap();
        mapArray2[1].put("method","i32MapSimpleTypeEcho");
        mapArray2[1].put("params","[{\"3\":33,\"4\":44}]");
        ...
        AssertionUtils.multiAssertEquals("{\"id\":1,\"result\":{\"2\":22,\"1\":11},\"jsonrpc\":\"2.0\"}", map5.get("response1"));
        AssertionUtils.multiAssertEquals("{\"id\":2,\"result\":{\"3\":33,\"4\":44},\"jsonrpc\":\"2.0\"}", map5.get("response2"));
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "i32MapSimpleTypeEcho"),new RequestLogRequirement("2.8", "i32MapSimpleTypeEcho") );
