...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/SOAP_RequestTypes_DateTimeMap_NoOffsetSpecified.xls;
...
/**
 * Ensure that when a SOAP request is received, Cougar can handle the dateTimeMap datatype containing a date with no offset
 */
public class SOAPRequestTypesDateTimeMapNoOffsetSpecifiedTest {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document (with a dateTimeMap parameter containing a date with no offset)
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<DateTimeMapOperationRequest><message><dateTimeMap><entry key=\"date1\"><Date>2009-06-01T11:50:00.000Z</Date></entry><entry key=\"date2\"><Date>2009-06-01T12:50:00.000Z</Date></entry></dateTimeMap></message></DateTimeMapOperationRequest>");
        ...
        String date1 = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2009, (int) 6, (int) 1, (int) 11, (int) 50, (int) 0, (int) 0);
        // Create the date object expected to be returned in the response

        String date2 = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2009, (int) 6, (int) 1, (int) 12, (int) 50, (int) 0, (int) 0);
