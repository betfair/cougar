...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_SimpleType_Integer_null.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request contains a null SimpleType Integer body parameter
 */
public class RestIDLPostBodyElementSimpleTypeIntegernullTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, setting the SimpleType Integer body parameter to be null
        ...
        getNewHttpCallBean2.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><bodyParameter></bodyParameter></message>".getBytes())));
