...
/**
 * Ensure that when the 4 supported Rest XML/JSON Gets are performed against a Cougar operation that requires no parameters, the correct responses are received.
 */
public class RestGetNoParametersRequiredTest {
    ...
    public void doTest() throws Exception {
        ...
        cougarManager1.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp6, new RequestLogRequirement("2.8", "testNoParams"),new RequestLogRequirement("2.8", "testNoParams"),new RequestLogRequirement("2.8", "testNoParams"),new RequestLogRequirement("2.8", "testNoParams") );
    }
