...
package com.betfair.cougar.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.floatz.rest;
...
/**
 * Test that the Cougar service allows to use float primitive type in the response (REST)
 */
public class RestfloatResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        CougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "floatSimpleTypeEcho"),new RequestLogRequirement("2.8", "floatSimpleTypeEcho"),new RequestLogRequirement("2.8", "floatSimpleTypeEcho"),new RequestLogRequirement("2.8", "floatSimpleTypeEcho") );
    }
