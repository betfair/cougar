...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/Test-IDL/SOAP_RequestTypes_Bytes_Negatives.xls;
...
/**
 * Ensure that when a SOAP request is received, Cougar can handle the byte datatype with negative bytes
 */
public class SOAPRequestTypesBytesNegativesTest {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document (with byte parameters)
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<ByteOperationRequest><headerParam>-1</headerParam><queryParam>-128</queryParam><message><bodyParameter>BBBB</bodyParameter></message></ByteOperationRequest>");
