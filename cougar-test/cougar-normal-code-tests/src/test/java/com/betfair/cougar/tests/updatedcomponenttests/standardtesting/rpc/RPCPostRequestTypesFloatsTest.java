...
/**
 * Ensure that Cougar can handle Floats in the post body, header params and query params of an RPC request
 */
public class RPCPostRequestTypesFloatsTest {
    ...
    public void doTest() throws Exception {
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "floatOperation"),new RequestLogRequirement("2.8", "floatOperation"),new RequestLogRequirement("2.8", "floatOperation"),new RequestLogRequirement("2.8", "floatOperation"),new RequestLogRequirement("2.8", "floatOperation") );
