...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_QueryParam_Float_null.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request passes a null Float Query parameter
 */
public class RestIDLQueryParamFloatnullTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, setting the Float Query parameter as null
