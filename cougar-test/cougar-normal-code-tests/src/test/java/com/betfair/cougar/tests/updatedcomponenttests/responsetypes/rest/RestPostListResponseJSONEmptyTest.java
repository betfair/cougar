 ...
 */
public class RestPostListResponseJSONEmptyTest {
    @Test
    public void doTest() throws Exception {
        ...
        Document createAsDocument10 = xMLHelpers4.getXMLObjectFromString("<TestSimpleListGetResponse></TestSimpleListGetResponse>");
