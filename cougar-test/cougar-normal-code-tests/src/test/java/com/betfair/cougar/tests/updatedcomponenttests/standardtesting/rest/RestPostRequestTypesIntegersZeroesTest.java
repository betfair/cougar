...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_Integers_Zeroes.xls;
...
/**
 * Ensure that Cougar can handle Integers in the post body, header params and query params that are zero
 */
public class RestPostRequestTypesIntegersZeroesTest {
    @Test
    public void doTest() throws Exception {
        ...
        getNewHttpCallBean1.setOperationName("i32Operation");
        
        getNewHttpCallBean1.setServiceName("baseline", "cougarBaseline");
        
        getNewHttpCallBean1.setVersion("v2");
        // Set each of the parameter types to contain a zero integer datatype object
        ...
        Document createAsDocument11 = xMLHelpers5.getXMLObjectFromString("<I32OperationResponseObject><bodyParameter>0</bodyParameter><headerParameter>0</headerParameter><queryParameter>0</queryParameter></I32OperationResponseObject>");
        ...
        cougarManager1.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp9, new RequestLogRequirement("2.8", "i32Operation"),new RequestLogRequirement("2.8", "i32Operation"),new RequestLogRequirement("2.8", "i32Operation"),new RequestLogRequirement("2.8", "i32Operation") );
    }
