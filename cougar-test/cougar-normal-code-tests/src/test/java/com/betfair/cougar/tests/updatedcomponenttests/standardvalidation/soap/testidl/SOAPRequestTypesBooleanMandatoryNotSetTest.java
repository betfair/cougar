...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/Test-IDL/SOAP_RequestTypes_Boolean_Mandatory_NotSet.xls;
...
/**
 * Ensure that when a SOAP request is received with a missing mandatory Boolean parameter, Cougar returns the correct fault
 */
public class SOAPRequestTypesBooleanMandatoryNotSetTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<BoolOperationRequest><headerParam>true</headerParam><message><bodyParameter>true</bodyParameter></message></BoolOperationRequest>");
