...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTime_MiliisecondsNotSpecified.xls;
 ...
 */
public class RestPostRequestTypesDateTimeMiliisecondsNotSpecifiedTest {
    @Test
    public void doTest() throws Exception {
        ...
        String date = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2009, (int) 6, (int) 1, (int) 13, (int) 50, (int) 0, (int) 0);
        // Set the post body to contain a date time object (with no milliseconds specified)
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<bodyParamDateTimeObject><dateTimeParameter>2009-06-01T13:50:00Z</dateTimeParameter></bodyParamDateTimeObject>".getBytes())));
