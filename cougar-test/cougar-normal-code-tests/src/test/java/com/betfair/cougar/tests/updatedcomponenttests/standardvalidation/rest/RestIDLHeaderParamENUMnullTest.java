...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_ENUM_null.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a request passes a null value in an ENUM parameter
 */
public class RestIDLHeaderParamENUMnullTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the Enum Header param as null
