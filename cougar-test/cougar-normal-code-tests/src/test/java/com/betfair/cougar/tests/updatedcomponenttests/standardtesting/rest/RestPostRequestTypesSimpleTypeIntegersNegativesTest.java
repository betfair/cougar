...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_SimpleType_Integers_Negatives.xls;
...
/**
 * Ensure that Cougar can handle Negative Simple Type Integers in the post body, header params and query params
 */
public class RestPostRequestTypesSimpleTypeIntegersNegativesTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set each of the parameter types to contain a Negative SimpleType Integer datatype object
        Map map2 = new HashMap();
        map2.put("HeaderParam","-1");
        ...
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><bodyParameter>-50</bodyParameter></message>".getBytes())));
        ...
        Document createAsDocument11 = xMLHelpers5.getXMLObjectFromString("<I32SimpleOperationResponseObject><bodyParameter>-50</bodyParameter><headerParameter>-1</headerParameter><queryParameter>-43523434</queryParameter></I32SimpleOperationResponseObject>");
