...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_QueryParam_Byte_OutOfRange.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request passes an out of range value in a Byte Query parameter
 */
public class RestIDLQueryParamByteOutOfRangeTest {
    @Test
    public void doTest() throws Exception {
        ...
        hbean.setVersion("v2");
        // Set the parameters, setting the Byte Query parameter as an out of range value
        Map map3 = new HashMap();
        map3.put("HeaderParam","5");
        hbean.setHeaderParams(map3);

        Map map4 = new HashMap();
        map4.put("queryParam","-129");
