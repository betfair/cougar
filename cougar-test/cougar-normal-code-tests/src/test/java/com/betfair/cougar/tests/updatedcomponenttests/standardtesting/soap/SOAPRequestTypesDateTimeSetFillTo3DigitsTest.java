...
/**
 * Ensure that when a SOAP request is received, Cougar can handle the dateTimeSet datatype containing a date less than 3 digits milliseconds accuracy (cougar should fill the milliseconds to 3 digits)
 */
