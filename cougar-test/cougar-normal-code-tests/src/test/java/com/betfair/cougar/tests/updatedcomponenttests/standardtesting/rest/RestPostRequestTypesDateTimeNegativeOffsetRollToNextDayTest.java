...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTime_NegativeOffset_RollToNextDay.xls;
...
/**
 * Ensure that Cougar can handle the dateTime data type in the post body with a negative offset large enough to cause the date to roll to the next day
 */
public class RestPostRequestTypesDateTimeNegativeOffsetRollToNextDayTest {
    @Test
    public void doTest() throws Exception {
        ...
        String date = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2010, (int) 1, (int) 1, (int) 13, (int) 50, (int) 0, (int) 435);
        // Set the post body to contain a date time object (with a negative offset that will cause the date to roll to the next day)
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<bodyParamDateTimeObject><dateTimeParameter>2009-12-31T23:50:00.435-14:00</dateTimeParameter></bodyParamDateTimeObject>".getBytes())));
