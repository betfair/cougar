...
/**
 * Ensure that Cougar can handle the dateTimeMap data type in the post body of an XML request containing dates with a positive offset of hours and minutes (0230 = offset by 2 hours 30 minutes)
 */
