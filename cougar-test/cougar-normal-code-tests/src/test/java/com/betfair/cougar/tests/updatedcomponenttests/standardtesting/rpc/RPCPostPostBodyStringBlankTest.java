...
// Originally from UpdatedComponentTests/StandardTesting/RPC/RPC_Post_PostBody_String_Blank.xls;
...
/**
 * Ensure that when a Batched JSON request is performed against Cougar, requiring  a String post body element, that an empty string is accepted
 */
public class RPCPostPostBodyStringBlankTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray2[0].put("params","[\"h\",\"q\",{\"bodyParameter1\":\"\",\"bodyParameter2\":\"\"}]");
        mapArray2[0].put("id","1");
        mapArray2[1] = new HashMap();
        mapArray2[1].put("method","mandatoryParamsOperation");
        mapArray2[1].put("params","[\"h\",\"q\",{\"bodyParameter1\":\"\",\"bodyParameter2\":\"\"}]");
        ...
        AssertionUtils.multiAssertEquals("{\"id\":1,\"result\":{\"headerParameter\":\"h\",\"bodyParameter1\":\"\",\"bodyParameter2\":\"\",\"queryParameter\":\"q\"},\"jsonrpc\":\"2.0\"}", map5.get("response1"));
        AssertionUtils.multiAssertEquals("{\"id\":2,\"result\":{\"headerParameter\":\"h\",\"bodyParameter1\":\"\",\"bodyParameter2\":\"\",\"queryParameter\":\"q\"},\"jsonrpc\":\"2.0\"}", map5.get("response2"));
