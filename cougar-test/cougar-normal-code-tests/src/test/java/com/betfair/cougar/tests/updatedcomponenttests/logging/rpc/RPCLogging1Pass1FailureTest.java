...
// Originally from UpdatedComponentTests/Logging/RPC/RPC_Logging_1Pass1Failure.xls;
package com.betfair.cougar.tests.updatedcomponenttests.logging.rpc;
...
/**
 * Ensure that when a Batched JSON request containing one passing and one failing operation call is made to Cougar, it is logged correctly
 */
public class RPCLogging1Pass1FailureTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the list of requests to make a batched call to (one request which will pass and another which will fail as it's missing a mandatory parameter)
