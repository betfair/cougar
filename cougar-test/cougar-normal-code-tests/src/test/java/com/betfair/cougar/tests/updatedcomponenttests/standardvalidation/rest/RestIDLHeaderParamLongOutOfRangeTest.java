...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_Long_OutOfRange.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a request passes an out of range value in a Long parameter
 */
public class RestIDLHeaderParamLongOutOfRangeTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the Long Header param as an out of range value
        Map map3 = new HashMap();
        map3.put("HeaderParam","9223372036854775808");
