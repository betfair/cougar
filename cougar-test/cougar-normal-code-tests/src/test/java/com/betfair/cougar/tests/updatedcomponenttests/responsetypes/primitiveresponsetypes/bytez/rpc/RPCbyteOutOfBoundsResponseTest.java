...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/byte/RPC/RPC_byteOutOfBoundsResponse.xls;
...
/**
 * Test that the Cougar service returns a correct error when value passed  for byte is out of type bounds (Batched JSON)
 */
public class RPCbyteOutOfBoundsResponseTest {
    @Test
