...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Get_RequestTypes_Parameters_SetOfSimpleTypeEnum.xls;
...
/**
 * Ensure that when the 4 supported Rest XML/JSON Gets are performed, Cougar can handle a Set of Simple Type Enums being passed in the Header and Query parameters
 */
public class RestGetRequestTypesParametersSetOfSimpleTypeEnumTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters to sets of simple type enums
        ...
        Document xmlDocument = xMLHelpers5.getXMLObjectFromString("<NonMandatoryParamsOperationResponseObject><headerParameter>BARFOO,FOO,FOOBAR</headerParameter><queryParameter>BARBAR,FOOFOO</queryParameter></NonMandatoryParamsOperationResponseObject>");
        ...
        cougarManagerBaseline.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "simpleEnumSetOperation"),new RequestLogRequirement("2.8", "simpleEnumSetOperation"),new RequestLogRequirement("2.8", "simpleEnumSetOperation"),new RequestLogRequirement("2.8", "simpleEnumSetOperation") );
    }
