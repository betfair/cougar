...
/**
 * Ensure that when a Rest (JSON) Post operation is performed against Cougar, passing in an empty Map in the post body, it is correctly de-serialized, processed, returned the correct Map response.
 */
