...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_Doubles.xls;
...
/**
 * Ensure that Cougar can handle Doubles in the post body, header params and query params
 */
public class RestPostRequestTypesDoublesTest {
    @Test
    public void doTest() throws Exception {
        ...
        Document createAsDocument11 = xMLHelpers5.getXMLObjectFromString("<DoubleOperationResponseObject><bodyParameter>6.0E-4</bodyParameter><headerParameter>553.36</headerParameter><queryParameter>78.025</queryParameter></DoubleOperationResponseObject>");
