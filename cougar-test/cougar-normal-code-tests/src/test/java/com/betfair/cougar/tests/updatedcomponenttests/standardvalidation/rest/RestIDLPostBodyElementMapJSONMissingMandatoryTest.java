...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_Map_JSON_MissingMandatory.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST JSON request has a missing mandatory map body parameter
 */
public class RestIDLPostBodyElementMapJSONMissingMandatoryTest {
    @Test
