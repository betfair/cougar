...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/SOAP_RequestTypes_DateTimeMap_PositiveOffset.xls;
...
/**
 * Ensure that when a SOAP request is received, Cougar can handle the dateTimeMap datatype containing a date with a positive offset
 */
public class SOAPRequestTypesDateTimeMapPositiveOffsetTest {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document (with a dateTimeMap parameter containing a date with a positive offset)
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<DateTimeMapOperationRequest><message><dateTimeMap><entry key=\"date1\"><Date>2009-06-01T15:50:00+02:00</Date></entry><entry key=\"date2\"><Date>2009-06-01T16:50:00+02:00</Date></entry></dateTimeMap></message></DateTimeMapOperationRequest>");
