...
// Originally from UpdatedComponentTests/JMXServiceWebsite/Secure_JmxServiceTest_AuthenticationWithWrongPassword.xls;
...
/**
 * Tries to connect to the JMX admin page with the wrong password and checks the page wasn't loaded
 */
public class SecureJmxServiceTestAuthenticationWithWrongPasswordTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the auth details needed to load it (with wrong password)
        BeanyBaby.setAuthusername("jmxadmin");
        
        BeanyBaby.setAuthpassword("wrongpassword");
        ...
        // Check the page wasn't loaded as the password was incorrect
