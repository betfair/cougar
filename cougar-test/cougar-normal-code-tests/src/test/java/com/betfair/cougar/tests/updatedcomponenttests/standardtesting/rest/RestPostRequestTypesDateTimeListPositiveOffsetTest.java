...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeList_PositiveOffset.xls;
 ...
 */
public class RestPostRequestTypesDateTimeListPositiveOffsetTest {
    @Test
    public void doTest() throws Exception {
        ...
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeList><Date>2009-06-01T15:50:00.435+02:00</Date><Date>2009-06-01T16:50:00.435+02:00</Date></dateTimeList></message>".getBytes())));
