...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_Longs_Zeroes.xls;
...
/**
 * Ensure that Cougar can handle Longs in the post body, header params and query params which are Zero
 */
public class RestPostRequestTypesLongsZeroesTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set each of the parameter types to contain a long datatype object that is Zero
        ...
        Document createAsDocument11 = xMLHelpers5.getXMLObjectFromString("<I64OperationResponseObject><bodyParameter>0</bodyParameter><headerParameter>0</headerParameter><queryParameter>0</queryParameter></I64OperationResponseObject>");
