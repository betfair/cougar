...
public class Error404NonExistantStaticFileTest {
    ...
    public void doTest() throws Exception {
        ...
        // Request a non existant static file (and should be returned the 404 page)
        HttptestPageBean loadedPage = HttpService.loadPage("http://localhost:8080/static-html/nonExistant.html",false);
        // Get the 404 page as a Document and check it is as expected
