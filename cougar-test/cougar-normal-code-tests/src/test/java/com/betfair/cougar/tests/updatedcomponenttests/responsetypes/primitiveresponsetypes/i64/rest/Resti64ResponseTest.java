...
/**
 * Test that the Cougar service allows to use i64 primitive type in the response (REST)
 */
public class Resti64ResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        CougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "i64SimpleTypeEcho"),new RequestLogRequirement("2.8", "i64SimpleTypeEcho"),new RequestLogRequirement("2.8", "i64SimpleTypeEcho"),new RequestLogRequirement("2.8", "i64SimpleTypeEcho") );
    }
