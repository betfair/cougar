...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_QueryParam_Double_null.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request passes a null Double Query parameter
 */
public class RestIDLQueryParamDoublenullTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, setting the Double Query parameter as null
