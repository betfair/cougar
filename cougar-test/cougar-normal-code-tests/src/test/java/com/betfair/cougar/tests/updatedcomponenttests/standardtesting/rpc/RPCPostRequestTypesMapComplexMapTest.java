...
// Originally from UpdatedComponentTests/StandardTesting/RPC/RPC_Post_RequestTypes_Map_ComplexMap.xls;
...
/**
 * Ensure that Cougar can handle a ComplexMap in the post body of an RPC request
 */
public class RPCPostRequestTypesMapComplexMapTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray2[0].put("params","[{\"complexMap\":{\"aaa\":{\"dateTimeParameter\":\"2009-06-01T14:50:00.435Z\",\"listParameter\":[\"aaa List Entry 1\",\"aaa List Entry 2\" ],\"enumParameter\":\"BAR\",\"stringParameter\":\"String value for aaa\"},\"bbb\":{\"dateTimeParameter\":\"2009-06-02T14:50:00.435Z\",\"listParameter\":[\"bbb List Entry 1\",\"bbb List Entry 2\"],\"enumParameter\":\"FOO\",\"stringParameter\":\"String value for bbb\"}}}]");
        mapArray2[0].put("id","1");
        mapArray2[1] = new HashMap();
        mapArray2[1].put("method","complexMapOperation");
        mapArray2[1].put("params","[{\"complexMap\":{\"ccc\":{\"dateTimeParameter\":\"2009-06-03T14:50:00.435Z\",\"listParameter\":[\"ccc List Entry 1\", \"ccc List Entry 2\" ],\"enumParameter\":\"BAR\",\"stringParameter\":\"String value for ccc\"},\"ddd\":{\"dateTimeParameter\":\"2009-06-04T14:50:00.435Z\",\"listParameter\":[\"ddd List Entry 1\",\"ddd List Entry 2\"],\"enumParameter\":\"FOO\",\"stringParameter\":\"String value for ddd\"}}}]");
        ...
        AssertionUtils.multiAssertEquals("{\"id\":1,\"result\":{\"responseMap\":{\"aaa\":{\"enumParameter\":\"BAR\",\"dateTimeParameter\":\"2009-06-01T14:50:00.435Z\",\"stringParameter\":\"String value for aaa\",\"listParameter\":[\"aaa List Entry 1\",\"aaa List Entry 2\"]},\"bbb\":{\"enumParameter\":\"FOO\",\"dateTimeParameter\":\"2009-06-02T14:50:00.435Z\",\"stringParameter\":\"String value for bbb\",\"listParameter\":[\"bbb List Entry 1\",\"bbb List Entry 2\"]}}},\"jsonrpc\":\"2.0\"}", map5.get("response1"));
        AssertionUtils.multiAssertEquals("{\"id\":2,\"result\":{\"responseMap\":{\"ddd\":{\"enumParameter\":\"FOO\",\"dateTimeParameter\":\"2009-06-04T14:50:00.435Z\",\"stringParameter\":\"String value for ddd\",\"listParameter\":[\"ddd List Entry 1\",\"ddd List Entry 2\"]},\"ccc\":{\"enumParameter\":\"BAR\",\"dateTimeParameter\":\"2009-06-03T14:50:00.435Z\",\"stringParameter\":\"String value for ccc\",\"listParameter\":[\"ccc List Entry 1\",\"ccc List Entry 2\"]}}},\"jsonrpc\":\"2.0\"}", map5.get("response2"));
