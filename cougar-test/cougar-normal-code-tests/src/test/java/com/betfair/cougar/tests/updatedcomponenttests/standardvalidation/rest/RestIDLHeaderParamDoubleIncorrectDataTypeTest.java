...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_Double_IncorrectDataType.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a request passes a non Double object in a Double parameter
 */
public class RestIDLHeaderParamDoubleIncorrectDataTypeTest {
    @Test
    public void doTest() throws Exception {
        ...
        getNewHttpCallBean2.setOperationName("doubleOperation");

        getNewHttpCallBean2.setServiceName("baseline", "cougarBaseline");

        getNewHttpCallBean2.setVersion("v2");
        // Set the Double Header param as a non double
        Map map3 = new HashMap();
        map3.put("HeaderParam","sometext");
        getNewHttpCallBean2.setHeaderParams(map3);

        Map map4 = new HashMap();
        map4.put("queryParam","4534.34");
        getNewHttpCallBean2.setQueryParams(map4);

        getNewHttpCallBean2.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><bodyParameter>-45.5</bodyParameter></message>".getBytes())));
        ...
        cougarManager11.verifyAccessLogEntriesAfterDate(getTimeAsTimeStamp11, new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/doubleOperation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/doubleOperation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/doubleOperation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/cougarBaseline/v2/doubleOperation", "BadRequest") );
    }
