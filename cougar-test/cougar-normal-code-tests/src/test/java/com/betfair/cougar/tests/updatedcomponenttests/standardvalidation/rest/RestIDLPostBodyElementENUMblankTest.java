...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_PostBodyElement_ENUM_blank.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request contains a blank ENUM body parameter
 */
public class RestIDLPostBodyElementENUMblankTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the ENUM body parameter as blank
