...
// Originally from UpdatedComponentTests/Geolocate/RPC/RPC_Geolocate_ByIPAddress_US.xls;
...
/**
 * Ensure that when a Batched JSON request is received by Cougar, the ipaddress is used to correctly identify where the request originated, in this case: US
 */
public class RPCGeolocateByIPAddressUSTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the IP address that the request is originating from (in this case an US IP Address)
        callBean.setIpAddress("65.55.209.105");
        ...
        cougarManager9.verifyAccessLogEntriesAfterDate(timeStamp, new AccessLogRequirement("65.55.209.105", "/json-rpc", "Ok") );
    }
