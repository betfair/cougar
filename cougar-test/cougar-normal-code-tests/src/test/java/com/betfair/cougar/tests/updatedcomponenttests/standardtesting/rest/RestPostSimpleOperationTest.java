...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_SimpleOperation.xls;
...
/**
 * Ensure that when a simple Rest XML/JSON Post is performed against Cougar, requesting each supported response protocol (XML/JSON) the request is handled correctly
 */
public class RestPostSimpleOperationTest {
    @Test
    public void doTest() throws Exception {
        ...
        Document createAsDocument9 = xMLHelpers3.getXMLObjectFromString("<SimpleResponse><message>sum = 82</message></SimpleResponse>");
