...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTimeSet_PositiveOffset_RollToPreviousDay.xls;
...
/**
 * Ensure that Cougar can handle the dateTimeSet data type in the post body with a date with a positive offset
 */
public class RestPostRequestTypesDateTimeSetPositiveOffsetRollToPreviousDayTest {
    @Test
    public void doTest() throws Exception {
        ...
        String date1 = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2009, (int) 2, (int) 1, (int) 13, (int) 50, (int) 0, (int) 435);
        // Create a date time object expected to be in the response object

        String date2 = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2009, (int) 2, (int) 1, (int) 14, (int) 50, (int) 0, (int) 435);
        // Set the post body to contain a date time set object containing dates with a positive offset
        hbean.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><dateTimeSet><Date>2009-02-01T15:50:00.435+02:00</Date><Date>2009-02-01T16:50:00.435+02:00</Date></dateTimeSet></message>".getBytes())));
