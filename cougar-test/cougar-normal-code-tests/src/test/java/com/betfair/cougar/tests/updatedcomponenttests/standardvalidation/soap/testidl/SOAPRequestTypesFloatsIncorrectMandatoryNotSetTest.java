...
// Originally from UpdatedComponentTests/StandardValidation/SOAP/Test-IDL/SOAP_RequestTypes_Floats_Incorrect_Mandatory_NotSet.xls;
...
/**
 * Ensure that when a SOAP request is received with a missing mandatory Float parameter, Cougar returns the correct fault
 */
public class SOAPRequestTypesFloatsIncorrectMandatoryNotSetTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            Document createAsDocument2 = xMLHelpers2.getXMLObjectFromString("<FloatOperationRequest><headerParam>78.4</headerParam><message><bodyParameter>0.0006</bodyParameter></message></FloatOperationRequest>");
