...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_Integer_null.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a request passes a null Integer parameter
 */
public class RestIDLHeaderParamIntegernullTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the Integer header parameter to null
