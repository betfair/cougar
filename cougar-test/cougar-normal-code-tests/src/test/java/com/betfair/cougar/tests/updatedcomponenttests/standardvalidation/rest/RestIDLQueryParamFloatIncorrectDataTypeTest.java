...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_QueryParam_Float_IncorrectDataType.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a REST request passes a non Float object in a Float Query parameter
 */
public class RestIDLQueryParamFloatIncorrectDataTypeTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the parameters, setting the Float Query parameter as a non float
        Map map3 = new HashMap();
        map3.put("HeaderParam","5.43");
        getNewHttpCallBean2.setHeaderParams(map3);

        Map map4 = new HashMap();
        map4.put("queryParam","fjisdo");
