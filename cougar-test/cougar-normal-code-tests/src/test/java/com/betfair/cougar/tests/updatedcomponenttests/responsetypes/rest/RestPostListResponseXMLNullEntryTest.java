...
// Originally from UpdatedComponentTests/ResponseTypes/REST/Rest_Post_ListResponse_XML_NullEntry.xls;
...
/**
 * Ensure that when a Rest (XML) Post operation is performed against Cougar, passing a Set with a null entry in the post body, it is correctly de-serialized, processed, returned the correct response.
 */
public class RestPostListResponseXMLNullEntryTest {
    @Test
    public void doTest() throws Exception {
        ...
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<inputList xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"><String>bbb string</String><String xsi:nil=\"true\"/><String>ddd string</String><String>ccc string</String></inputList>".getBytes())));
        ...
        Document createAsDocument10 = xMLHelpers3.getXMLObjectFromString("<TestSimpleListGetResponse><String>bbb string</String><String xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:nil=\"true\"/><String>ddd string</String><String>ccc string</String></TestSimpleListGetResponse>");
