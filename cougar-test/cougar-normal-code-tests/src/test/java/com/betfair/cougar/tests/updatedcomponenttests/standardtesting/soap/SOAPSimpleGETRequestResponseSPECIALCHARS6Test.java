...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/SOAP_SimpleGET_RequestResponse_SPECIALCHARS_6.xls;
...
/**
 * Test Basic functionality of the Container, test simple requests and responses work for SOAP Protocol with multiple special characters
 */
public class SOAPSimpleGETRequestResponseSPECIALCHARS6Test {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document (with message containing the special character being tested)
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<TestSimpleGetRequest><message>!@#$%^*//%aghgjh?|>:/.,.m,;'\\[]</message></TestSimpleGetRequest>");
        ...
        Document createAsDocument10 = xMLHelpers4.getXMLObjectFromString("<response><message>!@#$%^*//%aghgjh?|>:/.,.m,;'\\[]</message></response>");
