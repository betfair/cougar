...
// Originally from UpdatedComponentTests/StandardTesting/REST/Rest_Post_RequestTypes_DateTime_PositiveOffset_RollToPreviousDay.xls;
...
/**
 * Ensure that Cougar can handle the dateTime data type in the post body with a positive offset large enough to cause the date to roll to the previous day
 */
public class RestPostRequestTypesDateTimePositiveOffsetRollToPreviousDayTest {
    @Test
    public void doTest() throws Exception {
        ...
        String date = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 2008, (int) 12, (int) 31, (int) 10, (int) 1, (int) 0, (int) 435);
        // Set the post body to contain a date time object (with a positive offset that rolls the date to the previous day)
        getNewHttpCallBean1.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<bodyParamDateTimeObject><dateTimeParameter>2009-01-01T00:01:00.435+14:00</dateTimeParameter></bodyParamDateTimeObject>".getBytes())));
