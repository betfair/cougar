...
// Originally from UpdatedComponentTests/ResponseTypes/PrimitiveResponseTypes/float/RPC/RPC_floatResponse.xls;
package com.betfair.cougar.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.floatz.rpc;
...
/**
 * Test that the Cougar service allows to use float primitive type in the response (Batched JSON)
 */
public class RPCfloatResponseTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray2[0].put("method","floatSimpleTypeEcho");
        mapArray2[0].put("params","[0.6]");
        mapArray2[0].put("id","1");
        mapArray2[1] = new HashMap();
        mapArray2[1].put("method","floatSimpleTypeEcho");
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "floatSimpleTypeEcho"),new RequestLogRequirement("2.8", "floatSimpleTypeEcho") );
