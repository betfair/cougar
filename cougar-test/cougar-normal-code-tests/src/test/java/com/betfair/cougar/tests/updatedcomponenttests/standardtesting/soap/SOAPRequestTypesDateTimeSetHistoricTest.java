...
/**
 * Ensure that when a SOAP request is received, Cougar can handle the dateTimeSet datatype containing a date set far in the past
 */
public class SOAPRequestTypesDateTimeSetHistoricTest {
    ...
    public void doTest() throws Exception {
        ...
        String convertUTCDateTimeToCougarFormat7 = TimingHelpers.convertUTCDateTimeToCougarFormat((int) 1899, (int) 6, (int) 2, (int) 13, (int) 50, (int) 0, (int) 0);
