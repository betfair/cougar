...
// Originally from UpdatedComponentTests/AcceptProtocols/Rest/Rest_Post_AcceptProtocolRankingXML_Unsupported.xls;
...
/**
 * Ensure that when a Rest XML Post operation is performed on Cougar, with all ranked response protocols being unsupported, the correct error response is generated.
 */
public class RestPostAcceptProtocolRankingXMLUnsupportedTest {
    @Test
