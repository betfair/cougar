...
// Originally from UpdatedComponentTests/StandardTesting/SOAP/Test-IDL/SOAP_RequestTypes_Floats_Infinity.xls;
...
/**
 * Ensure that when a SOAP request is received, Cougar can handle the float datatype with floats that will be handled as Infinity
 */
public class SOAPRequestTypesFloatsInfinityTest {
    @Test
    public void doTest() throws Exception {
        // Create the SOAP request as an XML Document (with float parameters)
        XMLHelpers xMLHelpers1 = new XMLHelpers();
        Document createAsDocument1 = xMLHelpers1.getXMLObjectFromString("<FloatOperationRequest><headerParam>3.4028235E40</headerParam><queryParam>3.4028235E39</queryParam><message><bodyParameter>-3.4028235E39</bodyParameter></message></FloatOperationRequest>");
