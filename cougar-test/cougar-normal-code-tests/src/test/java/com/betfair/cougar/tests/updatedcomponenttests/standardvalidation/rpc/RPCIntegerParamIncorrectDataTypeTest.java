...
// Originally from UpdatedComponentTests/StandardValidation/RPC/RPC_IntegerParam_IncorrectDataType.xls;
...
/**
 * Ensure that Cougar returns the correct fault when a  RPC request with Integer param  is made with incorrect data type parameter
 */
public class RPCIntegerParamIncorrectDataTypeTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray3[0].put("method","i32Operation");
        mapArray3[0].put("params","[256, 34,{\"bodyParameter\":234}]");
        mapArray3[0].put("id","\"Call with correct params\"");
        mapArray3[1] = new HashMap();
        mapArray3[1].put("method","i32Operation");
        mapArray3[1].put("params","[21474836480, 256,{\"bodyParameter\":234}]");
        mapArray3[1].put("id","\"Incorrect Header param\"");
        mapArray3[2] = new HashMap();
        mapArray3[2].put("method","i32Operation");
        mapArray3[2].put("params","[256, 21474836480,{\"bodyParameter\":234}]");
        mapArray3[2].put("id","\"Incorrect Query param\"");
        mapArray3[3] = new HashMap();
        mapArray3[3].put("method","i32Operation");
        mapArray3[3].put("params","[256, 34,{\"bodyParameter\":21474836480}]");
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "i32Operation") );
