...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_SimpleType_ENUM_null.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a request contains a null simple type ENUM parameter
 */
public class RestIDLHeaderParamSimpleTypeENUMnullTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set the Simple Type ENUM Header param as null
        Map map3 = new HashMap();
        map3.put("HeaderParam","null");
        getNewHttpCallBean2.setHeaderParams(map3);

        Map map4 = new HashMap();
        map4.put("queryParam","FOO");
        map4.put("pathParam","FOO");
        getNewHttpCallBean2.setQueryParams(map4);

        getNewHttpCallBean2.setRestPostQueryObjects(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream("<message><bodyParameter>FOO</bodyParameter></message>".getBytes())));
