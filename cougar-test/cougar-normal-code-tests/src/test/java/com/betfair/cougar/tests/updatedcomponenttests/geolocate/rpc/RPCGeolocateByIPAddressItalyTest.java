...
// Originally from UpdatedComponentTests/Geolocate/RPC/RPC_Geolocate_ByIPAddress_Italy.xls;
...
/**
 * Ensure that when a Batched JSON request is received by Cougar, the ipaddress is used to correctly identify where the request originated, in this case: Italy
 */
public class RPCGeolocateByIPAddressItalyTest {
