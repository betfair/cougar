...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_MissingMandatory.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a request is missing a mandatory header parameter
 */
public class RestIDLHeaderParamMissingMandatoryTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set up Http Call Bean for making the request
        ...
        // Set parameters but don't set mandatory header parameter
        ...
        Document createAsDocument11 = xMLHelpers5.getXMLObjectFromString("<fault><faultcode>Client</faultcode><faultstring>DSC-0018</faultstring><detail/></fault>");
