...
// Originally from UpdatedComponentTests/StandardValidation/REST/Rest_IDL_HeaderParam_SimpleType_ENUM_Mandatory_NotSet.xls;
...
/**
 * Ensure that Cougar returns the correct fault, when a request is missing a mandatory simple type ENUM parameter
 */
public class RestIDLHeaderParamSimpleTypeENUMMandatoryNotSetTest {
    @Test
    public void doTest() throws Exception {
        ...
        // Set parameters but don't set the mandatory simple Type ENUM Header parameter
