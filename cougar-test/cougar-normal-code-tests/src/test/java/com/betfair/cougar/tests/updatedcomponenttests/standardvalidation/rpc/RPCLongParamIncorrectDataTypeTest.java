...
// Originally from UpdatedComponentTests/StandardValidation/RPC/RPC_LongParam_IncorrectDataType.xls;
...
/**
 * Ensure that Cougar returns the correct fault when a  RPC request with Long param  is made with incorrect data type parameter
 */
public class RPCLongParamIncorrectDataTypeTest {
    @Test
    public void doTest() throws Exception {
        ...
        mapArray3[0].put("method","i64Operation");
        mapArray3[0].put("params","[256, 34,{\"bodyParameter\":234}]");
        mapArray3[0].put("id","\"Call with correct params\"");
        mapArray3[1] = new HashMap();
        mapArray3[1].put("method","i64Operation");
        mapArray3[1].put("params","[92233720368547758080, 256,{\"bodyParameter\":234}]");
        mapArray3[1].put("id","\"Incorrect Header param\"");
        mapArray3[2] = new HashMap();
        mapArray3[2].put("method","i64Operation");
        mapArray3[2].put("params","[256,92233720368547758080,{\"bodyParameter\":234}]");
        mapArray3[2].put("id","\"Incorrect Query param\"");
        mapArray3[3] = new HashMap();
        mapArray3[3].put("method","i64Operation");
        mapArray3[3].put("params","[256, 34,{\"bodyParameter\":92233720368547758080}]");
        ...
        AssertionUtils.multiAssertEquals("{\"id\":\"Call with correct params\",\"result\":{\"headerParameter\":256,\"queryParameter\":34,\"bodyParameter\":234},\"jsonrpc\":\"2.0\"}", map6.get("responseCall with correct params"));
        ...
        cougarManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "i64Operation") );
