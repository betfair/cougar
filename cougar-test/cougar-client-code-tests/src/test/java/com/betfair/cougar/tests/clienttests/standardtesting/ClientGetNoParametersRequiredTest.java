...
/**
 * Ensure that when an operation which requires no parameters is performed against cougar via a cougar client, the request is sent and the response is handled correctly
 */
