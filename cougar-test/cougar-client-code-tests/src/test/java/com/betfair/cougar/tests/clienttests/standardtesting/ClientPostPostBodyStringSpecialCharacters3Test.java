...
// Originally from ClientTests/Transport/StandardTesting/Client_Rescript_Post_PostBody_String_SpecialCharacters_3.xls;
...
/**
 * Ensure that when a request containing special character \" in a body parameter is made to cougar via a cougar client the request is sent and the response is handled correctly
 */
public class ClientPostPostBodyStringSpecialCharacters3Test {
    ...
    public void doTest(CougarClientWrapper.TransportType tt) throws Exception {
        ...
        complexObject2.setName("this is a \\\" slash+dblquote");
        ...
        assertEquals("this is a \\\" slash+dblquote = 82", response3.getMessage());
    }
