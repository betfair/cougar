...
/**
 * Ensure that when a simpleEnumList is passed to cougar via a cougar client the request is sent and the response is handled correctly
 */
public class ClientGetRequestTypesParametersListOfSimpleTypeEnumTest {
    ...
    public void doTest(CougarClientWrapper.TransportType tt) throws Exception {
        ...
        List<SimpleEnum> queryList = cougarClientResponseTypeUtils2.buildEnumList("FOOFOO,BARBAR,FOOFOO");
        // Build list to pass as parameter
        CougarClientResponseTypeUtils cougarClientResponseTypeUtils3 = new CougarClientResponseTypeUtils();
        List<SimpleEnum> headerList = cougarClientResponseTypeUtils3.buildEnumList("FOO,FOOBAR,BARFOO");
