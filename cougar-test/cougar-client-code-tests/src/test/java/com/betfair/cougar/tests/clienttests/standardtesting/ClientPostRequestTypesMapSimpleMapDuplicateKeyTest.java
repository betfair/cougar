...
// Originally from ClientTests/Transport/StandardTesting/Client_Rescript_Post_RequestTypes_Map_SimpleMap_DuplicateKey.xls;
...
/**
 * Ensure that when a SimpleMap object with a duplicate key is passed in parameters to cougar via a cougar client, the request is sent and the response is handled correctly
 */
public class ClientPostRequestTypesMapSimpleMapDuplicateKeyTest {
    ...
    public void doTest(CougarClientWrapper.TransportType tt) throws Exception {
        ...
        // Build map with a duplicate key
        CougarClientResponseTypeUtils cougarClientResponseTypeUtils2 = new CougarClientResponseTypeUtils();
        Map<String, String> simpleMap = cougarClientResponseTypeUtils2.buildMap("aaa,bbb,ccc,ccc,ddd", "Value for aaa,Value for bbb,Value for zzz,Value for ccc, Value for ddd ");
