...
// Originally from ClientTests/Transport/ResponseTypes/Client_Rescript_ListOfComplexObjects.xls;
...
/**
 * Ensure that when a List of SimpleResponse is returned by the operation, the elements of the list are of expected class (SimpleResponse)
 */
public class ClientListOfComplexObjectsTest {
    ...
    public void doTest(CougarClientWrapper.TransportType tt) throws Exception {
        ...
        List<SimpleResponse> response2 = client.testDirectListReturn(context, (int) 2, com.betfair.baseline.v2.enumerations.AsyncBehaviour.SYNC);
