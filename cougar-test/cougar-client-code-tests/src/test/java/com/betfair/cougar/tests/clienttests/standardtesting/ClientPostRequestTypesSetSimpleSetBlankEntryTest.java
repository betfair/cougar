...
// Originally from ClientTests/Transport/StandardTesting/Client_Rescript_Post_RequestTypes_Set_SimpleSet_BlankEntry.xls;
...
/**
 * Ensure that when a SimpleSet object with a blank entry is passed in parameters to cougar via a cougar client, the request is sent and the response is handled correctly
 */
public class ClientPostRequestTypesSetSimpleSetBlankEntryTest {
    ...
    public void doTest(CougarClientWrapper.TransportType tt) throws Exception {
        ...
        // Build set with a blank entry
        CougarClientResponseTypeUtils cougarClientResponseTypeUtils2 = new CougarClientResponseTypeUtils();
        Set<String> inputSet = cougarClientResponseTypeUtils2.buildSet("aaaString,,cccString,dddString");
        ...
        assertEquals(new LinkedHashSet(Arrays.asList("", "cccString", "dddString", "aaaString")), result.getResponseSet());
    }
