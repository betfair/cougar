...
// Originally from ClientTests/Transport/ResponseTypes/Client_Rescript_dateTimeResponse.xls;
...
/**
 * Ensure that when a dateTimeSimpleTypeEcho operation is performed against cougar via a cougar client the request is sent and the response is handled correctly
 */
public class ClientdateTimeResponseTest {
