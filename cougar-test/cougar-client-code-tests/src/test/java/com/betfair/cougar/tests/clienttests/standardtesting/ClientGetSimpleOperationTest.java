...
// Originally from ClientTests/Transport/StandardTesting/Client_Rescript_Get_SimpleOperation.xls;
...
/**
 * Ensure that a simple get operation can be performed against cougar via a cougar client and the response is handled correctly
 */
public class ClientGetSimpleOperationTest {
    ...
    public void doTest(CougarClientWrapper.TransportType tt) throws Exception {
        ...
        SimpleResponse response2 = client.testSimpleGet(context, "foo");
        assertEquals("foo", response2.getMessage());
    }
