...
/**
 * Ensure that when a stringList with a null entry is passed to cougar via a cougar client the request is sent and the response is handled correctly
 */
public class ClientGetRequestTypesParametersListOfStringsNullEntryTest {
    ...
    public void doTest(CougarClientWrapper.TransportType tt) throws Exception {
        ...
        List<String> queryList = cougarClientResponseTypeUtils2.buildList("query1,queryTwo,null,query4");
        // Build list to pass as parameter
        CougarClientResponseTypeUtils cougarClientResponseTypeUtils3 = new CougarClientResponseTypeUtils();
        List<String> headerList = cougarClientResponseTypeUtils3.buildList("header1,headerTwo,null,header4");
