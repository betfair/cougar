...
/**
 * Ensure that when request containing special character \r in a body parameter is made to cougar via a cougar client the request is sent and the response is handled correctly
 */
