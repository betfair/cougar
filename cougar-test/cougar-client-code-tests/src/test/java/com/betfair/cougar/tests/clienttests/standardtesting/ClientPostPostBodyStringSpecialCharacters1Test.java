...
// Originally from ClientTests/Transport/StandardTesting/Client_Rescript_Post_PostBody_String_SpecialCharacters_1.xls;
 ...
 */
public class ClientPostPostBodyStringSpecialCharacters1Test {
    ...
    public void doTest(CougarClientWrapper.TransportType tt) throws Exception {
        ...
        complexObject2.setName("C:\\Testing\\Validation");
        ...
        assertEquals("C:\\Testing\\Validation = 82", response3.getMessage());
    }
