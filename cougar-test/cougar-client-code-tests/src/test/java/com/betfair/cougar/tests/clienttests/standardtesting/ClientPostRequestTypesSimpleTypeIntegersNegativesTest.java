...
// Originally from ClientTests/Transport/StandardTesting/Client_Rescript_Post_RequestTypes_SimpleType_Integers_Negatives.xls;
...
/**
 * Ensure that when a Negative SimpleType Integer object is passed in parameters to cougar via a cougar client, the request is sent and the response is handled correctly
 */
public class ClientPostRequestTypesSimpleTypeIntegersNegativesTest {
