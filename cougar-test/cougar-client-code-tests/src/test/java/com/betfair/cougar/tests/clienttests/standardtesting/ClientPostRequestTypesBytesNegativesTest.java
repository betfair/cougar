...
/**
 * Ensure that when a Negative Byte object is passed in parameters to cougar via a cougar client, the request is sent and the response is handled correctly
 */
public class ClientPostRequestTypesBytesNegativesTest {
    ...
    public void doTest(CougarClientWrapper.TransportType tt) throws Exception {
        ...
        BodyParamByteObject bodyParam = cougarClientResponseTypeUtils2.buildByteBodyParamObject("-1,1,2,3,4,5");
