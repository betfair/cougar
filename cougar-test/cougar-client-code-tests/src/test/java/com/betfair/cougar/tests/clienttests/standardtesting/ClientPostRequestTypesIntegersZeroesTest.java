...
// Originally from ClientTests/Transport/StandardTesting/Client_Rescript_Post_RequestTypes_Integers_Zeroes.xls;
...
/**
 * Ensure that when an (Zeroe) Integer object is passed in parameters to cougar via a cougar client, the request is sent and the response is handled correctly
 */
public class ClientPostRequestTypesIntegersZeroesTest {
    ...
    public void doTest(CougarClientWrapper.TransportType tt) throws Exception {
        ...
        bodyParamI32Object2.setBodyParameter((int) 0);
        ...
        I32OperationResponseObject response3 = client.i32Operation(context, (int) 0, (int) 0, bodyParam);
