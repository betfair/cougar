...
// Originally from ClientTests/Transport/StandardTesting/Client_Rescript_Get_RequestTypes_String_HeaderParam_EscapedCharacters_Ampersand.xls;
 ...
 */
public class ClientGetRequestTypesStringHeaderParamEscapedCharactersAmpersandTest {
    ...
    public void doTest(CougarClientWrapper.TransportType tt) throws Exception {
        ...
        NonMandatoryParamsOperationResponseObject response3 = client.nonMandatoryParamsOperation(context, "this&that", "queryParamString", body);
        assertEquals("queryParamString", response3.getQueryParameter());
        assertEquals("this&that", response3.getHeaderParameter());
    }
