...
// Originally from ClientTests/Transport/StandardTesting/Client_Rescript_Post_PostBody_Parameter_NonMandatory_NotSet.xls;
...
/**
 * Ensure that when a request is made to cougar via a cougar client, with some non mandatory body parameters not set, the request is sent and the response is handled correctly
 */
public class ClientPostPostBodyParameterNonMandatoryNotSetTest {
    ...
    public void doTest(CougarClientWrapper.TransportType tt) throws Exception {
        ...
        nonMandatoryParamsRequest2.setBodyParameter2("postBodyParamString2");
