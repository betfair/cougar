...
// Originally from ClientTests/Transport/StandardTesting/Client_Rescript_Post_RequestTypes_DateTime_2.xls;
 ...
 */
public class ClientPostRequestTypesDateTime2Test {
    ...
    public void doTest(CougarClientWrapper.TransportType tt) throws Exception {
        ...
        Date dateParam = cougarClientResponseTypeUtils2.createDateFromString("2009-01-01T13:50:00.0Z");

         CougarHelpers helper = new CougarHelpers();

        Date convertedDate1 = helper.convertToSystemTimeZone("2009-06-01T13:50:00.0Z");

        // Create body parameter to be passed using date just created
        BodyParamDateTimeObject bodyParamDateTimeObject3 = new BodyParamDateTimeObject();
        bodyParamDateTimeObject3.setDateTimeParameter(convertedDate1);
