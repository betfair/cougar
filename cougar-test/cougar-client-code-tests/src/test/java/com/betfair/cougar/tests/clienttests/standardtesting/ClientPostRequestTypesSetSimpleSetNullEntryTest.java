...
// Originally from ClientTests/Transport/StandardTesting/Client_Rescript_Post_RequestTypes_Set_SimpleSet_NullEntry.xls;
...
/**
 * Ensure that when a SimpleSet object with a null entry is passed in parameters to cougar via a cougar client, the request is sent and the response is handled correctly
 */
public class ClientPostRequestTypesSetSimpleSetNullEntryTest {
