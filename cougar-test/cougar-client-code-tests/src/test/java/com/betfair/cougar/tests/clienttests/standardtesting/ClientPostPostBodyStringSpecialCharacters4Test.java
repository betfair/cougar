...
// Originally from ClientTests/Transport/StandardTesting/Client_Rescript_Post_PostBody_String_SpecialCharacters_4.xls;
 ...
 */
public class ClientPostPostBodyStringSpecialCharacters4Test {
    ...
    public void doTest(CougarClientWrapper.TransportType tt) throws Exception {
        ...
        complexObject2.setName("this is a \\\\ slash+slash");
        ...
        assertEquals("this is a \\\\ slash+slash = 82", response3.getMessage());
    }
