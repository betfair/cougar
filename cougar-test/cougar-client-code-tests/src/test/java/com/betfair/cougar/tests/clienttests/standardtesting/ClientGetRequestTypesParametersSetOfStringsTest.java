...
// Originally from ClientTests/Transport/StandardTesting/Client_Rescript_Get_RequestTypes_Parameters_SetOfStrings.xls;
...
/**
 * Ensure that when a stringSet is passed to cougar via a cougar client the request is sent and the response is handled correctly
 */
public class ClientGetRequestTypesParametersSetOfStringsTest {
    ...
    public void doTest(CougarClientWrapper.TransportType tt) throws Exception {
        ...
        Set<String> querySet = cougarClientResponseTypeUtils2.buildSet("query1,query2,query3,query4");
        // Build set to pass as parameter
        CougarClientResponseTypeUtils cougarClientResponseTypeUtils3 = new CougarClientResponseTypeUtils();
        Set<String> headerSet = cougarClientResponseTypeUtils3.buildSet("header1,header2,header3,header4");
        ...
        assertEquals("query1,query2,query3,query4", response4.getQueryParameter());
        assertEquals("header1,header2,header3,header4", response4.getHeaderParameter());
    }
