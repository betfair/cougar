...
// Originally from ClientTests/Transport/StandardTesting/Client_Rescript_Post_RequestTypes_Long_Zeroes.xls;
...
/**
 * Ensure that when a (Zeroe) Long object is passed in parameters to cougar via a cougar client, the request is sent and the response is handled correctly
 */
public class ClientPostRequestTypesLongZeroesTest {
    ...
    public void doTest(CougarClientWrapper.TransportType tt) throws Exception {
        ...
        bodyParamI64Object2.setBodyParameter(0L);
        ...
        I64OperationResponseObject response3 = client.i64Operation(context, 0L, 0L, bodyParam);
        assertEquals(0L, (long) response3.getQueryParameter());
        assertEquals(0L, (long) response3.getHeaderParameter());
        assertEquals(0L, (long) response3.getBodyParameter());
    }
