...
/**
 * Ensure that when a Double object (with an out of range value) is passed in parameters to cougar via a cougar client, the request is sent and the response is handled correctly
 */
