...
// Originally from ClientTests/Transport/StandardTesting/Client_Rescript_Get_RequestTypes_HeaderParams_PathParams_QueryParams_StandardAndEnums.xls;
...
/**
 * Ensure that when an operation, which takes standard and enum header and query parameters, is performed against cougar via a cougar client the request is sent and the response is handled correctly
 */
public class ClientGetRequestTypesHeaderParamsPathParamsQueryParamsStandardAndEnumsTest {
