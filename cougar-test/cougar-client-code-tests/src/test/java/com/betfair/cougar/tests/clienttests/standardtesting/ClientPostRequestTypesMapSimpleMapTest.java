...
// Originally from ClientTests/Transport/StandardTesting/Client_Rescript_Post_RequestTypes_Map_SimpleMap.xls;
...
/**
 * Ensure that when a SimpleMap object is passed in parameters to cougar via a cougar client, the request is sent and the response is handled correctly
 */
public class ClientPostRequestTypesMapSimpleMapTest {
    ...
    public void doTest(CougarClientWrapper.TransportType tt) throws Exception {
        ...
        Map<String, String> simpleMap = cougarClientResponseTypeUtils2.buildMap("aaa,bbb,ccc", "Value for aaa,Value for bbb,Value for ccc");
