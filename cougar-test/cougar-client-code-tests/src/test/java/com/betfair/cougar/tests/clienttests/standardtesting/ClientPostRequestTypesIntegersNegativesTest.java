...
// Originally from ClientTests/Transport/StandardTesting/Client_Rescript_Post_RequestTypes_Integers_Negatives.xls;
...
/**
 * Ensure that when a Negative Integer object is passed in parameters to cougar via a cougar client, the request is sent and the response is handled correctly
 */
public class ClientPostRequestTypesIntegersNegativesTest {
    ...
    public void doTest(CougarClientWrapper.TransportType tt) throws Exception {
        ...
        bodyParamI32Object2.setBodyParameter((int) -50);
        ...
        I32OperationResponseObject response3 = client.i32Operation(context, (int) -1, (int) -43523434, bodyParam);
