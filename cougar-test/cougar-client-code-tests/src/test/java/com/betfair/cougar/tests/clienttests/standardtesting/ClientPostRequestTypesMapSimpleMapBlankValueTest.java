...
/**
 * Ensure that when a SimpleMap object with a blank value is passed in parameters to cougar via a cougar client, the request is sent and the response is handled correctly
 */
public class ClientPostRequestTypesMapSimpleMapBlankValueTest {
    ...
    public void doTest(CougarClientWrapper.TransportType tt) throws Exception {
        ...
        Map<String, String> simpleMap = cougarClientResponseTypeUtils2.buildMap("aaa,bbb,ccc,ddd", "Value for aaa,,Value for ccc,Value for ddd");
