...
// Originally from ClientTests/Transport/StandardTesting/Client_Rescript_Get_RequestTypes_String_QueryParam_EscapedCharacters_Ampersand.xls;
 ...
 */
public class ClientGetRequestTypesStringQueryParamEscapedCharactersAmpersandTest {
    ...
    public void doTest(CougarClientWrapper.TransportType tt) throws Exception {
       ...
       Date convertedDate= helper.convertToSystemTimeZone("2009-06-01T13:50:00.0Z");
        ...
        SimpleResponse response3 = client.testParameterStylesQA(context, com.betfair.baseline.v2.enumerations.TestParameterStylesQAHeaderParamEnum.Foo, "this & that", convertedDate);
        assertEquals("headerParam=Foo,queryParam=this & that,dateQueryParam="+helper.dateInUTC(convertedDate), response3.getMessage());
    }
