...
// Originally from ClientTests/Transport/StandardTesting/Client_Rescript_Post_RequestTypes_Map_SimpleMap_NullValue.xls;
...
/**
 * Ensure that when a SimpleMap object with a large null value is passed in parameters to cougar via a cougar client, the request is sent and the response is handled correctly
 */
public class ClientPostRequestTypesMapSimpleMapNullValueTest {
    ...
    public void doTest(CougarClientWrapper.TransportType tt) throws Exception {
        ...
        // Build map with a null value
        CougarClientResponseTypeUtils cougarClientResponseTypeUtils2 = new CougarClientResponseTypeUtils();
        Map<String, String> simpleMap = cougarClientResponseTypeUtils2.buildMap("aaa,bbb,ccc,ddd", "Value for aaa,Value for bbb,Value for ccc");
