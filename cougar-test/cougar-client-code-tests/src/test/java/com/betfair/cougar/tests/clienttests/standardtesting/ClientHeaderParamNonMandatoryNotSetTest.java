...
// Originally from ClientTests/Transport/StandardTesting/Client_Rescript_HeaderParam_NonMandatory_NotSet.xls;
...
/**
 * Ensure that when a request is made to cougar via a cougar client, with some non mandatory header parameter not set, the request is sent and the response is handled correctly
 */
public class ClientHeaderParamNonMandatoryNotSetTest {
    ...
    public void doTest(CougarClientWrapper.TransportType tt) throws Exception {
        ...
        NonMandatoryParamsOperationResponseObject response3 = client.nonMandatoryParamsOperation(context, null, "queryParamString", bodyParam);
