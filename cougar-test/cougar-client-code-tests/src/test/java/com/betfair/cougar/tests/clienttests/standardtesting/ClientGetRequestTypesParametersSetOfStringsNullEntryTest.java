...
/**
 * Ensure that when a stringSet with a null entry is passed to cougar via a cougar client the request is sent and the response is handled correctly
 */
public class ClientGetRequestTypesParametersSetOfStringsNullEntryTest {
    ...
    public void doTest(CougarClientWrapper.TransportType tt) throws Exception {
        ...
        Set<String> querySet = cougarClientResponseTypeUtils2.buildSet("query1,queryTwo,null,query4");
        // Build set to pass as parameter
        CougarClientResponseTypeUtils cougarClientResponseTypeUtils3 = new CougarClientResponseTypeUtils();
        Set<String> headerSet = cougarClientResponseTypeUtils3.buildSet("header1,headerTwo,null,header4");
