...
/**
 * Ensure that when a Float object (with value Infinity) is passed in parameters to cougar via a cougar client, the request is sent and the response is handled correctly
 */
