...
// Originally from ClientTests/Transport/StandardTesting/Client_Rescript_Post_PostBody_String_SpecialCharacters_2.xls;
...
/**
 * Ensure that when a request containing special character \n in a body parameter is made to cougar via a cougar client the request is sent and the response is handled correctly
 */
public class ClientPostPostBodyStringSpecialCharacters2Test {
    ...
    public void doTest(CougarClientWrapper.TransportType tt) throws Exception {
        ...
        complexObject2.setName("this is a \\n slash+n");
        ...
        assertEquals("this is a \\n slash+n = 82", response3.getMessage());
    }
