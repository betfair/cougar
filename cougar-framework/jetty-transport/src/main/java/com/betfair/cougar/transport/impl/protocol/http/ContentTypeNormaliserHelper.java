...
public class ContentTypeNormaliserHelper implements InitializingBean {
	...
	public void setDataBindingMaps(List<DataBindingMap> dataBindingMaps) {
		this.dataBindingMaps = dataBindingMaps;
	}

	public void setValidEncodings(Set<String> validEncodings) {
