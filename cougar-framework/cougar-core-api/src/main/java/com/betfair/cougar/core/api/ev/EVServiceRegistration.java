...
/**
 * Interface facilitates Service introduction to an execution venue, and a collection of transports
 */
public interface EVServiceRegistration {
    public void introduceServiceToEV(ExecutionVenue ev, ServiceRegistrar serviceRegistrar,
                                     CompoundExecutableResolver compoundExecutableResolver);
