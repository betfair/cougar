...
/**
 * Simple Event definition used by unit tests
 */
public class ExpectedEvent extends AbstractEvent implements Transcribable {
    private String name;
    ...
    public ExpectedEvent(String name, String address) {
        this.name = name;
