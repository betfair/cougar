...
public class SimpleConnectedObject {

    private ObjectNode node;

    public SimpleConnectedObject(ObjectNode node) {
        this.node = node;
    }

    public ScalarProjection<Integer> value() {
        return node.ensureField("value", intProjector.getType()).project(intProjector);
    }
}
